...
------------ | ------------- | ------------- | -------------
*IntegrationApi* | [**ActivateLoyaltyPoints**](docs/apis/IntegrationApi.md#activateloyaltypoints) | **POST** /v1/loyalty_programs/{loyaltyProgramId}/activate_points | Activate loyalty points
...
*IntegrationApi* | [**DeleteLoyaltyTransactionsFromLedgers**](docs/apis/IntegrationApi.md#deleteloyaltytransactionsfromledgers) | **POST** /v1/loyalty_programs/{loyaltyProgramId}/profile/{integrationId}/delete_transactions | Delete customer's transactions from loyalty ledgers
...
*IntegrationApi* | [**GetCustomerRewards**](docs/apis/IntegrationApi.md#getcustomerrewards) | **GET** /v1/customer_profiles/{integrationId}/rewards | List customer's rewards
...
*IntegrationApi* | [**GetEventV3**](docs/apis/IntegrationApi.md#geteventv3) | **GET** /v3/events/{integrationId} | Get advanced event
...
*ManagementApi* | [**CreateAchievementV2**](docs/apis/ManagementApi.md#createachievementv2) | **POST** /v2/achievements | Create achievement
...
*ManagementApi* | [**CreateCampaign**](docs/apis/ManagementApi.md#createcampaign) | **POST** /v1/applications/{applicationId}/campaigns | Create campaign
...
*ManagementApi* | [**CreateCouponsAsynchronously**](docs/apis/ManagementApi.md#createcouponsasynchronously) | **POST** /v1/applications/{applicationId}/campaigns/{campaignId}/coupons_async | Create coupons asynchronously
...
*ManagementApi* | [**DeleteAchievementV2**](docs/apis/ManagementApi.md#deleteachievementv2) | **DELETE** /v2/achievements/{achievementId} | Delete achievement
...
*ManagementApi* | [**ExcludePriceHistory**](docs/apis/ManagementApi.md#excludepricehistory) | **POST** /v1/applications/{applicationId}/price_history/exclusions | Exclude price records from price history
...
*ManagementApi* | [**ExportAchievementV2**](docs/apis/ManagementApi.md#exportachievementv2) | **GET** /v2/achievements/{achievementId}/export | Export achievement customer data
...
*ManagementApi* | [**ExportApplicationCampaignAnalytics**](docs/apis/ManagementApi.md#exportapplicationcampaignanalytics) | **GET** /v1/applications/{applicationId}/campaign_analytics/export | Export Application analytics aggregated by campaign
...
*ManagementApi* | [**ExportCampaignValueMap**](docs/apis/ManagementApi.md#exportcampaignvaluemap) | **GET** /v1/applications/{applicationId}/campaigns/{campaignId}/value_maps/{valueMapId}/export | Export campaign value map
...
*ManagementApi* | [**ExportLoyaltyJoinDates**](docs/apis/ManagementApi.md#exportloyaltyjoindates) | **GET** /v1/loyalty_programs/{loyaltyProgramId}/export_join_dates | Export customers' loyalty program join dates
...
*ManagementApi* | [**GenerateCouponRejections**](docs/apis/ManagementApi.md#generatecouponrejections) | **GET** /v1/coupon_rejections | Summarize coupon redemption failures in session
...
*ManagementApi* | [**GetAchievementV2**](docs/apis/ManagementApi.md#getachievementv2) | **GET** /v2/achievements/{achievementId} | Get achievement
...
*ManagementApi* | [**GetApplicationCartItemFilterExpression**](docs/apis/ManagementApi.md#getapplicationcartitemfilterexpression) | **GET** /v1/applications/{applicationId}/cart_item_filters/{cartItemFilterId}/expressions/{expressionId} | Get Application cart item filter expression
...
*ManagementApi* | [**GetApplicationSessionsByCustomerAttributes**](docs/apis/ManagementApi.md#getapplicationsessionsbycustomerattributes) | **POST** /v1/applications/{applicationId}/sessions_search | List Application sessions matching the given customer attributes
...
*ManagementApi* | [**GetLoyaltyLedgerBalances**](docs/apis/ManagementApi.md#getloyaltyledgerbalances) | **GET** /v1/loyalty_programs/{loyaltyProgramId}/profile/{integrationId}/ledger_balances | Get customer's loyalty balances (Management API)
...
*ManagementApi* | [**GetLoyaltyProgramProfileLedgerTransactions**](docs/apis/ManagementApi.md#getloyaltyprogramprofileledgertransactions) | **GET** /v1/loyalty_programs/{loyaltyProgramId}/profile/{integrationId}/ledger_transactions | List customer's loyalty transactions (Management API)
...
*ManagementApi* | [**GetRulesetV2**](docs/apis/ManagementApi.md#getrulesetv2) | **GET** /v2/applications/{applicationId}/campaigns/{campaignId}/rulesets/{rulesetId} | Get ruleset (V2)
...
*ManagementApi* | [**ImportLoyaltyJoinDates**](docs/apis/ManagementApi.md#importloyaltyjoindates) | **POST** /v1/loyalty_programs/{loyaltyProgramId}/import_join_dates | Import join dates for a loyalty program
...
*ManagementApi* | [**ListAchievementsV2**](docs/apis/ManagementApi.md#listachievementsv2) | **GET** /v2/achievements | List achievements
*ManagementApi* | [**ListAllRolesV2**](docs/apis/ManagementApi.md#listallrolesv2) | **GET** /v2/roles | List roles
*ManagementApi* | [**ListApplicationCartItemFilters**](docs/apis/ManagementApi.md#listapplicationcartitemfilters) | **GET** /v1/applications/{applicationId}/cart_item_filters | List Application cart item filters
...
*ManagementApi* | [**UpdateAchievementV2**](docs/apis/ManagementApi.md#updateachievementv2) | **PUT** /v2/achievements/{achievementId} | Update achievement
...
- [Model.AchievementBlockReference](docs/models/AchievementBlockReference.md)
...
- [Model.AddLoyaltyPointsSupport](docs/models/AddLoyaltyPointsSupport.md)
...
- [Model.AdditionalCostReference](docs/models/AdditionalCostReference.md)
...
- [Model.ApplicationMembership](docs/models/ApplicationMembership.md)
...
- [Model.AttributeBlockReference](docs/models/AttributeBlockReference.md)
...
- [Model.AudienceBlockReference](docs/models/AudienceBlockReference.md)
...
- [Model.AwardDiscountAdditionalCostTarget](docs/models/AwardDiscountAdditionalCostTarget.md)
- [Model.AwardDiscountAdditionalCostTargetTarget](docs/models/AwardDiscountAdditionalCostTargetTarget.md)
- [Model.AwardDiscountAllItemsTarget](docs/models/AwardDiscountAllItemsTarget.md)
- [Model.AwardDiscountBlock](docs/models/AwardDiscountBlock.md)
- [Model.AwardDiscountBlock1Value](docs/models/AwardDiscountBlock1Value.md)
- [Model.AwardDiscountBundleItem](docs/models/AwardDiscountBundleItem.md)
- [Model.AwardDiscountBundleItemByAttribute](docs/models/AwardDiscountBundleItemByAttribute.md)
- [Model.AwardDiscountBundleItemByIndex](docs/models/AwardDiscountBundleItemByIndex.md)
- [Model.AwardDiscountBundleTarget](docs/models/AwardDiscountBundleTarget.md)
- [Model.AwardDiscountCartTarget](docs/models/AwardDiscountCartTarget.md)
- [Model.AwardDiscountGlobalFilterTarget](docs/models/AwardDiscountGlobalFilterTarget.md)
...
- [Model.AwardLoyaltyPointsAllItemsTarget](docs/models/AwardLoyaltyPointsAllItemsTarget.md)
- [Model.AwardLoyaltyPointsBlock](docs/models/AwardLoyaltyPointsBlock.md)
- [Model.AwardLoyaltyPointsBlock1Program](docs/models/AwardLoyaltyPointsBlock1Program.md)
- [Model.AwardLoyaltyPointsBlock1Value](docs/models/AwardLoyaltyPointsBlock1Value.md)
- [Model.AwardLoyaltyPointsBundleTarget](docs/models/AwardLoyaltyPointsBundleTarget.md)
- [Model.AwardLoyaltyPointsCartTarget](docs/models/AwardLoyaltyPointsCartTarget.md)
- [Model.AwardLoyaltyPointsGlobalFilterTarget](docs/models/AwardLoyaltyPointsGlobalFilterTarget.md)
- [Model.AwardLoyaltyPointsSelectorTarget](docs/models/AwardLoyaltyPointsSelectorTarget.md)
- [Model.AwardLoyaltyPointsTarget](docs/models/AwardLoyaltyPointsTarget.md)
...
- [Model.BaseNotificationPolicy](docs/models/BaseNotificationPolicy.md)
...
- [Model.BestPriorPriceSettings](docs/models/BestPriorPriceSettings.md)
...
- [Model.CampaignEligibility](docs/models/CampaignEligibility.md)
- [Model.CampaignEligibilityDetails](docs/models/CampaignEligibilityDetails.md)
- [Model.CampaignEligibilityExperiment](docs/models/CampaignEligibilityExperiment.md)
- [Model.CampaignEligibilityFailureDetails](docs/models/CampaignEligibilityFailureDetails.md)
...
- [Model.CampaignReference](docs/models/CampaignReference.md)
...
- [Model.CatalogActionAdd](docs/models/CatalogActionAdd.md)
- [Model.CatalogActionAddPriceAdjustment](docs/models/CatalogActionAddPriceAdjustment.md)
- [Model.CatalogActionFilter](docs/models/CatalogActionFilter.md)
- [Model.CatalogActionPatch](docs/models/CatalogActionPatch.md)
- [Model.CatalogActionPatchMany](docs/models/CatalogActionPatchMany.md)
- [Model.CatalogActionRemove](docs/models/CatalogActionRemove.md)
- [Model.CatalogActionRemoveMany](docs/models/CatalogActionRemoveMany.md)
...
- [Model.CheckAchievementBlock](docs/models/CheckAchievementBlock.md)
- [Model.CheckAttributeBlock](docs/models/CheckAttributeBlock.md)
- [Model.CheckAttributeBlockBase](docs/models/CheckAttributeBlockBase.md)
- [Model.CheckAudienceBlock](docs/models/CheckAudienceBlock.md)
- [Model.CheckBudgetBlock](docs/models/CheckBudgetBlock.md)
- [Model.CheckCouponBlock](docs/models/CheckCouponBlock.md)
- [Model.CheckEventBlock](docs/models/CheckEventBlock.md)
- [Model.CheckLoyaltyBalanceBlock](docs/models/CheckLoyaltyBalanceBlock.md)
- [Model.CheckLoyaltyBalanceBlock1Program](docs/models/CheckLoyaltyBalanceBlock1Program.md)
- [Model.CheckLoyaltyCardBlock](docs/models/CheckLoyaltyCardBlock.md)
- [Model.CheckReferralBlock](docs/models/CheckReferralBlock.md)
- [Model.CheckTierBlock](docs/models/CheckTierBlock.md)
...
- [Model.ConfirmRisksRequest](docs/models/ConfirmRisksRequest.md)
...
- [Model.CouponReservation](docs/models/CouponReservation.md)
...
- [Model.CouponWithReservations](docs/models/CouponWithReservations.md)
...
- [Model.CreateCouponBlock](docs/models/CreateCouponBlock.md)
- [Model.CreateCouponBlock1CampaignId](docs/models/CreateCouponBlock1CampaignId.md)
- [Model.CreateCouponBlock1DiscountLimit](docs/models/CreateCouponBlock1DiscountLimit.md)
- [Model.CreateCouponBlock1UsageLimit](docs/models/CreateCouponBlock1UsageLimit.md)
...
- [Model.CreateMCPKey](docs/models/CreateMCPKey.md)
- [Model.CreateManagementKey](docs/models/CreateManagementKey.md)
- [Model.CreateReferralBlock](docs/models/CreateReferralBlock.md)
- [Model.CreateReferralBlock1CampaignId](docs/models/CreateReferralBlock1CampaignId.md)
- [Model.CreateReferralBlock1UsageLimit](docs/models/CreateReferralBlock1UsageLimit.md)
...
- [Model.CustomEffectBlockReference](docs/models/CustomEffectBlockReference.md)
- [Model.CustomEffectProps](docs/models/CustomEffectProps.md)
- [Model.CustomerAchievement](docs/models/CustomerAchievement.md)
...
- [Model.CustomerProfileReward](docs/models/CustomerProfileReward.md)
...
- [Model.CustomerReservation](docs/models/CustomerReservation.md)
- [Model.CustomerReward](docs/models/CustomerReward.md)
...
- [Model.DeleteLoyaltyTransactionsRequest](docs/models/DeleteLoyaltyTransactionsRequest.md)
- [Model.DeleteUserRequest](docs/models/DeleteUserRequest.md)
- [Model.DigitalPass](docs/models/DigitalPass.md)
- [Model.DiscardRisksRequest](docs/models/DiscardRisksRequest.md)
- [Model.Effect](docs/models/Effect.md)
- [Model.EffectAcceptCoupon](docs/models/EffectAcceptCoupon.md)
- [Model.EffectAcceptReferral](docs/models/EffectAcceptReferral.md)
- [Model.EffectAddFreeItem](docs/models/EffectAddFreeItem.md)
- [Model.EffectAddLoyaltyPoints](docs/models/EffectAddLoyaltyPoints.md)
...
- [Model.EffectCustomEffect](docs/models/EffectCustomEffect.md)
- [Model.EffectDeductLoyaltyPoints](docs/models/EffectDeductLoyaltyPoints.md)
- [Model.EffectEntity](docs/models/EffectEntity.md)
- [Model.EffectError](docs/models/EffectError.md)
- [Model.EffectExtendLoyaltyPointsExpiryDate](docs/models/EffectExtendLoyaltyPointsExpiryDate.md)
- [Model.EffectIncreaseAchievementProgress](docs/models/EffectIncreaseAchievementProgress.md)
- [Model.EffectJoinLoyaltyProgram](docs/models/EffectJoinLoyaltyProgram.md)
- [Model.EffectOffsetNegativeLoyaltyPoints](docs/models/EffectOffsetNegativeLoyaltyPoints.md)
- [Model.EffectRedeemReferral](docs/models/EffectRedeemReferral.md)
- [Model.EffectReferralCreated](docs/models/EffectReferralCreated.md)
- [Model.EffectRejectCoupon](docs/models/EffectRejectCoupon.md)
- [Model.EffectRejectReferral](docs/models/EffectRejectReferral.md)
- [Model.EffectRemoveFromAudience](docs/models/EffectRemoveFromAudience.md)
- [Model.EffectReserveCoupon](docs/models/EffectReserveCoupon.md)
- [Model.EffectRollbackAddedLoyaltyPoints](docs/models/EffectRollbackAddedLoyaltyPoints.md)
- [Model.EffectRollbackCoupon](docs/models/EffectRollbackCoupon.md)
- [Model.EffectRollbackDeductedLoyaltyPoints](docs/models/EffectRollbackDeductedLoyaltyPoints.md)
- [Model.EffectRollbackDiscount](docs/models/EffectRollbackDiscount.md)
- [Model.EffectRollbackIncreasedAchievementProgress](docs/models/EffectRollbackIncreasedAchievementProgress.md)
- [Model.EffectRollbackReferral](docs/models/EffectRollbackReferral.md)
- [Model.EffectRollbackUseReward](docs/models/EffectRollbackUseReward.md)
- [Model.EffectSet](docs/models/EffectSet.md)
- [Model.EffectSetDiscount](docs/models/EffectSetDiscount.md)
- [Model.EffectSetDiscountPerAdditionalCost](docs/models/EffectSetDiscountPerAdditionalCost.md)
- [Model.EffectSetDiscountPerAdditionalCostPerItem](docs/models/EffectSetDiscountPerAdditionalCostPerItem.md)
- [Model.EffectSetDiscountPerItem](docs/models/EffectSetDiscountPerItem.md)
- [Model.EffectSetLoyaltyPointsExpiryDate](docs/models/EffectSetLoyaltyPointsExpiryDate.md)
- [Model.EffectShowBundleMetadata](docs/models/EffectShowBundleMetadata.md)
- [Model.EffectShowNotification](docs/models/EffectShowNotification.md)
- [Model.EffectStartAchievementProgress](docs/models/EffectStartAchievementProgress.md)
- [Model.EffectUnlockReward](docs/models/EffectUnlockReward.md)
- [Model.EffectUseReward](docs/models/EffectUseReward.md)
- [Model.EffectWillAwardGiveaway](docs/models/EffectWillAwardGiveaway.md)
...
- [Model.EventV3ReferralEntity](docs/models/EventV3ReferralEntity.md)
- [Model.EventV3RequestEntity](docs/models/EventV3RequestEntity.md)
- [Model.ExcludePriceObservationsRequest](docs/models/ExcludePriceObservationsRequest.md)
- [Model.Experiment](docs/models/Experiment.md)
- [Model.ExperimentCampaignCopy](docs/models/ExperimentCampaignCopy.md)
- [Model.ExperimentConfidenceTimeline](docs/models/ExperimentConfidenceTimeline.md)
- [Model.ExperimentConfidenceTimelineDataPoint](docs/models/ExperimentConfidenceTimelineDataPoint.md)
...
- [Model.ExperimentSegmentInsight](docs/models/ExperimentSegmentInsight.md)
- [Model.ExperimentSegmentInsightMetric](docs/models/ExperimentSegmentInsightMetric.md)
- [Model.ExperimentSegmentInsightVariant](docs/models/ExperimentSegmentInsightVariant.md)
- [Model.ExperimentSegmentInsights](docs/models/ExperimentSegmentInsights.md)
...
- [Model.ExperimentVerdict](docs/models/ExperimentVerdict.md)
- [Model.ExperimentVerdictResponse](docs/models/ExperimentVerdictResponse.md)
...
- [Model.FeatureFlagUpdate](docs/models/FeatureFlagUpdate.md)
- [Model.FeaturesFeed](docs/models/FeaturesFeed.md)
- [Model.FilterAndMapValuesSelectorStep](docs/models/FilterAndMapValuesSelectorStep.md)
- [Model.FilterSelectorStep](docs/models/FilterSelectorStep.md)
...
- [Model.GenerateCouponRejections200Response](docs/models/GenerateCouponRejections200Response.md)
...
- [Model.GeoJSONGeometry](docs/models/GeoJSONGeometry.md)
- [Model.GeoJSONGeometryCollection](docs/models/GeoJSONGeometryCollection.md)
- [Model.GeoJSONMultiPolygon](docs/models/GeoJSONMultiPolygon.md)
- [Model.GeoJSONPoint](docs/models/GeoJSONPoint.md)
- [Model.GeoJSONPolygon](docs/models/GeoJSONPolygon.md)
...
- [Model.GetApplicationSessionsByCustomerAttributes200Response](docs/models/GetApplicationSessionsByCustomerAttributes200Response.md)
...
- [Model.GetCustomerRewards200Response](docs/models/GetCustomerRewards200Response.md)
...
- [Model.GiveawayPoolBlockReference](docs/models/GiveawayPoolBlockReference.md)
...
- [Model.IntegrationCampaignBase](docs/models/IntegrationCampaignBase.md)
...
- [Model.IntegrationGetAllCampaigns200Response](docs/models/IntegrationGetAllCampaigns200Response.md)
- [Model.IntegrationHubConfig](docs/models/IntegrationHubConfig.md)
- [Model.IntegrationHubEventPayloadCouponBasedNotifications](docs/models/IntegrationHubEventPayloadCouponBasedNotifications.md)
- [Model.IntegrationHubEventPayloadCouponBasedNotificationsLimits](docs/models/IntegrationHubEventPayloadCouponBasedNotificationsLimits.md)
- [Model.IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotification](docs/models/IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotification.md)
- [Model.IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction](docs/models/IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction.md)
...
- [Model.IntegrationHubEventType](docs/models/IntegrationHubEventType.md)
...
- [Model.IntegrationUnlockRewardRequest](docs/models/IntegrationUnlockRewardRequest.md)
- [Model.IntegrationUnlockRewardResponse](docs/models/IntegrationUnlockRewardResponse.md)
...
- [Model.ListAchievementsV2200Response](docs/models/ListAchievementsV2200Response.md)
- [Model.ListAllRolesV2200Response](docs/models/ListAllRolesV2200Response.md)
- [Model.ListApplicationCartItemFilters200Response](docs/models/ListApplicationCartItemFilters200Response.md)
...
- [Model.ListCheckAttributeBlock](docs/models/ListCheckAttributeBlock.md)
- [Model.ListExperiments200Response](docs/models/ListExperiments200Response.md)
- [Model.ListStores200Response](docs/models/ListStores200Response.md)
- [Model.ListWithCountCheckAttributeBlock](docs/models/ListWithCountCheckAttributeBlock.md)
- [Model.LocationCheckAttributeBlock](docs/models/LocationCheckAttributeBlock.md)
- [Model.LocationCheckAttributeBlockValues](docs/models/LocationCheckAttributeBlockValues.md)
- [Model.LocationCheckAttributeBlockValuesOneOfInner](docs/models/LocationCheckAttributeBlockValuesOneOfInner.md)
...
- [Model.MCPCompleteOAuthSession](docs/models/MCPCompleteOAuthSession.md)
- [Model.MCPKey](docs/models/MCPKey.md)
- [Model.MCPOAuthClient](docs/models/MCPOAuthClient.md)
- [Model.MCPOAuthCompleteResult](docs/models/MCPOAuthCompleteResult.md)
- [Model.MCPOAuthProtectedResource](docs/models/MCPOAuthProtectedResource.md)
- [Model.MCPOAuthServerMetadata](docs/models/MCPOAuthServerMetadata.md)
- [Model.MCPOAuthSessionInfo](docs/models/MCPOAuthSessionInfo.md)
- [Model.MCPOAuthToken](docs/models/MCPOAuthToken.md)
- [Model.MCPOAuthTokenError](docs/models/MCPOAuthTokenError.md)
- [Model.MCPOAuthTokenRequest](docs/models/MCPOAuthTokenRequest.md)
- [Model.ManagementKey](docs/models/ManagementKey.md)
- [Model.ManagerConfig](docs/models/ManagerConfig.md)
- [Model.MapSelectorStep](docs/models/MapSelectorStep.md)
...
- [Model.NewDigitalPass](docs/models/NewDigitalPass.md)
...
- [Model.NewMCPKey](docs/models/NewMCPKey.md)
- [Model.NewMCPOAuthClient](docs/models/NewMCPOAuthClient.md)
...
- [Model.NewReward](docs/models/NewReward.md)
- [Model.NewRiskNotification](docs/models/NewRiskNotification.md)
...
- [Model.OutgoingIntegrationConfigurationPolicy](docs/models/OutgoingIntegrationConfigurationPolicy.md)
...
- [Model.PassthroughBlock](docs/models/PassthroughBlock.md)
...
- [Model.PriceHistoryRequest](docs/models/PriceHistoryRequest.md)
- [Model.PriceHistoryResponse](docs/models/PriceHistoryResponse.md)
...
- [Model.ReserveCouponBlock](docs/models/ReserveCouponBlock.md)
...
- [Model.ReverseSelectorStep](docs/models/ReverseSelectorStep.md)
- [Model.ReviewRisksRequest](docs/models/ReviewRisksRequest.md)
...
- [Model.RewardCatalogItem](docs/models/RewardCatalogItem.md)
...
- [Model.RiskDetail](docs/models/RiskDetail.md)
...
- [Model.RuleEligibilityFailureDetails](docs/models/RuleEligibilityFailureDetails.md)
- [Model.RuleFailureReason](docs/models/RuleFailureReason.md)
- [Model.RuleMetadata](docs/models/RuleMetadata.md)
- [Model.RuleMetadataEligibility](docs/models/RuleMetadataEligibility.md)
- [Model.RuleV2](docs/models/RuleV2.md)
- [Model.Ruleset](docs/models/Ruleset.md)
- [Model.RulesetV2](docs/models/RulesetV2.md)
...
- [Model.ScalarCheckAttributeBlock](docs/models/ScalarCheckAttributeBlock.md)
...
- [Model.ShowNotificationBlock](docs/models/ShowNotificationBlock.md)
...
- [Model.SortSelectorStep](docs/models/SortSelectorStep.md)
...
- [Model.SupportBalances](docs/models/SupportBalances.md)
- [Model.SupportCustomerProfile](docs/models/SupportCustomerProfile.md)
...
- [Model.TemplateParameter](docs/models/TemplateParameter.md)
- [Model.Tier](docs/models/Tier.md)
- [Model.TierBlockReference](docs/models/TierBlockReference.md)
...
- [Model.TriggerCustomEffectBlock](docs/models/TriggerCustomEffectBlock.md)
- [Model.TriggerCustomEffectBlock1Target](docs/models/TriggerCustomEffectBlock1Target.md)
- [Model.TriggerWebhookBlock](docs/models/TriggerWebhookBlock.md)
- [Model.TriggerWebhookEffectProps](docs/models/TriggerWebhookEffectProps.md)
- [Model.TwoFAConfig](docs/models/TwoFAConfig.md)
- [Model.UnaryCheckAttributeBlock](docs/models/UnaryCheckAttributeBlock.md)
- [Model.UnlockRewardEffectProps](docs/models/UnlockRewardEffectProps.md)
- [Model.UpdateAccount](docs/models/UpdateAccount.md)
- [Model.UpdateAchievement](docs/models/UpdateAchievement.md)
- [Model.UpdateAchievementProgressBlock](docs/models/UpdateAchievementProgressBlock.md)
...
- [Model.UpdateAttributeValueBlock](docs/models/UpdateAttributeValueBlock.md)
- [Model.UpdateAttributeValueBlock1Target](docs/models/UpdateAttributeValueBlock1Target.md)
- [Model.UpdateAudience](docs/models/UpdateAudience.md)
- [Model.UpdateAudienceMembershipBlock](docs/models/UpdateAudienceMembershipBlock.md)
...
- [Model.UpdateLoyaltyPointsExpiryBlock](docs/models/UpdateLoyaltyPointsExpiryBlock.md)
- [Model.UpdateLoyaltyPointsExpiryBlock1Program](docs/models/UpdateLoyaltyPointsExpiryBlock1Program.md)
...
- [Model.UpdateRiskNotification](docs/models/UpdateRiskNotification.md)
...
- [Model.UseRewardEffectProps](docs/models/UseRewardEffectProps.md)
...
- [Model.WebhookBlockReference](docs/models/WebhookBlockReference.md)
...
- [Model.WithinCheckAttributeBlock](docs/models/WithinCheckAttributeBlock.md)
