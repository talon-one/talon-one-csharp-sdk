...
namespace TalonOneSdk.Test.Model
{
    ...
    public class IntegrationHubEventPayloadCouponBasedNotificationsTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" IntegrationHubEventPayloadCouponBasedNotifications
            //Assert.IsType<IntegrationHubEventPayloadCouponBasedNotifications>(instance);
        }
