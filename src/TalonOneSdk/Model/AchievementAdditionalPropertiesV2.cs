...
namespace TalonOneSdk.Model
{
    ...
    public partial class AchievementAdditionalPropertiesV2 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AchievementAdditionalPropertiesV2(long userId, Option<string> createdBy = default, Option<TimePoint> periodEndOverride = default, Option<bool?> hasProgress = default, Option<StatusEnum?> status = default)
        {
            UserId = userId;
    ...
    /// </summary>
    public partial class AchievementAdditionalPropertiesV2JsonConverter : JsonConverter<AchievementAdditionalPropertiesV2>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="AchievementAdditionalPropertiesV2JsonConverter" /> class.
        /// </summary>
        public AchievementAdditionalPropertiesV2JsonConverter()
        {
            OnCreated();
        }
        ...
        public override AchievementAdditionalPropertiesV2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "status":
                            ...
                            {
                                AchievementAdditionalPropertiesV2.StatusEnum? statusValue = AchievementAdditionalPropertiesV2.StatusEnumFromStringOrDefault(statusRawValue);
                                if (statusValue == null)
                                    throw new JsonException();
                                status = new Option<AchievementAdditionalPropertiesV2.StatusEnum?>(statusValue);
                            }
                            break;
                        default:
                            break;
            ...
            return new AchievementAdditionalPropertiesV2(userId.Value.Value, createdBy, periodEndOverride, hasProgress, status);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, AchievementAdditionalPropertiesV2 achievementAdditionalPropertiesV2, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (achievementAdditionalPropertiesV2.PeriodEndOverrideOption.IsSet)
            {
                writer.WritePropertyName("periodEndOverride");
                JsonSerializer.Serialize(writer, achievementAdditionalPropertiesV2.PeriodEndOverride, jsonSerializerOptions);
            }
