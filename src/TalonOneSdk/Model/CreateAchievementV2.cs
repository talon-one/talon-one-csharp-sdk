    ...
    public class CreateAchievementV2JsonConverter : JsonConverter<CreateAchievementV2>
    {
        ...
        public override CreateAchievementV2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (subscribedApplications.IsSet && subscribedApplications.Value == null)
                throw new ArgumentNullException(nameof(subscribedApplications), "Property is not nullable for class CreateAchievementV2.");
            ...
            if (period.IsSet && period.Value == null)
                throw new ArgumentNullException(nameof(period), "Property is not nullable for class CreateAchievementV2.");
