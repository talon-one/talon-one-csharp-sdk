...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectStartAchievementProgress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectStartAchievementProgress" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;startAchievementProgress&#x60;.</param>
        /// <param name="props">The properties of the &#x60;startAchievementProgress&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;startAchievementProgress&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum StartAchievementProgress for value: startAchievementProgress
            /// </summary>
            StartAchievementProgress = 1
        }
        ...
        {
            if (value.Equals("startAchievementProgress"))
                return EffectTypeEnum.StartAchievementProgress;
        ...
        {
            if (value == EffectTypeEnum.StartAchievementProgress)
                return "startAchievementProgress";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;startAchievementProgress&#x60; effect.</value>
        [JsonPropertyName("props")]
        public StartAchievementProgressEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectStartAchievementProgress" />
    /// </summary>
    public partial class EffectStartAchievementProgressJsonConverter : JsonConverter<EffectStartAchievementProgress>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectStartAchievementProgressJsonConverter" /> class.
        /// </summary>
        public EffectStartAchievementProgressJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectStartAchievementProgress" />
        /// </summary>
        ...
        public override EffectStartAchievementProgress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectStartAchievementProgress.EffectTypeEnum?> effectType = default;
            Option<StartAchievementProgressEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectStartAchievementProgress.EffectTypeEnum? effectTypeValue = EffectStartAchievementProgress.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectStartAchievementProgress.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<StartAchievementProgressEffectProps>(JsonSerializer.Deserialize<StartAchievementProgressEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectStartAchievementProgress.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectStartAchievementProgress.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectStartAchievementProgress.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectStartAchievementProgress.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectStartAchievementProgress.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectStartAchievementProgress.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectStartAchievementProgress.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectStartAchievementProgress.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectStartAchievementProgress.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectStartAchievementProgress.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectStartAchievementProgress.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectStartAchievementProgress.");

            return new EffectStartAchievementProgress(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectStartAchievementProgress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectStartAchievementProgress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectStartAchievementProgress effectStartAchievementProgress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectStartAchievementProgress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectStartAchievementProgress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectStartAchievementProgress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectStartAchievementProgress effectStartAchievementProgress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectStartAchievementProgress.RuleName == null)
                throw new ArgumentNullException(nameof(effectStartAchievementProgress.RuleName), "Property is required for class EffectStartAchievementProgress.");

            if (effectStartAchievementProgress.Props == null)
                throw new ArgumentNullException(nameof(effectStartAchievementProgress.Props), "Property is required for class EffectStartAchievementProgress.");

            writer.WriteNumber("campaignId", effectStartAchievementProgress.CampaignId);

            writer.WriteNumber("rulesetId", effectStartAchievementProgress.RulesetId);

            writer.WriteNumber("ruleIndex", effectStartAchievementProgress.RuleIndex);

            writer.WriteString("ruleName", effectStartAchievementProgress.RuleName);

            var effectTypeRawValue = EffectStartAchievementProgress.EffectTypeEnumToJsonValue(effectStartAchievementProgress.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectStartAchievementProgress.Props, jsonSerializerOptions);
            if (effectStartAchievementProgress.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectStartAchievementProgress.ExperimentIdOption.Value.Value);

            if (effectStartAchievementProgress.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectStartAchievementProgress.TriggeredByCouponOption.Value.Value);

            if (effectStartAchievementProgress.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectStartAchievementProgress.TriggeredForCatalogItemOption.Value.Value);

            if (effectStartAchievementProgress.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectStartAchievementProgress.ConditionIndexOption.Value.Value);

            if (effectStartAchievementProgress.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectStartAchievementProgress.EvaluationGroupIDOption.Value.Value);

            if (effectStartAchievementProgress.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectStartAchievementProgress.EvaluationGroupMode);

            if (effectStartAchievementProgress.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectStartAchievementProgress.CampaignRevisionIdOption.Value.Value);

            if (effectStartAchievementProgress.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectStartAchievementProgress.CampaignRevisionVersionIdOption.Value.Value);

            if (effectStartAchievementProgress.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectStartAchievementProgress.SelectedPriceType);

            if (effectStartAchievementProgress.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectStartAchievementProgress.SelectedPriceOption.Value.Value);

            if (effectStartAchievementProgress.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectStartAchievementProgress.AdjustmentReferenceIdOption.Value.Value);

            if (effectStartAchievementProgress.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectStartAchievementProgress.RewardIdOption.Value.Value);
        }
    }
}
