...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectRollbackIncreasedAchievementProgress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRollbackIncreasedAchievementProgress" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;rollbackIncreasedAchievementProgress&#x60;.</param>
        /// <param name="props">The properties of the &#x60;rollbackIncreasedAchievementProgress&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;rollbackIncreasedAchievementProgress&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum RollbackIncreasedAchievementProgress for value: rollbackIncreasedAchievementProgress
            /// </summary>
            RollbackIncreasedAchievementProgress = 1
        }
        ...
        {
            if (value.Equals("rollbackIncreasedAchievementProgress"))
                return EffectTypeEnum.RollbackIncreasedAchievementProgress;
        ...
        {
            if (value == EffectTypeEnum.RollbackIncreasedAchievementProgress)
                return "rollbackIncreasedAchievementProgress";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;rollbackIncreasedAchievementProgress&#x60; effect.</value>
        [JsonPropertyName("props")]
        public RollbackIncreasedAchievementProgressEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectRollbackIncreasedAchievementProgress" />
    /// </summary>
    public partial class EffectRollbackIncreasedAchievementProgressJsonConverter : JsonConverter<EffectRollbackIncreasedAchievementProgress>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRollbackIncreasedAchievementProgressJsonConverter" /> class.
        /// </summary>
        public EffectRollbackIncreasedAchievementProgressJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectRollbackIncreasedAchievementProgress" />
        /// </summary>
        ...
        public override EffectRollbackIncreasedAchievementProgress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectRollbackIncreasedAchievementProgress.EffectTypeEnum?> effectType = default;
            Option<RollbackIncreasedAchievementProgressEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectRollbackIncreasedAchievementProgress.EffectTypeEnum? effectTypeValue = EffectRollbackIncreasedAchievementProgress.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectRollbackIncreasedAchievementProgress.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<RollbackIncreasedAchievementProgressEffectProps>(JsonSerializer.Deserialize<RollbackIncreasedAchievementProgressEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackIncreasedAchievementProgress.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackIncreasedAchievementProgress.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackIncreasedAchievementProgress.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackIncreasedAchievementProgress.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackIncreasedAchievementProgress.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackIncreasedAchievementProgress.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectRollbackIncreasedAchievementProgress.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectRollbackIncreasedAchievementProgress.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectRollbackIncreasedAchievementProgress.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectRollbackIncreasedAchievementProgress.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectRollbackIncreasedAchievementProgress.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectRollbackIncreasedAchievementProgress.");

            return new EffectRollbackIncreasedAchievementProgress(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectRollbackIncreasedAchievementProgress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRollbackIncreasedAchievementProgress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectRollbackIncreasedAchievementProgress effectRollbackIncreasedAchievementProgress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectRollbackIncreasedAchievementProgress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectRollbackIncreasedAchievementProgress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRollbackIncreasedAchievementProgress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectRollbackIncreasedAchievementProgress effectRollbackIncreasedAchievementProgress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectRollbackIncreasedAchievementProgress.RuleName == null)
                throw new ArgumentNullException(nameof(effectRollbackIncreasedAchievementProgress.RuleName), "Property is required for class EffectRollbackIncreasedAchievementProgress.");

            if (effectRollbackIncreasedAchievementProgress.Props == null)
                throw new ArgumentNullException(nameof(effectRollbackIncreasedAchievementProgress.Props), "Property is required for class EffectRollbackIncreasedAchievementProgress.");

            writer.WriteNumber("campaignId", effectRollbackIncreasedAchievementProgress.CampaignId);

            writer.WriteNumber("rulesetId", effectRollbackIncreasedAchievementProgress.RulesetId);

            writer.WriteNumber("ruleIndex", effectRollbackIncreasedAchievementProgress.RuleIndex);

            writer.WriteString("ruleName", effectRollbackIncreasedAchievementProgress.RuleName);

            var effectTypeRawValue = EffectRollbackIncreasedAchievementProgress.EffectTypeEnumToJsonValue(effectRollbackIncreasedAchievementProgress.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectRollbackIncreasedAchievementProgress.Props, jsonSerializerOptions);
            if (effectRollbackIncreasedAchievementProgress.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectRollbackIncreasedAchievementProgress.ExperimentIdOption.Value.Value);

            if (effectRollbackIncreasedAchievementProgress.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectRollbackIncreasedAchievementProgress.TriggeredByCouponOption.Value.Value);

            if (effectRollbackIncreasedAchievementProgress.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectRollbackIncreasedAchievementProgress.TriggeredForCatalogItemOption.Value.Value);

            if (effectRollbackIncreasedAchievementProgress.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectRollbackIncreasedAchievementProgress.ConditionIndexOption.Value.Value);

            if (effectRollbackIncreasedAchievementProgress.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectRollbackIncreasedAchievementProgress.EvaluationGroupIDOption.Value.Value);

            if (effectRollbackIncreasedAchievementProgress.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectRollbackIncreasedAchievementProgress.EvaluationGroupMode);

            if (effectRollbackIncreasedAchievementProgress.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectRollbackIncreasedAchievementProgress.CampaignRevisionIdOption.Value.Value);

            if (effectRollbackIncreasedAchievementProgress.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectRollbackIncreasedAchievementProgress.CampaignRevisionVersionIdOption.Value.Value);

            if (effectRollbackIncreasedAchievementProgress.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectRollbackIncreasedAchievementProgress.SelectedPriceType);

            if (effectRollbackIncreasedAchievementProgress.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectRollbackIncreasedAchievementProgress.SelectedPriceOption.Value.Value);

            if (effectRollbackIncreasedAchievementProgress.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectRollbackIncreasedAchievementProgress.AdjustmentReferenceIdOption.Value.Value);

            if (effectRollbackIncreasedAchievementProgress.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectRollbackIncreasedAchievementProgress.RewardIdOption.Value.Value);
        }
    }
}
