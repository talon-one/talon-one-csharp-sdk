...
namespace TalonOneSdk.Model
{
    ...
    public partial class CampaignEditedNotification : IValidatableObject
    {
        ...
        public List<CampaignEditedNotificationItem> Data { get { return this.DataOption.Value; } set { this.DataOption = new Option<List<CampaignEditedNotificationItem>>(value); } }
    ...
    /// </summary>
    public partial class CampaignEditedNotificationJsonConverter : JsonConverter<CampaignEditedNotification>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignEditedNotificationJsonConverter" /> class.
        /// </summary>
        public CampaignEditedNotificationJsonConverter()
        {
            OnCreated();
        }
