...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public class CampaignStateChangedNotificationJsonConverter : JsonConverter<CampaignStateChangedNotification>
    {
        /// <summary>
        ...
        public override CampaignStateChangedNotification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class CampaignStateChangedNotification.");
