...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CampaignStateChangedNotification : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public CampaignStateChangedNotification(NotificationTypeEnum notificationType, long totalResultSize, Option<List<CampaignStateChangedNotificationItem>> data = default)
        {
        ...
        public Option<List<CampaignStateChangedNotificationItem>> DataOption { get; private set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="CampaignStateChangedNotification" />
    /// </summary>
    public partial class CampaignStateChangedNotificationJsonConverter : JsonConverter<CampaignStateChangedNotification>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignStateChangedNotificationJsonConverter" /> class.
        /// </summary>
        public CampaignStateChangedNotificationJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="CampaignStateChangedNotification" />
        /// </summary>
        ...
        public override CampaignStateChangedNotification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<CampaignStateChangedNotification.NotificationTypeEnum?> notificationType = default;
            Option<long?> totalResultSize = default;
            Option<List<CampaignStateChangedNotificationItem>> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "NotificationType":
                            ...
                            {
                                CampaignStateChangedNotification.NotificationTypeEnum? notificationTypeValue = CampaignStateChangedNotification.NotificationTypeEnumFromStringOrDefault(notificationTypeRawValue);
                                if (notificationTypeValue == null)
                                    throw new JsonException();
                                notificationType = new Option<CampaignStateChangedNotification.NotificationTypeEnum?>(notificationTypeValue);
                            }
                            break;
            ...
            if (!notificationType.IsSet)
                throw new ArgumentException("Property is required for class CampaignStateChangedNotification.", nameof(notificationType));
        ...
        /// <summary>
        /// Serializes a <see cref="CampaignStateChangedNotification" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="campaignStateChangedNotification"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CampaignStateChangedNotification campaignStateChangedNotification, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, campaignStateChangedNotification, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CampaignStateChangedNotification" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="campaignStateChangedNotification"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, CampaignStateChangedNotification campaignStateChangedNotification, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (campaignStateChangedNotification.DataOption.IsSet)
            {
                writer.WritePropertyName("Data");
                JsonSerializer.Serialize(writer, campaignStateChangedNotification.Data, jsonSerializerOptions);
            }
        }
    }
}
