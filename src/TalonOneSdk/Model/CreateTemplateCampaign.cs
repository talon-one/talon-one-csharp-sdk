...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CreateTemplateCampaignJsonConverter : JsonConverter<CreateTemplateCampaign>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTemplateCampaignJsonConverter" /> class.
        /// </summary>
        public CreateTemplateCampaignJsonConverter()
        {
            OnCreated();
        }
