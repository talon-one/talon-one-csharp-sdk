...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class FuncArgDefJsonConverter : JsonConverter<FuncArgDef>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="FuncArgDefJsonConverter" /> class.
        /// </summary>
        public FuncArgDefJsonConverter()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "type":
                            ...
                            {
                                FuncArgDef.TypeEnum? typeValue = FuncArgDef.TypeEnumFromStringOrDefault(typeRawValue);
                                if (typeValue == null)
                                    throw new JsonException();
                                type = new Option<FuncArgDef.TypeEnum?>(typeValue);
                            }
                            break;
                        case "description":
