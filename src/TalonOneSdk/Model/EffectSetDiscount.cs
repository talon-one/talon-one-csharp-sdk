...
namespace TalonOneSdk.Model
{
    ...
    /// EffectSetDiscount
    /// </summary>
    public partial class EffectSetDiscount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectSetDiscount" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;setDiscount&#x60;.</param>
        /// <param name="props">The properties of the &#x60;setDiscount&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;setDiscount&#x60;.</value>
        ...
        public static EffectTypeEnum EffectTypeEnumFromString(string value)
        {
            if (value.Equals("setDiscount"))
                return EffectTypeEnum.SetDiscount;
        ...
        {
            if (value == EffectTypeEnum.SetDiscount)
                return "setDiscount";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;setDiscount&#x60; effect.</value>
        [JsonPropertyName("props")]
        public SetDiscountEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectSetDiscount" />
    /// </summary>
    public partial class EffectSetDiscountJsonConverter : JsonConverter<EffectSetDiscount>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectSetDiscountJsonConverter" /> class.
        /// </summary>
        public EffectSetDiscountJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectSetDiscount" />
        /// </summary>
        ...
        public override EffectSetDiscount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectSetDiscount.EffectTypeEnum?> effectType = default;
            Option<SetDiscountEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectSetDiscount.EffectTypeEnum? effectTypeValue = EffectSetDiscount.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectSetDiscount.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<SetDiscountEffectProps>(JsonSerializer.Deserialize<SetDiscountEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscount.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscount.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscount.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscount.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscount.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscount.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectSetDiscount.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectSetDiscount.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectSetDiscount.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectSetDiscount.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectSetDiscount.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectSetDiscount.");

            return new EffectSetDiscount(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectSetDiscount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectSetDiscount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectSetDiscount effectSetDiscount, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectSetDiscount, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectSetDiscount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectSetDiscount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectSetDiscount effectSetDiscount, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectSetDiscount.RuleName == null)
                throw new ArgumentNullException(nameof(effectSetDiscount.RuleName), "Property is required for class EffectSetDiscount.");

            if (effectSetDiscount.Props == null)
                throw new ArgumentNullException(nameof(effectSetDiscount.Props), "Property is required for class EffectSetDiscount.");

            writer.WriteNumber("campaignId", effectSetDiscount.CampaignId);

            writer.WriteNumber("rulesetId", effectSetDiscount.RulesetId);

            writer.WriteNumber("ruleIndex", effectSetDiscount.RuleIndex);

            writer.WriteString("ruleName", effectSetDiscount.RuleName);

            var effectTypeRawValue = EffectSetDiscount.EffectTypeEnumToJsonValue(effectSetDiscount.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectSetDiscount.Props, jsonSerializerOptions);
            if (effectSetDiscount.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectSetDiscount.ExperimentIdOption.Value.Value);

            if (effectSetDiscount.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectSetDiscount.TriggeredByCouponOption.Value.Value);

            if (effectSetDiscount.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectSetDiscount.TriggeredForCatalogItemOption.Value.Value);

            if (effectSetDiscount.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectSetDiscount.ConditionIndexOption.Value.Value);

            if (effectSetDiscount.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectSetDiscount.EvaluationGroupIDOption.Value.Value);

            if (effectSetDiscount.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectSetDiscount.EvaluationGroupMode);

            if (effectSetDiscount.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectSetDiscount.CampaignRevisionIdOption.Value.Value);

            if (effectSetDiscount.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectSetDiscount.CampaignRevisionVersionIdOption.Value.Value);

            if (effectSetDiscount.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectSetDiscount.SelectedPriceType);

            if (effectSetDiscount.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectSetDiscount.SelectedPriceOption.Value.Value);

            if (effectSetDiscount.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectSetDiscount.AdjustmentReferenceIdOption.Value.Value);

            if (effectSetDiscount.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectSetDiscount.RewardIdOption.Value.Value);
        }
    }
}
