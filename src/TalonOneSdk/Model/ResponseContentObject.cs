...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class ResponseContentObjectJsonConverter : JsonConverter<ResponseContentObject>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseContentObjectJsonConverter" /> class.
        /// </summary>
        public ResponseContentObjectJsonConverter()
        {
            OnCreated();
        }
