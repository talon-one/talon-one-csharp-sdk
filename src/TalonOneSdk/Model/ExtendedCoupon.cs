...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class ExtendedCouponJsonConverter : JsonConverter<ExtendedCoupon>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ExtendedCouponJsonConverter" /> class.
        /// </summary>
        public ExtendedCouponJsonConverter()
        {
            OnCreated();
        }
