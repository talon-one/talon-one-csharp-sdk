...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class RevisionVersionJsonConverter : JsonConverter<RevisionVersion>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="RevisionVersionJsonConverter" /> class.
        /// </summary>
        public RevisionVersionJsonConverter()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "features":
                            ...
                            {
                                features = new Option<List<RevisionVersion.FeaturesEnum>>((List<RevisionVersion.FeaturesEnum>)null);
                            }
                            else if (utf8JsonReader.TokenType == JsonTokenType.StartArray)
                            {
                                var featuresItems = new List<RevisionVersion.FeaturesEnum>();
                                while (utf8JsonReader.Read())
                                {
                                    ...
                                    featuresItems.Add(RevisionVersion.FeaturesEnumFromString(featuresItemRawValue));
                                }
                                features = new Option<List<RevisionVersion.FeaturesEnum>>(featuresItems);
                            }
                            else
                                throw new JsonException();
                            break;
        ...
        public void WriteProperties(Utf8JsonWriter writer, RevisionVersion revisionVersion, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (revisionVersion.ReevaluateOnReturnOption.IsSet)
                writer.WriteBoolean("reevaluateOnReturn", revisionVersion.ReevaluateOnReturnOption.Value.Value);

            if (revisionVersion.FeaturesOption.IsSet)
            {
                writer.WritePropertyName("features");
                writer.WriteStartArray();
                foreach (var featuresItem in revisionVersion.Features)
                {
