...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CustomerProfileAudienceRequestItem : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="audienceId">The ID of the audience. You get it via the &#x60;id&#x60; property when [creating an audience](#tag/Audiences/operation/createAudienceV2).</param>
        [JsonConstructor]
        public CustomerProfileAudienceRequestItem(ActionEnum action, string profileIntegrationId, long audienceId)
        {
            Action = action;
    ...
    /// <summary>
    /// A Json converter for type <see cref="CustomerProfileAudienceRequestItem" />
    /// </summary>
    public partial class CustomerProfileAudienceRequestItemJsonConverter : JsonConverter<CustomerProfileAudienceRequestItem>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerProfileAudienceRequestItemJsonConverter" /> class.
        /// </summary>
        public CustomerProfileAudienceRequestItemJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="CustomerProfileAudienceRequestItem" />
        /// </summary>
        ...
        public override CustomerProfileAudienceRequestItem Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<CustomerProfileAudienceRequestItem.ActionEnum?> action = default;
            ...
            if (!action.IsSet)
                throw new ArgumentException("Property is required for class CustomerProfileAudienceRequestItem.", nameof(action));

            if (!profileIntegrationId.IsSet)
                throw new ArgumentException("Property is required for class CustomerProfileAudienceRequestItem.", nameof(profileIntegrationId));
        ...
        /// <summary>
        /// Serializes a <see cref="CustomerProfileAudienceRequestItem" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="customerProfileAudienceRequestItem"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CustomerProfileAudienceRequestItem customerProfileAudienceRequestItem, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, customerProfileAudienceRequestItem, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CustomerProfileAudienceRequestItem" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="customerProfileAudienceRequestItem"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CustomerProfileAudienceRequestItem customerProfileAudienceRequestItem, JsonSerializerOptions jsonSerializerOptions)
        {
            if (customerProfileAudienceRequestItem.ProfileIntegrationId == null)
                throw new ArgumentNullException(nameof(customerProfileAudienceRequestItem.ProfileIntegrationId), "Property is required for class CustomerProfileAudienceRequestItem.");

            var actionRawValue = CustomerProfileAudienceRequestItem.ActionEnumToJsonValue(customerProfileAudienceRequestItem.Action);
            writer.WriteString("action", actionRawValue);
            writer.WriteString("profileIntegrationId", customerProfileAudienceRequestItem.ProfileIntegrationId);

            writer.WriteNumber("audienceId", customerProfileAudienceRequestItem.AudienceId);
        }
    }
}
