...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class PriceTypeJsonConverter : JsonConverter<PriceType>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="PriceTypeJsonConverter" /> class.
        /// </summary>
        public PriceTypeJsonConverter()
        {
            OnCreated();
        }
