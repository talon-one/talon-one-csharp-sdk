...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectOffsetNegativeLoyaltyPoints : IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;offsetNegativeLoyaltyPoints&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum OffsetNegativeLoyaltyPoints for value: offsetNegativeLoyaltyPoints
            /// </summary>
            OffsetNegativeLoyaltyPoints = 1
        }
        ...
        {
            if (value.Equals("offsetNegativeLoyaltyPoints"))
                return EffectTypeEnum.OffsetNegativeLoyaltyPoints;
        ...
        {
            if (value == EffectTypeEnum.OffsetNegativeLoyaltyPoints)
                return "offsetNegativeLoyaltyPoints";
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectOffsetNegativeLoyaltyPoints" />
    /// </summary>
    public partial class EffectOffsetNegativeLoyaltyPointsJsonConverter : JsonConverter<EffectOffsetNegativeLoyaltyPoints>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectOffsetNegativeLoyaltyPointsJsonConverter" /> class.
        /// </summary>
        public EffectOffsetNegativeLoyaltyPointsJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectOffsetNegativeLoyaltyPoints" />
        /// </summary>
        ...
        public override EffectOffsetNegativeLoyaltyPoints Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectOffsetNegativeLoyaltyPoints.EffectTypeEnum? effectTypeValue = EffectOffsetNegativeLoyaltyPoints.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
        ...
        /// <summary>
        /// Serializes a <see cref="EffectOffsetNegativeLoyaltyPoints" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectOffsetNegativeLoyaltyPoints"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectOffsetNegativeLoyaltyPoints effectOffsetNegativeLoyaltyPoints, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectOffsetNegativeLoyaltyPoints, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectOffsetNegativeLoyaltyPoints" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectOffsetNegativeLoyaltyPoints"></param>
        /// <param name="jsonSerializerOptions"></param>
