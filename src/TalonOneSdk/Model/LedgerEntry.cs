...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class LedgerEntryJsonConverter : JsonConverter<LedgerEntry>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="LedgerEntryJsonConverter" /> class.
        /// </summary>
        public LedgerEntryJsonConverter()
        {
            OnCreated();
        }
