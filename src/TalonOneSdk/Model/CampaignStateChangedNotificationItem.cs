...
namespace TalonOneSdk.Model
{
    ...
    public partial class CampaignStateChangedNotificationItem : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CampaignStateChangedNotificationItem(string @event, Campaign campaign, string oldState, string newState, Option<Ruleset> ruleset = default, Option<List<PlaceholderDetails>> placeholders = default)
        {
            Event = @event;
            Campaign = campaign;
            OldState = oldState;
    ...
    public partial class CampaignStateChangedNotificationItemJsonConverter : JsonConverter<CampaignStateChangedNotificationItem>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, CampaignStateChangedNotificationItem campaignStateChangedNotificationItem, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (campaignStateChangedNotificationItem.PlaceholdersOption.IsSet)
            {
                writer.WritePropertyName("placeholders");
                JsonSerializer.Serialize(writer, campaignStateChangedNotificationItem.Placeholders, jsonSerializerOptions);
            }
        }
    }
}
