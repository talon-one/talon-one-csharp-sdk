...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectRemoveFromAudience : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRemoveFromAudience" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;removeFromAudience&#x60;.</param>
        /// <param name="props">The properties of the &#x60;removeFromAudience&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;removeFromAudience&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum RemoveFromAudience for value: removeFromAudience
            /// </summary>
            RemoveFromAudience = 1
        }
        ...
        {
            if (value.Equals("removeFromAudience"))
                return EffectTypeEnum.RemoveFromAudience;
        ...
        {
            if (value == EffectTypeEnum.RemoveFromAudience)
                return "removeFromAudience";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;removeFromAudience&#x60; effect.</value>
        [JsonPropertyName("props")]
        public RemoveFromAudienceEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectRemoveFromAudience" />
    /// </summary>
    public partial class EffectRemoveFromAudienceJsonConverter : JsonConverter<EffectRemoveFromAudience>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRemoveFromAudienceJsonConverter" /> class.
        /// </summary>
        public EffectRemoveFromAudienceJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectRemoveFromAudience" />
        /// </summary>
        ...
        public override EffectRemoveFromAudience Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectRemoveFromAudience.EffectTypeEnum?> effectType = default;
            Option<RemoveFromAudienceEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectRemoveFromAudience.EffectTypeEnum? effectTypeValue = EffectRemoveFromAudience.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectRemoveFromAudience.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<RemoveFromAudienceEffectProps>(JsonSerializer.Deserialize<RemoveFromAudienceEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectRemoveFromAudience.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectRemoveFromAudience.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectRemoveFromAudience.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectRemoveFromAudience.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectRemoveFromAudience.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectRemoveFromAudience.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectRemoveFromAudience.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectRemoveFromAudience.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectRemoveFromAudience.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectRemoveFromAudience.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectRemoveFromAudience.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectRemoveFromAudience.");

            return new EffectRemoveFromAudience(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectRemoveFromAudience" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRemoveFromAudience"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectRemoveFromAudience effectRemoveFromAudience, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectRemoveFromAudience, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectRemoveFromAudience" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRemoveFromAudience"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectRemoveFromAudience effectRemoveFromAudience, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectRemoveFromAudience.RuleName == null)
                throw new ArgumentNullException(nameof(effectRemoveFromAudience.RuleName), "Property is required for class EffectRemoveFromAudience.");

            if (effectRemoveFromAudience.Props == null)
                throw new ArgumentNullException(nameof(effectRemoveFromAudience.Props), "Property is required for class EffectRemoveFromAudience.");

            writer.WriteNumber("campaignId", effectRemoveFromAudience.CampaignId);

            writer.WriteNumber("rulesetId", effectRemoveFromAudience.RulesetId);

            writer.WriteNumber("ruleIndex", effectRemoveFromAudience.RuleIndex);

            writer.WriteString("ruleName", effectRemoveFromAudience.RuleName);

            var effectTypeRawValue = EffectRemoveFromAudience.EffectTypeEnumToJsonValue(effectRemoveFromAudience.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectRemoveFromAudience.Props, jsonSerializerOptions);
            if (effectRemoveFromAudience.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectRemoveFromAudience.ExperimentIdOption.Value.Value);

            if (effectRemoveFromAudience.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectRemoveFromAudience.TriggeredByCouponOption.Value.Value);

            if (effectRemoveFromAudience.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectRemoveFromAudience.TriggeredForCatalogItemOption.Value.Value);

            if (effectRemoveFromAudience.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectRemoveFromAudience.ConditionIndexOption.Value.Value);

            if (effectRemoveFromAudience.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectRemoveFromAudience.EvaluationGroupIDOption.Value.Value);

            if (effectRemoveFromAudience.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectRemoveFromAudience.EvaluationGroupMode);

            if (effectRemoveFromAudience.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectRemoveFromAudience.CampaignRevisionIdOption.Value.Value);

            if (effectRemoveFromAudience.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectRemoveFromAudience.CampaignRevisionVersionIdOption.Value.Value);

            if (effectRemoveFromAudience.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectRemoveFromAudience.SelectedPriceType);

            if (effectRemoveFromAudience.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectRemoveFromAudience.SelectedPriceOption.Value.Value);

            if (effectRemoveFromAudience.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectRemoveFromAudience.AdjustmentReferenceIdOption.Value.Value);

            if (effectRemoveFromAudience.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectRemoveFromAudience.RewardIdOption.Value.Value);
        }
    }
}
