...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectRollbackAddedLoyaltyPoints : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRollbackAddedLoyaltyPoints" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;rollbackAddedLoyaltyPoints&#x60;.</param>
        /// <param name="props">The properties of the &#x60;rollbackAddedLoyaltyPoints&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;rollbackAddedLoyaltyPoints&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum RollbackAddedLoyaltyPoints for value: rollbackAddedLoyaltyPoints
            /// </summary>
            RollbackAddedLoyaltyPoints = 1
        }
        ...
        {
            if (value.Equals("rollbackAddedLoyaltyPoints"))
                return EffectTypeEnum.RollbackAddedLoyaltyPoints;
        ...
        {
            if (value == EffectTypeEnum.RollbackAddedLoyaltyPoints)
                return "rollbackAddedLoyaltyPoints";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;rollbackAddedLoyaltyPoints&#x60; effect.</value>
        [JsonPropertyName("props")]
        public RollbackAddedLoyaltyPointsEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectRollbackAddedLoyaltyPoints" />
    /// </summary>
    public partial class EffectRollbackAddedLoyaltyPointsJsonConverter : JsonConverter<EffectRollbackAddedLoyaltyPoints>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRollbackAddedLoyaltyPointsJsonConverter" /> class.
        /// </summary>
        public EffectRollbackAddedLoyaltyPointsJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectRollbackAddedLoyaltyPoints" />
        /// </summary>
        ...
        public override EffectRollbackAddedLoyaltyPoints Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectRollbackAddedLoyaltyPoints.EffectTypeEnum?> effectType = default;
            Option<RollbackAddedLoyaltyPointsEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectRollbackAddedLoyaltyPoints.EffectTypeEnum? effectTypeValue = EffectRollbackAddedLoyaltyPoints.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectRollbackAddedLoyaltyPoints.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<RollbackAddedLoyaltyPointsEffectProps>(JsonSerializer.Deserialize<RollbackAddedLoyaltyPointsEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackAddedLoyaltyPoints.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackAddedLoyaltyPoints.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackAddedLoyaltyPoints.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackAddedLoyaltyPoints.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackAddedLoyaltyPoints.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackAddedLoyaltyPoints.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectRollbackAddedLoyaltyPoints.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectRollbackAddedLoyaltyPoints.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectRollbackAddedLoyaltyPoints.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectRollbackAddedLoyaltyPoints.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectRollbackAddedLoyaltyPoints.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectRollbackAddedLoyaltyPoints.");

            return new EffectRollbackAddedLoyaltyPoints(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectRollbackAddedLoyaltyPoints" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRollbackAddedLoyaltyPoints"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectRollbackAddedLoyaltyPoints effectRollbackAddedLoyaltyPoints, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectRollbackAddedLoyaltyPoints, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectRollbackAddedLoyaltyPoints" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRollbackAddedLoyaltyPoints"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectRollbackAddedLoyaltyPoints effectRollbackAddedLoyaltyPoints, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectRollbackAddedLoyaltyPoints.RuleName == null)
                throw new ArgumentNullException(nameof(effectRollbackAddedLoyaltyPoints.RuleName), "Property is required for class EffectRollbackAddedLoyaltyPoints.");

            if (effectRollbackAddedLoyaltyPoints.Props == null)
                throw new ArgumentNullException(nameof(effectRollbackAddedLoyaltyPoints.Props), "Property is required for class EffectRollbackAddedLoyaltyPoints.");

            writer.WriteNumber("campaignId", effectRollbackAddedLoyaltyPoints.CampaignId);

            writer.WriteNumber("rulesetId", effectRollbackAddedLoyaltyPoints.RulesetId);

            writer.WriteNumber("ruleIndex", effectRollbackAddedLoyaltyPoints.RuleIndex);

            writer.WriteString("ruleName", effectRollbackAddedLoyaltyPoints.RuleName);

            var effectTypeRawValue = EffectRollbackAddedLoyaltyPoints.EffectTypeEnumToJsonValue(effectRollbackAddedLoyaltyPoints.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectRollbackAddedLoyaltyPoints.Props, jsonSerializerOptions);
            if (effectRollbackAddedLoyaltyPoints.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectRollbackAddedLoyaltyPoints.ExperimentIdOption.Value.Value);

            if (effectRollbackAddedLoyaltyPoints.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectRollbackAddedLoyaltyPoints.TriggeredByCouponOption.Value.Value);

            if (effectRollbackAddedLoyaltyPoints.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectRollbackAddedLoyaltyPoints.TriggeredForCatalogItemOption.Value.Value);

            if (effectRollbackAddedLoyaltyPoints.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectRollbackAddedLoyaltyPoints.ConditionIndexOption.Value.Value);

            if (effectRollbackAddedLoyaltyPoints.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectRollbackAddedLoyaltyPoints.EvaluationGroupIDOption.Value.Value);

            if (effectRollbackAddedLoyaltyPoints.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectRollbackAddedLoyaltyPoints.EvaluationGroupMode);

            if (effectRollbackAddedLoyaltyPoints.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectRollbackAddedLoyaltyPoints.CampaignRevisionIdOption.Value.Value);

            if (effectRollbackAddedLoyaltyPoints.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectRollbackAddedLoyaltyPoints.CampaignRevisionVersionIdOption.Value.Value);

            if (effectRollbackAddedLoyaltyPoints.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectRollbackAddedLoyaltyPoints.SelectedPriceType);

            if (effectRollbackAddedLoyaltyPoints.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectRollbackAddedLoyaltyPoints.SelectedPriceOption.Value.Value);

            if (effectRollbackAddedLoyaltyPoints.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectRollbackAddedLoyaltyPoints.AdjustmentReferenceIdOption.Value.Value);

            if (effectRollbackAddedLoyaltyPoints.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectRollbackAddedLoyaltyPoints.RewardIdOption.Value.Value);
        }
    }
}
