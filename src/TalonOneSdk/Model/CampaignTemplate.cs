...
namespace TalonOneSdk.Model
{
    ...
    public partial class CampaignTemplate : IValidatableObject
    {
        ...
        public List<CampaignTemplate.FeaturesEnum> Features { get { return this.FeaturesOption.Value; } set { this.FeaturesOption = new Option<List<CampaignTemplate.FeaturesEnum>>(value); } }
        ...
        public long? CampaignsCount { get { return this.CampaignsCountOption.Value; } set { this.CampaignsCountOption = new Option<long?>(value); } }
        ...
        public bool? IsUserFavorite { get { return this.IsUserFavoriteOption.Value; } set { this.IsUserFavoriteOption = new Option<bool?>(value); } }
    ...
    /// </summary>
    public partial class CampaignTemplateJsonConverter : JsonConverter<CampaignTemplate>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignTemplateJsonConverter" /> class.
        /// </summary>
        public CampaignTemplateJsonConverter()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "state":
                            ...
                            {
                                CampaignTemplate.StateEnum? stateValue = CampaignTemplate.StateEnumFromStringOrDefault(stateRawValue);
                                if (stateValue == null)
                                    throw new JsonException();
                                state = new Option<CampaignTemplate.StateEnum?>(stateValue);
                            }
                            break;
                        ...
                        case "campaignType":
                            ...
                            {
                                CampaignTemplate.CampaignTypeEnum? campaignTypeValue = CampaignTemplate.CampaignTypeEnumFromStringOrDefault(campaignTypeRawValue);
                                if (campaignTypeValue == null)
                                    throw new JsonException();
                                campaignType = new Option<CampaignTemplate.CampaignTypeEnum?>(campaignTypeValue);
                            }
                            break;
                        case "campaignsCount":
