...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class NewManagementKeyJsonConverter : JsonConverter<NewManagementKey>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="NewManagementKeyJsonConverter" /> class.
        /// </summary>
        public NewManagementKeyJsonConverter()
        {
            OnCreated();
        }
