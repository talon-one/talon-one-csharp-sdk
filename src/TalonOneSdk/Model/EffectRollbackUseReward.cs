...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectRollbackUseReward : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRollbackUseReward" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;rollbackUseReward&#x60;.</param>
        /// <param name="props">The properties of the &#x60;rollbackUseReward&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;rollbackUseReward&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum RollbackUseReward for value: rollbackUseReward
            /// </summary>
            RollbackUseReward = 1
        }
        ...
        {
            if (value.Equals("rollbackUseReward"))
                return EffectTypeEnum.RollbackUseReward;
        ...
        {
            if (value == EffectTypeEnum.RollbackUseReward)
                return "rollbackUseReward";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;rollbackUseReward&#x60; effect.</value>
        [JsonPropertyName("props")]
        public RollbackUseRewardEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectRollbackUseReward" />
    /// </summary>
    public partial class EffectRollbackUseRewardJsonConverter : JsonConverter<EffectRollbackUseReward>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRollbackUseRewardJsonConverter" /> class.
        /// </summary>
        public EffectRollbackUseRewardJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectRollbackUseReward" />
        /// </summary>
        ...
        public override EffectRollbackUseReward Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectRollbackUseReward.EffectTypeEnum?> effectType = default;
            Option<RollbackUseRewardEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectRollbackUseReward.EffectTypeEnum? effectTypeValue = EffectRollbackUseReward.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectRollbackUseReward.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<RollbackUseRewardEffectProps>(JsonSerializer.Deserialize<RollbackUseRewardEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackUseReward.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackUseReward.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackUseReward.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackUseReward.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackUseReward.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackUseReward.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectRollbackUseReward.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectRollbackUseReward.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectRollbackUseReward.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectRollbackUseReward.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectRollbackUseReward.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectRollbackUseReward.");

            return new EffectRollbackUseReward(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectRollbackUseReward" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRollbackUseReward"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectRollbackUseReward effectRollbackUseReward, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectRollbackUseReward, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectRollbackUseReward" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRollbackUseReward"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectRollbackUseReward effectRollbackUseReward, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectRollbackUseReward.RuleName == null)
                throw new ArgumentNullException(nameof(effectRollbackUseReward.RuleName), "Property is required for class EffectRollbackUseReward.");

            if (effectRollbackUseReward.Props == null)
                throw new ArgumentNullException(nameof(effectRollbackUseReward.Props), "Property is required for class EffectRollbackUseReward.");

            writer.WriteNumber("campaignId", effectRollbackUseReward.CampaignId);

            writer.WriteNumber("rulesetId", effectRollbackUseReward.RulesetId);

            writer.WriteNumber("ruleIndex", effectRollbackUseReward.RuleIndex);

            writer.WriteString("ruleName", effectRollbackUseReward.RuleName);

            var effectTypeRawValue = EffectRollbackUseReward.EffectTypeEnumToJsonValue(effectRollbackUseReward.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectRollbackUseReward.Props, jsonSerializerOptions);
            if (effectRollbackUseReward.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectRollbackUseReward.ExperimentIdOption.Value.Value);

            if (effectRollbackUseReward.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectRollbackUseReward.TriggeredByCouponOption.Value.Value);

            if (effectRollbackUseReward.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectRollbackUseReward.TriggeredForCatalogItemOption.Value.Value);

            if (effectRollbackUseReward.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectRollbackUseReward.ConditionIndexOption.Value.Value);

            if (effectRollbackUseReward.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectRollbackUseReward.EvaluationGroupIDOption.Value.Value);

            if (effectRollbackUseReward.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectRollbackUseReward.EvaluationGroupMode);

            if (effectRollbackUseReward.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectRollbackUseReward.CampaignRevisionIdOption.Value.Value);

            if (effectRollbackUseReward.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectRollbackUseReward.CampaignRevisionVersionIdOption.Value.Value);

            if (effectRollbackUseReward.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectRollbackUseReward.SelectedPriceType);

            if (effectRollbackUseReward.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectRollbackUseReward.SelectedPriceOption.Value.Value);

            if (effectRollbackUseReward.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectRollbackUseReward.AdjustmentReferenceIdOption.Value.Value);

            if (effectRollbackUseReward.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectRollbackUseReward.RewardIdOption.Value.Value);
        }
    }
}
