...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class UpdateExperimentJsonConverter : JsonConverter<UpdateExperiment>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateExperimentJsonConverter" /> class.
        /// </summary>
        public UpdateExperimentJsonConverter()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "goalType":
                            ...
                            {
                                UpdateExperiment.GoalTypeEnum? goalTypeValue = UpdateExperiment.GoalTypeEnumFromStringOrDefault(goalTypeRawValue);
                                if (goalTypeValue == null)
                                    throw new JsonException();
                                goalType = new Option<UpdateExperiment.GoalTypeEnum?>(goalTypeValue);
                            }
                            break;
