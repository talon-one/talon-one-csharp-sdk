...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class GiveawaysPoolJsonConverter : JsonConverter<GiveawaysPool>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="GiveawaysPoolJsonConverter" /> class.
        /// </summary>
        public GiveawaysPoolJsonConverter()
        {
            OnCreated();
        }
