...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectRejectReferral : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRejectReferral" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;rejectReferral&#x60;.</param>
        /// <param name="props">The properties of the &#x60;rejectReferral&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;rejectReferral&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum RejectReferral for value: rejectReferral
            /// </summary>
            RejectReferral = 1
        }
        ...
        {
            if (value.Equals("rejectReferral"))
                return EffectTypeEnum.RejectReferral;
        ...
        {
            if (value == EffectTypeEnum.RejectReferral)
        ...
        /// </summary>
        /// <value>The properties of the &#x60;rejectReferral&#x60; effect.</value>
        [JsonPropertyName("props")]
        public RejectReferralEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectRejectReferral" />
    /// </summary>
    public partial class EffectRejectReferralJsonConverter : JsonConverter<EffectRejectReferral>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRejectReferralJsonConverter" /> class.
        /// </summary>
        public EffectRejectReferralJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectRejectReferral" />
        /// </summary>
        ...
        public override EffectRejectReferral Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectRejectReferral.EffectTypeEnum?> effectType = default;
            Option<RejectReferralEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectRejectReferral.EffectTypeEnum? effectTypeValue = EffectRejectReferral.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectRejectReferral.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<RejectReferralEffectProps>(JsonSerializer.Deserialize<RejectReferralEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectRejectReferral.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectRejectReferral.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectRejectReferral.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectRejectReferral.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectRejectReferral.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectRejectReferral.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectRejectReferral.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectRejectReferral.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectRejectReferral.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectRejectReferral.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectRejectReferral.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectRejectReferral.");

            return new EffectRejectReferral(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectRejectReferral" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRejectReferral"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectRejectReferral effectRejectReferral, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectRejectReferral, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectRejectReferral" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRejectReferral"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectRejectReferral effectRejectReferral, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectRejectReferral.RuleName == null)
                throw new ArgumentNullException(nameof(effectRejectReferral.RuleName), "Property is required for class EffectRejectReferral.");

            if (effectRejectReferral.Props == null)
                throw new ArgumentNullException(nameof(effectRejectReferral.Props), "Property is required for class EffectRejectReferral.");

            writer.WriteNumber("campaignId", effectRejectReferral.CampaignId);

            writer.WriteNumber("rulesetId", effectRejectReferral.RulesetId);

            writer.WriteNumber("ruleIndex", effectRejectReferral.RuleIndex);

            writer.WriteString("ruleName", effectRejectReferral.RuleName);

            var effectTypeRawValue = EffectRejectReferral.EffectTypeEnumToJsonValue(effectRejectReferral.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectRejectReferral.Props, jsonSerializerOptions);
            if (effectRejectReferral.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectRejectReferral.ExperimentIdOption.Value.Value);

            if (effectRejectReferral.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectRejectReferral.TriggeredByCouponOption.Value.Value);

            if (effectRejectReferral.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectRejectReferral.TriggeredForCatalogItemOption.Value.Value);

            if (effectRejectReferral.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectRejectReferral.ConditionIndexOption.Value.Value);

            if (effectRejectReferral.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectRejectReferral.EvaluationGroupIDOption.Value.Value);

            if (effectRejectReferral.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectRejectReferral.EvaluationGroupMode);

            if (effectRejectReferral.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectRejectReferral.CampaignRevisionIdOption.Value.Value);

            if (effectRejectReferral.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectRejectReferral.CampaignRevisionVersionIdOption.Value.Value);

            if (effectRejectReferral.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectRejectReferral.SelectedPriceType);

            if (effectRejectReferral.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectRejectReferral.SelectedPriceOption.Value.Value);

            if (effectRejectReferral.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectRejectReferral.AdjustmentReferenceIdOption.Value.Value);

            if (effectRejectReferral.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectRejectReferral.RewardIdOption.Value.Value);
        }
    }
}
