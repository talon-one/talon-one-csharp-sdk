...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class AddLoyaltyPointsSupport : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddLoyaltyPointsSupport" /> class.
        /// </summary>
        ...
        /// <param name="supportRequestId">ID of the support request to approve. When provided by an admin, the points are added on behalf of the support user who created the request.</param>
        /// <param name="processingNote">Note from the admin approving the support request. Stored as the processing note on the support request record. This is only used when a supportRequestId is passed.</param>
        [JsonConstructor]
        public AddLoyaltyPointsSupport(decimal points, Option<string> name = default, Option<string> validityDuration = default, Option<DateTime?> validUntil = default, Option<string> pendingDuration = default, Option<DateTime?> pendingUntil = default, Option<string> subledgerId = default, Option<long?> applicationId = default, Option<long?> supportRequestId = default, Option<string> processingNote = default)
        {
            Points = points;
            NameOption = name;
        ...
        /// </summary>
        /// <value>ID of the support request to approve. When provided by an admin, the points are added on behalf of the support user who created the request.</value>
        /* <example>42</example> */
        ...
        /// </summary>
        /// <value>Note from the admin approving the support request. Stored as the processing note on the support request record. This is only used when a supportRequestId is passed.</value>
        /* <example>Approved after manual review.</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="AddLoyaltyPointsSupport" />
    /// </summary>
    public partial class AddLoyaltyPointsSupportJsonConverter : JsonConverter<AddLoyaltyPointsSupport>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="AddLoyaltyPointsSupportJsonConverter" /> class.
        /// </summary>
        public AddLoyaltyPointsSupportJsonConverter()
        {
            OnCreated();
        }
        ...
        /// <summary>
        /// Deserializes json to <see cref="AddLoyaltyPointsSupport" />
        /// </summary>
        ...
        public override AddLoyaltyPointsSupport Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!points.IsSet)
                throw new ArgumentException("Property is required for class AddLoyaltyPointsSupport.", nameof(points));

            if (points.IsSet && points.Value == null)
                throw new ArgumentNullException(nameof(points), "Property is not nullable for class AddLoyaltyPointsSupport.");

            return new AddLoyaltyPointsSupport(points.Value.Value, name, validityDuration, validUntil, pendingDuration, pendingUntil, subledgerId, applicationId, supportRequestId, processingNote);
        }

        /// <summary>
        /// Serializes a <see cref="AddLoyaltyPointsSupport" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addLoyaltyPointsSupport"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AddLoyaltyPointsSupport addLoyaltyPointsSupport, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, addLoyaltyPointsSupport, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AddLoyaltyPointsSupport" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addLoyaltyPointsSupport"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AddLoyaltyPointsSupport addLoyaltyPointsSupport, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteNumber("points", addLoyaltyPointsSupport.Points);

            if (addLoyaltyPointsSupport.NameOption.IsSet)
                writer.WriteString("name", addLoyaltyPointsSupport.Name);

            if (addLoyaltyPointsSupport.ValidityDurationOption.IsSet)
                writer.WriteString("validityDuration", addLoyaltyPointsSupport.ValidityDuration);

            if (addLoyaltyPointsSupport.ValidUntilOption.IsSet)
                writer.WriteString("validUntil", addLoyaltyPointsSupport.ValidUntilOption.Value.Value.ToString(ValidUntilFormat));

            if (addLoyaltyPointsSupport.PendingDurationOption.IsSet)
                writer.WriteString("pendingDuration", addLoyaltyPointsSupport.PendingDuration);

            if (addLoyaltyPointsSupport.PendingUntilOption.IsSet)
                writer.WriteString("pendingUntil", addLoyaltyPointsSupport.PendingUntilOption.Value.Value.ToString(PendingUntilFormat));

            if (addLoyaltyPointsSupport.SubledgerIdOption.IsSet)
                writer.WriteString("subledgerId", addLoyaltyPointsSupport.SubledgerId);

            if (addLoyaltyPointsSupport.ApplicationIdOption.IsSet)
                writer.WriteNumber("applicationId", addLoyaltyPointsSupport.ApplicationIdOption.Value.Value);

            if (addLoyaltyPointsSupport.SupportRequestIdOption.IsSet)
                writer.WriteNumber("supportRequestId", addLoyaltyPointsSupport.SupportRequestIdOption.Value.Value);

            if (addLoyaltyPointsSupport.ProcessingNoteOption.IsSet)
                writer.WriteString("processingNote", addLoyaltyPointsSupport.ProcessingNote);
        }
    }
}
