...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CouponWithApplication : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="applicationName">Name of the Application that is connected to the coupon.</param>
        ...
        /* <example>Test Application</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="CouponWithApplication" />
    /// </summary>
    public partial class CouponWithApplicationJsonConverter : JsonConverter<CouponWithApplication>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CouponWithApplicationJsonConverter" /> class.
        /// </summary>
        public CouponWithApplicationJsonConverter()
        {
            OnCreated();
        }
        ...
        /// <summary>
        /// Deserializes json to <see cref="CouponWithApplication" />
        /// </summary>
        ...
        public override CouponWithApplication Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!id.IsSet)
                throw new ArgumentException("Property is required for class CouponWithApplication.", nameof(id));

            if (!created.IsSet)
                throw new ArgumentException("Property is required for class CouponWithApplication.", nameof(created));

            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class CouponWithApplication.", nameof(campaignId));

            if (!usageCounter.IsSet)
                throw new ArgumentException("Property is required for class CouponWithApplication.", nameof(usageCounter));

            if (!applicationId.IsSet)
                throw new ArgumentException("Property is required for class CouponWithApplication.", nameof(applicationId));
        ...
        /// <summary>
        /// Serializes a <see cref="CouponWithApplication" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="couponWithApplication"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CouponWithApplication couponWithApplication, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, couponWithApplication, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CouponWithApplication" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="couponWithApplication"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CouponWithApplication couponWithApplication, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteString("created", couponWithApplication.Created.ToString(CreatedFormat));

            writer.WriteNumber("campaignId", couponWithApplication.CampaignId);

            writer.WriteNumber("usageCounter", couponWithApplication.UsageCounter);

            writer.WriteNumber("applicationId", couponWithApplication.ApplicationId);

            writer.WriteString("applicationName", couponWithApplication.ApplicationName);

            if (couponWithApplication.ValueOption.IsSet)
                writer.WriteString("value", couponWithApplication.Value);

            if (couponWithApplication.UsageLimitOption.IsSet)
                writer.WriteNumber("usageLimit", couponWithApplication.UsageLimitOption.Value.Value);

            if (couponWithApplication.DiscountLimitOption.IsSet)
                writer.WriteNumber("discountLimit", couponWithApplication.DiscountLimitOption.Value.Value);

            if (couponWithApplication.ReservationLimitOption.IsSet)
                writer.WriteNumber("reservationLimit", couponWithApplication.ReservationLimitOption.Value.Value);

            if (couponWithApplication.StartDateOption.IsSet)
                writer.WriteString("startDate", couponWithApplication.StartDateOption.Value.Value.ToString(StartDateFormat));

            if (couponWithApplication.ExpiryDateOption.IsSet)
                writer.WriteString("expiryDate", couponWithApplication.ExpiryDateOption.Value.Value.ToString(ExpiryDateFormat));

            if (couponWithApplication.LimitsOption.IsSet)
            {
                writer.WritePropertyName("limits");
                JsonSerializer.Serialize(writer, couponWithApplication.Limits, jsonSerializerOptions);
            }
            if (couponWithApplication.DiscountCounterOption.IsSet)
                writer.WriteNumber("discountCounter", couponWithApplication.DiscountCounterOption.Value.Value);

            if (couponWithApplication.DiscountRemainderOption.IsSet)
                writer.WriteNumber("discountRemainder", couponWithApplication.DiscountRemainderOption.Value.Value);

            if (couponWithApplication.ReservationCounterOption.IsSet)
                writer.WriteNumber("reservationCounter", couponWithApplication.ReservationCounterOption.Value.Value);

            if (couponWithApplication.AttributesOption.IsSet)
            {
                writer.WritePropertyName("attributes");
                JsonSerializer.Serialize(writer, couponWithApplication.Attributes, jsonSerializerOptions);
            }
            if (couponWithApplication.ReferralIdOption.IsSet)
                writer.WriteNumber("referralId", couponWithApplication.ReferralIdOption.Value.Value);

            if (couponWithApplication.RecipientIntegrationIdOption.IsSet)
                writer.WriteString("recipientIntegrationId", couponWithApplication.RecipientIntegrationId);

            if (couponWithApplication.ImportIdOption.IsSet)
                writer.WriteNumber("importId", couponWithApplication.ImportIdOption.Value.Value);

            if (couponWithApplication.ReservationOption.IsSet)
                writer.WriteBoolean("reservation", couponWithApplication.ReservationOption.Value.Value);

            if (couponWithApplication.BatchIdOption.IsSet)
                writer.WriteString("batchId", couponWithApplication.BatchId);

            if (couponWithApplication.IsReservationMandatoryOption.IsSet)
                writer.WriteBoolean("isReservationMandatory", couponWithApplication.IsReservationMandatoryOption.Value.Value);

            if (couponWithApplication.ImplicitlyReservedOption.IsSet)
                writer.WriteBoolean("implicitlyReserved", couponWithApplication.ImplicitlyReservedOption.Value.Value);
        }
    }
}
