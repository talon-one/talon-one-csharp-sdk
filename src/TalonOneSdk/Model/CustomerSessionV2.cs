...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CustomerSessionV2JsonConverter : JsonConverter<CustomerSessionV2>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerSessionV2JsonConverter" /> class.
        /// </summary>
        public CustomerSessionV2JsonConverter()
        {
            OnCreated();
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CustomerSessionV2 customerSessionV2, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (customerSessionV2.ExperimentVariantAllocationsOption.IsSet)
            {
                writer.WritePropertyName("experimentVariantAllocations");
                JsonSerializer.Serialize(writer, customerSessionV2.ExperimentVariantAllocations, jsonSerializerOptions);
            }
