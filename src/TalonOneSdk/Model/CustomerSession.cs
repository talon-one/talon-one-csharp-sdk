...
namespace TalonOneSdk.Model
{
    ...
    public partial class CustomerSessionJsonConverter : JsonConverter<CustomerSession>
    {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "state":
                            ...
                            {
                                CustomerSession.StateEnum? stateValue = CustomerSession.StateEnumFromStringOrDefault(stateRawValue);
                                if (stateValue == null)
                                    throw new JsonException();
                                state = new Option<CustomerSession.StateEnum?>(stateValue);
                            }
                            break;
                        case "cartItems":
        ...
        public void WriteProperties(Utf8JsonWriter writer, CustomerSession customerSession, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (customerSession.StateOption.IsSet)
            {
                var stateRawValue = CustomerSession.StateEnumToJsonValue(customerSession.StateOption.Value);
