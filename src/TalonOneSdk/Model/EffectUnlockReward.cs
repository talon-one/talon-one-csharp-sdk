...
namespace TalonOneSdk.Model
{
    ...
    /// EffectUnlockReward
    /// </summary>
    public partial class EffectUnlockReward : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectUnlockReward" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;unlockReward&#x60;.</param>
        /// <param name="props">The properties of the &#x60;unlockReward&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;unlockReward&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum UnlockReward for value: unlockReward
            /// </summary>
            UnlockReward = 1
        }
        ...
        {
            if (value.Equals("unlockReward"))
                return EffectTypeEnum.UnlockReward;
        ...
        {
            if (value == EffectTypeEnum.UnlockReward)
                return "unlockReward";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;unlockReward&#x60; effect.</value>
        [JsonPropertyName("props")]
        public UnlockRewardEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectUnlockReward" />
    /// </summary>
    public partial class EffectUnlockRewardJsonConverter : JsonConverter<EffectUnlockReward>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectUnlockRewardJsonConverter" /> class.
        /// </summary>
        public EffectUnlockRewardJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectUnlockReward" />
        /// </summary>
        ...
        public override EffectUnlockReward Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectUnlockReward.EffectTypeEnum?> effectType = default;
            Option<UnlockRewardEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectUnlockReward.EffectTypeEnum? effectTypeValue = EffectUnlockReward.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectUnlockReward.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<UnlockRewardEffectProps>(JsonSerializer.Deserialize<UnlockRewardEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectUnlockReward.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectUnlockReward.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectUnlockReward.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectUnlockReward.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectUnlockReward.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectUnlockReward.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectUnlockReward.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectUnlockReward.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectUnlockReward.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectUnlockReward.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectUnlockReward.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectUnlockReward.");

            return new EffectUnlockReward(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectUnlockReward" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectUnlockReward"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectUnlockReward effectUnlockReward, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectUnlockReward, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectUnlockReward" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectUnlockReward"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectUnlockReward effectUnlockReward, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectUnlockReward.RuleName == null)
                throw new ArgumentNullException(nameof(effectUnlockReward.RuleName), "Property is required for class EffectUnlockReward.");

            if (effectUnlockReward.Props == null)
                throw new ArgumentNullException(nameof(effectUnlockReward.Props), "Property is required for class EffectUnlockReward.");

            writer.WriteNumber("campaignId", effectUnlockReward.CampaignId);

            writer.WriteNumber("rulesetId", effectUnlockReward.RulesetId);

            writer.WriteNumber("ruleIndex", effectUnlockReward.RuleIndex);

            writer.WriteString("ruleName", effectUnlockReward.RuleName);

            var effectTypeRawValue = EffectUnlockReward.EffectTypeEnumToJsonValue(effectUnlockReward.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectUnlockReward.Props, jsonSerializerOptions);
            if (effectUnlockReward.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectUnlockReward.ExperimentIdOption.Value.Value);

            if (effectUnlockReward.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectUnlockReward.TriggeredByCouponOption.Value.Value);

            if (effectUnlockReward.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectUnlockReward.TriggeredForCatalogItemOption.Value.Value);

            if (effectUnlockReward.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectUnlockReward.ConditionIndexOption.Value.Value);

            if (effectUnlockReward.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectUnlockReward.EvaluationGroupIDOption.Value.Value);

            if (effectUnlockReward.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectUnlockReward.EvaluationGroupMode);

            if (effectUnlockReward.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectUnlockReward.CampaignRevisionIdOption.Value.Value);

            if (effectUnlockReward.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectUnlockReward.CampaignRevisionVersionIdOption.Value.Value);

            if (effectUnlockReward.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectUnlockReward.SelectedPriceType);

            if (effectUnlockReward.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectUnlockReward.SelectedPriceOption.Value.Value);

            if (effectUnlockReward.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectUnlockReward.AdjustmentReferenceIdOption.Value.Value);

            if (effectUnlockReward.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectUnlockReward.RewardIdOption.Value.Value);
        }
    }
}
