...
namespace TalonOneSdk.Model
{
    ...
    /// NewReferral
    /// </summary>
    public partial class NewReferral : IValidatableObject
    {
        /// <summary>
    ...
    public class NewReferralJsonConverter : JsonConverter<NewReferral>
    {
        ...
        public override NewReferral Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class NewReferral.", nameof(campaignId));
        ...
        /// <summary>
        /// Serializes a <see cref="NewReferral" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="newReferral"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, NewReferral newReferral, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, newReferral, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="NewReferral" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="newReferral"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, NewReferral newReferral, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteString("advocateProfileIntegrationId", newReferral.AdvocateProfileIntegrationId);

            if (newReferral.StartDateOption.IsSet)
                writer.WriteString("startDate", newReferral.StartDateOption.Value.Value.ToString(StartDateFormat));

            if (newReferral.ExpiryDateOption.IsSet)
                writer.WriteString("expiryDate", newReferral.ExpiryDateOption.Value.Value.ToString(ExpiryDateFormat));

            if (newReferral.UsageLimitOption.IsSet)
                writer.WriteNumber("usageLimit", newReferral.UsageLimitOption.Value.Value);

            if (newReferral.FriendProfileIntegrationIdOption.IsSet)
                writer.WriteString("friendProfileIntegrationId", newReferral.FriendProfileIntegrationId);

            if (newReferral.AttributesOption.IsSet)
            {
                writer.WritePropertyName("attributes");
                JsonSerializer.Serialize(writer, newReferral.Attributes, jsonSerializerOptions);
            }
        }
    }
}
