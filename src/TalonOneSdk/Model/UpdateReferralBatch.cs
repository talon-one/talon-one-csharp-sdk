...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class UpdateReferralBatchJsonConverter : JsonConverter<UpdateReferralBatch>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateReferralBatchJsonConverter" /> class.
        /// </summary>
        public UpdateReferralBatchJsonConverter()
        {
            OnCreated();
        }
