...
namespace TalonOneSdk.Model
{
    ...
    /// EffectReserveCoupon
    /// </summary>
    public partial class EffectReserveCoupon : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectReserveCoupon" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;reserveCoupon&#x60;.</param>
        /// <param name="props">The properties of the &#x60;reserveCoupon&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;reserveCoupon&#x60;.</value>
        ...
        public static EffectTypeEnum EffectTypeEnumFromString(string value)
        {
            if (value.Equals("reserveCoupon"))
                return EffectTypeEnum.ReserveCoupon;
        ...
        {
            if (value == EffectTypeEnum.ReserveCoupon)
        ...
        /// </summary>
        /// <value>The properties of the &#x60;reserveCoupon&#x60; effect.</value>
        [JsonPropertyName("props")]
        public ReserveCouponEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectReserveCoupon" />
    /// </summary>
    public partial class EffectReserveCouponJsonConverter : JsonConverter<EffectReserveCoupon>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectReserveCouponJsonConverter" /> class.
        /// </summary>
        public EffectReserveCouponJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectReserveCoupon" />
        /// </summary>
        ...
        public override EffectReserveCoupon Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectReserveCoupon.EffectTypeEnum?> effectType = default;
            Option<ReserveCouponEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectReserveCoupon.EffectTypeEnum? effectTypeValue = EffectReserveCoupon.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectReserveCoupon.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<ReserveCouponEffectProps>(JsonSerializer.Deserialize<ReserveCouponEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectReserveCoupon.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectReserveCoupon.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectReserveCoupon.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectReserveCoupon.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectReserveCoupon.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectReserveCoupon.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectReserveCoupon.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectReserveCoupon.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectReserveCoupon.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectReserveCoupon.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectReserveCoupon.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectReserveCoupon.");

            return new EffectReserveCoupon(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectReserveCoupon" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectReserveCoupon"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectReserveCoupon effectReserveCoupon, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectReserveCoupon, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectReserveCoupon" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectReserveCoupon"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectReserveCoupon effectReserveCoupon, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectReserveCoupon.RuleName == null)
                throw new ArgumentNullException(nameof(effectReserveCoupon.RuleName), "Property is required for class EffectReserveCoupon.");

            if (effectReserveCoupon.Props == null)
                throw new ArgumentNullException(nameof(effectReserveCoupon.Props), "Property is required for class EffectReserveCoupon.");

            writer.WriteNumber("campaignId", effectReserveCoupon.CampaignId);

            writer.WriteNumber("rulesetId", effectReserveCoupon.RulesetId);

            writer.WriteNumber("ruleIndex", effectReserveCoupon.RuleIndex);

            writer.WriteString("ruleName", effectReserveCoupon.RuleName);

            var effectTypeRawValue = EffectReserveCoupon.EffectTypeEnumToJsonValue(effectReserveCoupon.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectReserveCoupon.Props, jsonSerializerOptions);
            if (effectReserveCoupon.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectReserveCoupon.ExperimentIdOption.Value.Value);

            if (effectReserveCoupon.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectReserveCoupon.TriggeredByCouponOption.Value.Value);

            if (effectReserveCoupon.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectReserveCoupon.TriggeredForCatalogItemOption.Value.Value);

            if (effectReserveCoupon.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectReserveCoupon.ConditionIndexOption.Value.Value);

            if (effectReserveCoupon.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectReserveCoupon.EvaluationGroupIDOption.Value.Value);

            if (effectReserveCoupon.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectReserveCoupon.EvaluationGroupMode);

            if (effectReserveCoupon.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectReserveCoupon.CampaignRevisionIdOption.Value.Value);

            if (effectReserveCoupon.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectReserveCoupon.CampaignRevisionVersionIdOption.Value.Value);

            if (effectReserveCoupon.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectReserveCoupon.SelectedPriceType);

            if (effectReserveCoupon.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectReserveCoupon.SelectedPriceOption.Value.Value);

            if (effectReserveCoupon.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectReserveCoupon.AdjustmentReferenceIdOption.Value.Value);

            if (effectReserveCoupon.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectReserveCoupon.RewardIdOption.Value.Value);
        }
    }
}
