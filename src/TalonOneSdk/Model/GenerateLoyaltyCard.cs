...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class GenerateLoyaltyCardJsonConverter : JsonConverter<GenerateLoyaltyCard>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateLoyaltyCardJsonConverter" /> class.
        /// </summary>
        public GenerateLoyaltyCardJsonConverter()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "status":
                            ...
                            {
                                GenerateLoyaltyCard.StatusEnum? statusValue = GenerateLoyaltyCard.StatusEnumFromStringOrDefault(statusRawValue);
                                if (statusValue == null)
                                    throw new JsonException();
                                status = new Option<GenerateLoyaltyCard.StatusEnum?>(statusValue);
                            }
                            break;
