...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CreateAchievementJsonConverter : JsonConverter<CreateAchievement>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAchievementJsonConverter" /> class.
        /// </summary>
        public CreateAchievementJsonConverter()
        {
            OnCreated();
        }
