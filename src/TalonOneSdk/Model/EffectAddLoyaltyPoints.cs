...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectAddLoyaltyPoints : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectAddLoyaltyPoints" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;addLoyaltyPoints&#x60;.</param>
        /// <param name="props">The properties of the &#x60;addLoyaltyPoints&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;addLoyaltyPoints&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum AddLoyaltyPoints for value: addLoyaltyPoints
            /// </summary>
            AddLoyaltyPoints = 1
        }
        ...
        {
            if (value.Equals("addLoyaltyPoints"))
                return EffectTypeEnum.AddLoyaltyPoints;
        ...
        {
            if (value == EffectTypeEnum.AddLoyaltyPoints)
        ...
        /// </summary>
        /// <value>The properties of the &#x60;addLoyaltyPoints&#x60; effect.</value>
        [JsonPropertyName("props")]
        public AddLoyaltyPointsEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectAddLoyaltyPoints" />
    /// </summary>
    public partial class EffectAddLoyaltyPointsJsonConverter : JsonConverter<EffectAddLoyaltyPoints>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectAddLoyaltyPointsJsonConverter" /> class.
        /// </summary>
        public EffectAddLoyaltyPointsJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectAddLoyaltyPoints" />
        /// </summary>
        ...
        public override EffectAddLoyaltyPoints Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectAddLoyaltyPoints.EffectTypeEnum?> effectType = default;
            Option<AddLoyaltyPointsEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectAddLoyaltyPoints.EffectTypeEnum? effectTypeValue = EffectAddLoyaltyPoints.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectAddLoyaltyPoints.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<AddLoyaltyPointsEffectProps>(JsonSerializer.Deserialize<AddLoyaltyPointsEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectAddLoyaltyPoints.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectAddLoyaltyPoints.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectAddLoyaltyPoints.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectAddLoyaltyPoints.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectAddLoyaltyPoints.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectAddLoyaltyPoints.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectAddLoyaltyPoints.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectAddLoyaltyPoints.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectAddLoyaltyPoints.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectAddLoyaltyPoints.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectAddLoyaltyPoints.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectAddLoyaltyPoints.");

            return new EffectAddLoyaltyPoints(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectAddLoyaltyPoints" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectAddLoyaltyPoints"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectAddLoyaltyPoints effectAddLoyaltyPoints, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectAddLoyaltyPoints, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectAddLoyaltyPoints" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectAddLoyaltyPoints"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectAddLoyaltyPoints effectAddLoyaltyPoints, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectAddLoyaltyPoints.RuleName == null)
                throw new ArgumentNullException(nameof(effectAddLoyaltyPoints.RuleName), "Property is required for class EffectAddLoyaltyPoints.");

            if (effectAddLoyaltyPoints.Props == null)
                throw new ArgumentNullException(nameof(effectAddLoyaltyPoints.Props), "Property is required for class EffectAddLoyaltyPoints.");

            writer.WriteNumber("campaignId", effectAddLoyaltyPoints.CampaignId);

            writer.WriteNumber("rulesetId", effectAddLoyaltyPoints.RulesetId);

            writer.WriteNumber("ruleIndex", effectAddLoyaltyPoints.RuleIndex);

            writer.WriteString("ruleName", effectAddLoyaltyPoints.RuleName);

            var effectTypeRawValue = EffectAddLoyaltyPoints.EffectTypeEnumToJsonValue(effectAddLoyaltyPoints.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectAddLoyaltyPoints.Props, jsonSerializerOptions);
            if (effectAddLoyaltyPoints.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectAddLoyaltyPoints.ExperimentIdOption.Value.Value);

            if (effectAddLoyaltyPoints.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectAddLoyaltyPoints.TriggeredByCouponOption.Value.Value);

            if (effectAddLoyaltyPoints.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectAddLoyaltyPoints.TriggeredForCatalogItemOption.Value.Value);

            if (effectAddLoyaltyPoints.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectAddLoyaltyPoints.ConditionIndexOption.Value.Value);

            if (effectAddLoyaltyPoints.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectAddLoyaltyPoints.EvaluationGroupIDOption.Value.Value);

            if (effectAddLoyaltyPoints.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectAddLoyaltyPoints.EvaluationGroupMode);

            if (effectAddLoyaltyPoints.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectAddLoyaltyPoints.CampaignRevisionIdOption.Value.Value);

            if (effectAddLoyaltyPoints.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectAddLoyaltyPoints.CampaignRevisionVersionIdOption.Value.Value);

            if (effectAddLoyaltyPoints.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectAddLoyaltyPoints.SelectedPriceType);

            if (effectAddLoyaltyPoints.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectAddLoyaltyPoints.SelectedPriceOption.Value.Value);

            if (effectAddLoyaltyPoints.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectAddLoyaltyPoints.AdjustmentReferenceIdOption.Value.Value);

            if (effectAddLoyaltyPoints.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectAddLoyaltyPoints.RewardIdOption.Value.Value);
        }
    }
}
