...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class ScimServiceProviderConfigResponseSortJsonConverter : JsonConverter<ScimServiceProviderConfigResponseSort>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ScimServiceProviderConfigResponseSortJsonConverter" /> class.
        /// </summary>
        public ScimServiceProviderConfigResponseSortJsonConverter()
        {
            OnCreated();
        }
