...
namespace TalonOneSdk.Model
{
    ...
    public class ExperimentVariantJsonConverter : JsonConverter<ExperimentVariant>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, ExperimentVariant experimentVariant, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (experimentVariant.RulesetOption.IsSet && experimentVariant.Ruleset == null)
                throw new ArgumentNullException(nameof(experimentVariant.Ruleset), "Property is required for class ExperimentVariant.");
