...
namespace TalonOneSdk.Model
{
    ...
    /// EffectCustomEffect
    /// </summary>
    public partial class EffectCustomEffect : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectCustomEffect" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;customEffect&#x60;.</param>
        /// <param name="props">The properties of the &#x60;customEffect&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;customEffect&#x60;.</value>
        ...
        public static EffectTypeEnum EffectTypeEnumFromString(string value)
        {
            if (value.Equals("customEffect"))
                return EffectTypeEnum.CustomEffect;
        ...
        {
            if (value == EffectTypeEnum.CustomEffect)
                return "customEffect";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;customEffect&#x60; effect.</value>
        [JsonPropertyName("props")]
        public CustomEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectCustomEffect" />
    /// </summary>
    public partial class EffectCustomEffectJsonConverter : JsonConverter<EffectCustomEffect>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectCustomEffectJsonConverter" /> class.
        /// </summary>
        public EffectCustomEffectJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectCustomEffect" />
        /// </summary>
        ...
        public override EffectCustomEffect Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectCustomEffect.EffectTypeEnum?> effectType = default;
            Option<CustomEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectCustomEffect.EffectTypeEnum? effectTypeValue = EffectCustomEffect.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectCustomEffect.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<CustomEffectProps>(JsonSerializer.Deserialize<CustomEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectCustomEffect.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectCustomEffect.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectCustomEffect.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectCustomEffect.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectCustomEffect.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectCustomEffect.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectCustomEffect.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectCustomEffect.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectCustomEffect.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectCustomEffect.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectCustomEffect.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectCustomEffect.");

            return new EffectCustomEffect(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectCustomEffect" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectCustomEffect"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectCustomEffect effectCustomEffect, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectCustomEffect, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectCustomEffect" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectCustomEffect"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectCustomEffect effectCustomEffect, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectCustomEffect.RuleName == null)
                throw new ArgumentNullException(nameof(effectCustomEffect.RuleName), "Property is required for class EffectCustomEffect.");

            if (effectCustomEffect.Props == null)
                throw new ArgumentNullException(nameof(effectCustomEffect.Props), "Property is required for class EffectCustomEffect.");

            writer.WriteNumber("campaignId", effectCustomEffect.CampaignId);

            writer.WriteNumber("rulesetId", effectCustomEffect.RulesetId);

            writer.WriteNumber("ruleIndex", effectCustomEffect.RuleIndex);

            writer.WriteString("ruleName", effectCustomEffect.RuleName);

            var effectTypeRawValue = EffectCustomEffect.EffectTypeEnumToJsonValue(effectCustomEffect.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectCustomEffect.Props, jsonSerializerOptions);
            if (effectCustomEffect.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectCustomEffect.ExperimentIdOption.Value.Value);

            if (effectCustomEffect.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectCustomEffect.TriggeredByCouponOption.Value.Value);

            if (effectCustomEffect.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectCustomEffect.TriggeredForCatalogItemOption.Value.Value);

            if (effectCustomEffect.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectCustomEffect.ConditionIndexOption.Value.Value);

            if (effectCustomEffect.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectCustomEffect.EvaluationGroupIDOption.Value.Value);

            if (effectCustomEffect.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectCustomEffect.EvaluationGroupMode);

            if (effectCustomEffect.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectCustomEffect.CampaignRevisionIdOption.Value.Value);

            if (effectCustomEffect.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectCustomEffect.CampaignRevisionVersionIdOption.Value.Value);

            if (effectCustomEffect.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectCustomEffect.SelectedPriceType);

            if (effectCustomEffect.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectCustomEffect.SelectedPriceOption.Value.Value);

            if (effectCustomEffect.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectCustomEffect.AdjustmentReferenceIdOption.Value.Value);

            if (effectCustomEffect.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectCustomEffect.RewardIdOption.Value.Value);
        }
    }
}
