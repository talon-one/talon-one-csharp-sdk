...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class StrikethroughSetDiscountPerItemMemberEffectPropsJsonConverter : JsonConverter<StrikethroughSetDiscountPerItemMemberEffectProps>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="StrikethroughSetDiscountPerItemMemberEffectPropsJsonConverter" /> class.
        /// </summary>
        public StrikethroughSetDiscountPerItemMemberEffectPropsJsonConverter()
        {
            OnCreated();
        }
