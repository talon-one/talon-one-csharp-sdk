...
namespace TalonOneSdk.Model
{
    ...
    /// EffectAddFreeItem
    /// </summary>
    public partial class EffectAddFreeItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectAddFreeItem" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;addFreeItem&#x60;.</param>
        /// <param name="props">The properties of the &#x60;addFreeItem&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;addFreeItem&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum AddFreeItem for value: addFreeItem
            /// </summary>
            AddFreeItem = 1
        }
        ...
        {
            if (value.Equals("addFreeItem"))
                return EffectTypeEnum.AddFreeItem;
        ...
        {
            if (value == EffectTypeEnum.AddFreeItem)
                return "addFreeItem";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;addFreeItem&#x60; effect.</value>
        [JsonPropertyName("props")]
        public AddFreeItemEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectAddFreeItem" />
    /// </summary>
    public partial class EffectAddFreeItemJsonConverter : JsonConverter<EffectAddFreeItem>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectAddFreeItemJsonConverter" /> class.
        /// </summary>
        public EffectAddFreeItemJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectAddFreeItem" />
        /// </summary>
        ...
        public override EffectAddFreeItem Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectAddFreeItem.EffectTypeEnum?> effectType = default;
            Option<AddFreeItemEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectAddFreeItem.EffectTypeEnum? effectTypeValue = EffectAddFreeItem.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectAddFreeItem.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<AddFreeItemEffectProps>(JsonSerializer.Deserialize<AddFreeItemEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectAddFreeItem.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectAddFreeItem.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectAddFreeItem.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectAddFreeItem.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectAddFreeItem.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectAddFreeItem.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectAddFreeItem.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectAddFreeItem.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectAddFreeItem.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectAddFreeItem.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectAddFreeItem.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectAddFreeItem.");

            return new EffectAddFreeItem(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectAddFreeItem" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectAddFreeItem"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectAddFreeItem effectAddFreeItem, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectAddFreeItem, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectAddFreeItem" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectAddFreeItem"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectAddFreeItem effectAddFreeItem, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectAddFreeItem.RuleName == null)
                throw new ArgumentNullException(nameof(effectAddFreeItem.RuleName), "Property is required for class EffectAddFreeItem.");

            if (effectAddFreeItem.Props == null)
                throw new ArgumentNullException(nameof(effectAddFreeItem.Props), "Property is required for class EffectAddFreeItem.");

            writer.WriteNumber("campaignId", effectAddFreeItem.CampaignId);

            writer.WriteNumber("rulesetId", effectAddFreeItem.RulesetId);

            writer.WriteNumber("ruleIndex", effectAddFreeItem.RuleIndex);

            writer.WriteString("ruleName", effectAddFreeItem.RuleName);

            var effectTypeRawValue = EffectAddFreeItem.EffectTypeEnumToJsonValue(effectAddFreeItem.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectAddFreeItem.Props, jsonSerializerOptions);
            if (effectAddFreeItem.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectAddFreeItem.ExperimentIdOption.Value.Value);

            if (effectAddFreeItem.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectAddFreeItem.TriggeredByCouponOption.Value.Value);

            if (effectAddFreeItem.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectAddFreeItem.TriggeredForCatalogItemOption.Value.Value);

            if (effectAddFreeItem.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectAddFreeItem.ConditionIndexOption.Value.Value);

            if (effectAddFreeItem.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectAddFreeItem.EvaluationGroupIDOption.Value.Value);

            if (effectAddFreeItem.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectAddFreeItem.EvaluationGroupMode);

            if (effectAddFreeItem.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectAddFreeItem.CampaignRevisionIdOption.Value.Value);

            if (effectAddFreeItem.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectAddFreeItem.CampaignRevisionVersionIdOption.Value.Value);

            if (effectAddFreeItem.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectAddFreeItem.SelectedPriceType);

            if (effectAddFreeItem.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectAddFreeItem.SelectedPriceOption.Value.Value);

            if (effectAddFreeItem.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectAddFreeItem.AdjustmentReferenceIdOption.Value.Value);

            if (effectAddFreeItem.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectAddFreeItem.RewardIdOption.Value.Value);
        }
    }
}
