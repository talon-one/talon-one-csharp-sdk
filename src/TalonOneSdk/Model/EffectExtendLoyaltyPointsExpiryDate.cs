...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectExtendLoyaltyPointsExpiryDate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectExtendLoyaltyPointsExpiryDate" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;extendLoyaltyPointsExpiryDate&#x60;.</param>
        /// <param name="props">The properties of the &#x60;extendLoyaltyPointsExpiryDate&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;extendLoyaltyPointsExpiryDate&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum ExtendLoyaltyPointsExpiryDate for value: extendLoyaltyPointsExpiryDate
            /// </summary>
            ExtendLoyaltyPointsExpiryDate = 1
        }
        ...
        {
            if (value.Equals("extendLoyaltyPointsExpiryDate"))
                return EffectTypeEnum.ExtendLoyaltyPointsExpiryDate;
        ...
        {
            if (value == EffectTypeEnum.ExtendLoyaltyPointsExpiryDate)
                return "extendLoyaltyPointsExpiryDate";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;extendLoyaltyPointsExpiryDate&#x60; effect.</value>
        [JsonPropertyName("props")]
        public ExtendLoyaltyPointsExpiryDateEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectExtendLoyaltyPointsExpiryDate" />
    /// </summary>
    public partial class EffectExtendLoyaltyPointsExpiryDateJsonConverter : JsonConverter<EffectExtendLoyaltyPointsExpiryDate>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectExtendLoyaltyPointsExpiryDateJsonConverter" /> class.
        /// </summary>
        public EffectExtendLoyaltyPointsExpiryDateJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectExtendLoyaltyPointsExpiryDate" />
        /// </summary>
        ...
        public override EffectExtendLoyaltyPointsExpiryDate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectExtendLoyaltyPointsExpiryDate.EffectTypeEnum?> effectType = default;
            Option<ExtendLoyaltyPointsExpiryDateEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectExtendLoyaltyPointsExpiryDate.EffectTypeEnum? effectTypeValue = EffectExtendLoyaltyPointsExpiryDate.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectExtendLoyaltyPointsExpiryDate.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<ExtendLoyaltyPointsExpiryDateEffectProps>(JsonSerializer.Deserialize<ExtendLoyaltyPointsExpiryDateEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectExtendLoyaltyPointsExpiryDate.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectExtendLoyaltyPointsExpiryDate.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectExtendLoyaltyPointsExpiryDate.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectExtendLoyaltyPointsExpiryDate.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectExtendLoyaltyPointsExpiryDate.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectExtendLoyaltyPointsExpiryDate.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectExtendLoyaltyPointsExpiryDate.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectExtendLoyaltyPointsExpiryDate.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectExtendLoyaltyPointsExpiryDate.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectExtendLoyaltyPointsExpiryDate.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectExtendLoyaltyPointsExpiryDate.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectExtendLoyaltyPointsExpiryDate.");

            return new EffectExtendLoyaltyPointsExpiryDate(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectExtendLoyaltyPointsExpiryDate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectExtendLoyaltyPointsExpiryDate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectExtendLoyaltyPointsExpiryDate effectExtendLoyaltyPointsExpiryDate, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectExtendLoyaltyPointsExpiryDate, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectExtendLoyaltyPointsExpiryDate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectExtendLoyaltyPointsExpiryDate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectExtendLoyaltyPointsExpiryDate effectExtendLoyaltyPointsExpiryDate, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectExtendLoyaltyPointsExpiryDate.RuleName == null)
                throw new ArgumentNullException(nameof(effectExtendLoyaltyPointsExpiryDate.RuleName), "Property is required for class EffectExtendLoyaltyPointsExpiryDate.");

            if (effectExtendLoyaltyPointsExpiryDate.Props == null)
                throw new ArgumentNullException(nameof(effectExtendLoyaltyPointsExpiryDate.Props), "Property is required for class EffectExtendLoyaltyPointsExpiryDate.");

            writer.WriteNumber("campaignId", effectExtendLoyaltyPointsExpiryDate.CampaignId);

            writer.WriteNumber("rulesetId", effectExtendLoyaltyPointsExpiryDate.RulesetId);

            writer.WriteNumber("ruleIndex", effectExtendLoyaltyPointsExpiryDate.RuleIndex);

            writer.WriteString("ruleName", effectExtendLoyaltyPointsExpiryDate.RuleName);

            var effectTypeRawValue = EffectExtendLoyaltyPointsExpiryDate.EffectTypeEnumToJsonValue(effectExtendLoyaltyPointsExpiryDate.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectExtendLoyaltyPointsExpiryDate.Props, jsonSerializerOptions);
            if (effectExtendLoyaltyPointsExpiryDate.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectExtendLoyaltyPointsExpiryDate.ExperimentIdOption.Value.Value);

            if (effectExtendLoyaltyPointsExpiryDate.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectExtendLoyaltyPointsExpiryDate.TriggeredByCouponOption.Value.Value);

            if (effectExtendLoyaltyPointsExpiryDate.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectExtendLoyaltyPointsExpiryDate.TriggeredForCatalogItemOption.Value.Value);

            if (effectExtendLoyaltyPointsExpiryDate.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectExtendLoyaltyPointsExpiryDate.ConditionIndexOption.Value.Value);

            if (effectExtendLoyaltyPointsExpiryDate.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectExtendLoyaltyPointsExpiryDate.EvaluationGroupIDOption.Value.Value);

            if (effectExtendLoyaltyPointsExpiryDate.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectExtendLoyaltyPointsExpiryDate.EvaluationGroupMode);

            if (effectExtendLoyaltyPointsExpiryDate.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectExtendLoyaltyPointsExpiryDate.CampaignRevisionIdOption.Value.Value);

            if (effectExtendLoyaltyPointsExpiryDate.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectExtendLoyaltyPointsExpiryDate.CampaignRevisionVersionIdOption.Value.Value);

            if (effectExtendLoyaltyPointsExpiryDate.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectExtendLoyaltyPointsExpiryDate.SelectedPriceType);

            if (effectExtendLoyaltyPointsExpiryDate.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectExtendLoyaltyPointsExpiryDate.SelectedPriceOption.Value.Value);

            if (effectExtendLoyaltyPointsExpiryDate.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectExtendLoyaltyPointsExpiryDate.AdjustmentReferenceIdOption.Value.Value);

            if (effectExtendLoyaltyPointsExpiryDate.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectExtendLoyaltyPointsExpiryDate.RewardIdOption.Value.Value);
        }
    }
}
