...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class UpdateCouponBatchJsonConverter : JsonConverter<UpdateCouponBatch>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCouponBatchJsonConverter" /> class.
        /// </summary>
        public UpdateCouponBatchJsonConverter()
        {
            OnCreated();
        }
