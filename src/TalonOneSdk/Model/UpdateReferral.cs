...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class UpdateReferralJsonConverter : JsonConverter<UpdateReferral>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateReferralJsonConverter" /> class.
        /// </summary>
        public UpdateReferralJsonConverter()
        {
            OnCreated();
        }
