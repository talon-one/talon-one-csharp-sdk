...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CampaignCopyJsonConverter : JsonConverter<CampaignCopy>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignCopyJsonConverter" /> class.
        /// </summary>
        public CampaignCopyJsonConverter()
        {
            OnCreated();
        }
