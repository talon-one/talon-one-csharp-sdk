...
namespace TalonOneSdk.Model
{
    ...
    public partial class ExperimentVariantResult : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ExperimentVariantResult(Option<long?> variantId = default, Option<string> variantName = default, Option<long?> variantWeight = default, Option<decimal?> totalRevenue = default, Option<decimal?> sessionsCount = default, Option<decimal?> avgItemsPerSession = default, Option<decimal?> avgSessionValue = default, Option<decimal?> avgDiscountedSessionValue = default, Option<decimal?> totalDiscounts = default, Option<decimal?> couponsCount = default)
        {
    ...
    public class ExperimentVariantResultJsonConverter : JsonConverter<ExperimentVariantResult>
    {
        ...
        public override ExperimentVariantResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ExperimentVariantResult(variantId, variantName, variantWeight, totalRevenue, sessionsCount, avgItemsPerSession, avgSessionValue, avgDiscountedSessionValue, totalDiscounts, couponsCount);
        }
