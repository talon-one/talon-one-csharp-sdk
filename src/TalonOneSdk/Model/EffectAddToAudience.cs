...
namespace TalonOneSdk.Model
{
    ...
    /// EffectAddToAudience
    /// </summary>
    public partial class EffectAddToAudience : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectAddToAudience" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;addToAudience&#x60;.</param>
        /// <param name="props">The properties of the &#x60;addToAudience&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;addToAudience&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum AddToAudience for value: addToAudience
            /// </summary>
            AddToAudience = 1
        }
        ...
        {
            if (value.Equals("addToAudience"))
                return EffectTypeEnum.AddToAudience;
        ...
        {
            if (value == EffectTypeEnum.AddToAudience)
                return "addToAudience";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;addToAudience&#x60; effect.</value>
        [JsonPropertyName("props")]
        public AddToAudienceEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectAddToAudience" />
    /// </summary>
    public partial class EffectAddToAudienceJsonConverter : JsonConverter<EffectAddToAudience>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectAddToAudienceJsonConverter" /> class.
        /// </summary>
        public EffectAddToAudienceJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectAddToAudience" />
        /// </summary>
        ...
        public override EffectAddToAudience Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectAddToAudience.EffectTypeEnum?> effectType = default;
            Option<AddToAudienceEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectAddToAudience.EffectTypeEnum? effectTypeValue = EffectAddToAudience.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectAddToAudience.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<AddToAudienceEffectProps>(JsonSerializer.Deserialize<AddToAudienceEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectAddToAudience.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectAddToAudience.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectAddToAudience.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectAddToAudience.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectAddToAudience.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectAddToAudience.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectAddToAudience.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectAddToAudience.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectAddToAudience.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectAddToAudience.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectAddToAudience.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectAddToAudience.");

            return new EffectAddToAudience(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectAddToAudience" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectAddToAudience"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectAddToAudience effectAddToAudience, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectAddToAudience, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectAddToAudience" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectAddToAudience"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectAddToAudience effectAddToAudience, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectAddToAudience.RuleName == null)
                throw new ArgumentNullException(nameof(effectAddToAudience.RuleName), "Property is required for class EffectAddToAudience.");

            if (effectAddToAudience.Props == null)
                throw new ArgumentNullException(nameof(effectAddToAudience.Props), "Property is required for class EffectAddToAudience.");

            writer.WriteNumber("campaignId", effectAddToAudience.CampaignId);

            writer.WriteNumber("rulesetId", effectAddToAudience.RulesetId);

            writer.WriteNumber("ruleIndex", effectAddToAudience.RuleIndex);

            writer.WriteString("ruleName", effectAddToAudience.RuleName);

            var effectTypeRawValue = EffectAddToAudience.EffectTypeEnumToJsonValue(effectAddToAudience.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectAddToAudience.Props, jsonSerializerOptions);
            if (effectAddToAudience.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectAddToAudience.ExperimentIdOption.Value.Value);

            if (effectAddToAudience.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectAddToAudience.TriggeredByCouponOption.Value.Value);

            if (effectAddToAudience.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectAddToAudience.TriggeredForCatalogItemOption.Value.Value);

            if (effectAddToAudience.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectAddToAudience.ConditionIndexOption.Value.Value);

            if (effectAddToAudience.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectAddToAudience.EvaluationGroupIDOption.Value.Value);

            if (effectAddToAudience.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectAddToAudience.EvaluationGroupMode);

            if (effectAddToAudience.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectAddToAudience.CampaignRevisionIdOption.Value.Value);

            if (effectAddToAudience.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectAddToAudience.CampaignRevisionVersionIdOption.Value.Value);

            if (effectAddToAudience.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectAddToAudience.SelectedPriceType);

            if (effectAddToAudience.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectAddToAudience.SelectedPriceOption.Value.Value);

            if (effectAddToAudience.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectAddToAudience.AdjustmentReferenceIdOption.Value.Value);

            if (effectAddToAudience.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectAddToAudience.RewardIdOption.Value.Value);
        }
    }
}
