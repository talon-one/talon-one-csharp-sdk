...
namespace TalonOneSdk.Model
{
    ...
    /// EffectCouponCreated
    /// </summary>
    public partial class EffectCouponCreated : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectCouponCreated" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;couponCreated&#x60;.</param>
        /// <param name="props">The properties of the &#x60;couponCreated&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;couponCreated&#x60;.</value>
        ...
        public static EffectTypeEnum EffectTypeEnumFromString(string value)
        {
            if (value.Equals("couponCreated"))
                return EffectTypeEnum.CouponCreated;
        ...
        {
            if (value == EffectTypeEnum.CouponCreated)
        ...
        /// </summary>
        /// <value>The properties of the &#x60;couponCreated&#x60; effect.</value>
        [JsonPropertyName("props")]
        public CouponCreatedEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectCouponCreated" />
    /// </summary>
    public partial class EffectCouponCreatedJsonConverter : JsonConverter<EffectCouponCreated>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectCouponCreatedJsonConverter" /> class.
        /// </summary>
        public EffectCouponCreatedJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectCouponCreated" />
        /// </summary>
        ...
        public override EffectCouponCreated Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectCouponCreated.EffectTypeEnum?> effectType = default;
            Option<CouponCreatedEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectCouponCreated.EffectTypeEnum? effectTypeValue = EffectCouponCreated.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectCouponCreated.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<CouponCreatedEffectProps>(JsonSerializer.Deserialize<CouponCreatedEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectCouponCreated.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectCouponCreated.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectCouponCreated.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectCouponCreated.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectCouponCreated.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectCouponCreated.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectCouponCreated.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectCouponCreated.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectCouponCreated.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectCouponCreated.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectCouponCreated.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectCouponCreated.");

            return new EffectCouponCreated(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectCouponCreated" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectCouponCreated"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectCouponCreated effectCouponCreated, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectCouponCreated, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectCouponCreated" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectCouponCreated"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectCouponCreated effectCouponCreated, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectCouponCreated.RuleName == null)
                throw new ArgumentNullException(nameof(effectCouponCreated.RuleName), "Property is required for class EffectCouponCreated.");

            if (effectCouponCreated.Props == null)
                throw new ArgumentNullException(nameof(effectCouponCreated.Props), "Property is required for class EffectCouponCreated.");

            writer.WriteNumber("campaignId", effectCouponCreated.CampaignId);

            writer.WriteNumber("rulesetId", effectCouponCreated.RulesetId);

            writer.WriteNumber("ruleIndex", effectCouponCreated.RuleIndex);

            writer.WriteString("ruleName", effectCouponCreated.RuleName);

            var effectTypeRawValue = EffectCouponCreated.EffectTypeEnumToJsonValue(effectCouponCreated.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectCouponCreated.Props, jsonSerializerOptions);
            if (effectCouponCreated.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectCouponCreated.ExperimentIdOption.Value.Value);

            if (effectCouponCreated.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectCouponCreated.TriggeredByCouponOption.Value.Value);

            if (effectCouponCreated.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectCouponCreated.TriggeredForCatalogItemOption.Value.Value);

            if (effectCouponCreated.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectCouponCreated.ConditionIndexOption.Value.Value);

            if (effectCouponCreated.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectCouponCreated.EvaluationGroupIDOption.Value.Value);

            if (effectCouponCreated.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectCouponCreated.EvaluationGroupMode);

            if (effectCouponCreated.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectCouponCreated.CampaignRevisionIdOption.Value.Value);

            if (effectCouponCreated.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectCouponCreated.CampaignRevisionVersionIdOption.Value.Value);

            if (effectCouponCreated.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectCouponCreated.SelectedPriceType);

            if (effectCouponCreated.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectCouponCreated.SelectedPriceOption.Value.Value);

            if (effectCouponCreated.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectCouponCreated.AdjustmentReferenceIdOption.Value.Value);

            if (effectCouponCreated.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectCouponCreated.RewardIdOption.Value.Value);
        }
    }
}
