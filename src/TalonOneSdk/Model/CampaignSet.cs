...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CampaignSetJsonConverter : JsonConverter<CampaignSet>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignSetJsonConverter" /> class.
        /// </summary>
        public CampaignSetJsonConverter()
        {
            OnCreated();
        }
