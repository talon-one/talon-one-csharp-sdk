...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class LoyaltyProgramTransactionJsonConverter : JsonConverter<LoyaltyProgramTransaction>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyProgramTransactionJsonConverter" /> class.
        /// </summary>
        public LoyaltyProgramTransactionJsonConverter()
        {
            OnCreated();
        }
