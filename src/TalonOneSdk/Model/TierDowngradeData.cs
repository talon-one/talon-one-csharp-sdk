...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class TierDowngradeDataJsonConverter : JsonConverter<TierDowngradeData>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="TierDowngradeDataJsonConverter" /> class.
        /// </summary>
        public TierDowngradeDataJsonConverter()
        {
            OnCreated();
        }
