...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class UpdateCollectionJsonConverter : JsonConverter<UpdateCollection>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCollectionJsonConverter" /> class.
        /// </summary>
        public UpdateCollectionJsonConverter()
        {
            OnCreated();
        }
