...
namespace TalonOneSdk.Model
{
    ...
    public partial class Event : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Event(long id, DateTime created, long applicationId, string type, Object attributes, List<Object> effects, Option<string> profileId = default, Option<string> storeIntegrationId = default, Option<string> integrationId = default, Option<string> sessionId = default, Option<List<LedgerEntry>> ledgerEntries = default, Option<Meta> meta = default)
        {
            Id = id;
            Created = created;
    ...
    public class EventJsonConverter : JsonConverter<Event>
    {
        ...
        public override Event Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Event(id.Value.Value, created.Value.Value, applicationId.Value.Value, type.Value, attributes.Value, effects.Value, profileId, storeIntegrationId, integrationId, sessionId, ledgerEntries, meta);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, Event varEvent, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (varEvent.IntegrationIdOption.IsSet)
                writer.WriteString("integrationId", varEvent.IntegrationId);
