...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectSetDiscountPerItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectSetDiscountPerItem" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;setDiscountPerItem&#x60;.</param>
        /// <param name="props">The properties of the &#x60;setDiscountPerItem&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;setDiscountPerItem&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum SetDiscountPerItem for value: setDiscountPerItem
            /// </summary>
            SetDiscountPerItem = 1
        }
        ...
        {
            if (value.Equals("setDiscountPerItem"))
                return EffectTypeEnum.SetDiscountPerItem;
        ...
        {
            if (value == EffectTypeEnum.SetDiscountPerItem)
                return "setDiscountPerItem";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;setDiscountPerItem&#x60; effect.</value>
        [JsonPropertyName("props")]
        public SetDiscountPerItemEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectSetDiscountPerItem" />
    /// </summary>
    public partial class EffectSetDiscountPerItemJsonConverter : JsonConverter<EffectSetDiscountPerItem>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectSetDiscountPerItemJsonConverter" /> class.
        /// </summary>
        public EffectSetDiscountPerItemJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectSetDiscountPerItem" />
        /// </summary>
        ...
        public override EffectSetDiscountPerItem Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectSetDiscountPerItem.EffectTypeEnum?> effectType = default;
            Option<SetDiscountPerItemEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectSetDiscountPerItem.EffectTypeEnum? effectTypeValue = EffectSetDiscountPerItem.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectSetDiscountPerItem.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<SetDiscountPerItemEffectProps>(JsonSerializer.Deserialize<SetDiscountPerItemEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerItem.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerItem.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerItem.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerItem.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerItem.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerItem.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectSetDiscountPerItem.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectSetDiscountPerItem.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectSetDiscountPerItem.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectSetDiscountPerItem.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectSetDiscountPerItem.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectSetDiscountPerItem.");

            return new EffectSetDiscountPerItem(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectSetDiscountPerItem" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectSetDiscountPerItem"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectSetDiscountPerItem effectSetDiscountPerItem, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectSetDiscountPerItem, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectSetDiscountPerItem" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectSetDiscountPerItem"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectSetDiscountPerItem effectSetDiscountPerItem, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectSetDiscountPerItem.RuleName == null)
                throw new ArgumentNullException(nameof(effectSetDiscountPerItem.RuleName), "Property is required for class EffectSetDiscountPerItem.");

            if (effectSetDiscountPerItem.Props == null)
                throw new ArgumentNullException(nameof(effectSetDiscountPerItem.Props), "Property is required for class EffectSetDiscountPerItem.");

            writer.WriteNumber("campaignId", effectSetDiscountPerItem.CampaignId);

            writer.WriteNumber("rulesetId", effectSetDiscountPerItem.RulesetId);

            writer.WriteNumber("ruleIndex", effectSetDiscountPerItem.RuleIndex);

            writer.WriteString("ruleName", effectSetDiscountPerItem.RuleName);

            var effectTypeRawValue = EffectSetDiscountPerItem.EffectTypeEnumToJsonValue(effectSetDiscountPerItem.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectSetDiscountPerItem.Props, jsonSerializerOptions);
            if (effectSetDiscountPerItem.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectSetDiscountPerItem.ExperimentIdOption.Value.Value);

            if (effectSetDiscountPerItem.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectSetDiscountPerItem.TriggeredByCouponOption.Value.Value);

            if (effectSetDiscountPerItem.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectSetDiscountPerItem.TriggeredForCatalogItemOption.Value.Value);

            if (effectSetDiscountPerItem.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectSetDiscountPerItem.ConditionIndexOption.Value.Value);

            if (effectSetDiscountPerItem.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectSetDiscountPerItem.EvaluationGroupIDOption.Value.Value);

            if (effectSetDiscountPerItem.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectSetDiscountPerItem.EvaluationGroupMode);

            if (effectSetDiscountPerItem.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectSetDiscountPerItem.CampaignRevisionIdOption.Value.Value);

            if (effectSetDiscountPerItem.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectSetDiscountPerItem.CampaignRevisionVersionIdOption.Value.Value);

            if (effectSetDiscountPerItem.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectSetDiscountPerItem.SelectedPriceType);

            if (effectSetDiscountPerItem.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectSetDiscountPerItem.SelectedPriceOption.Value.Value);

            if (effectSetDiscountPerItem.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectSetDiscountPerItem.AdjustmentReferenceIdOption.Value.Value);

            if (effectSetDiscountPerItem.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectSetDiscountPerItem.RewardIdOption.Value.Value);
        }
    }
}
