...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class TemplateLimitConfigJsonConverter : JsonConverter<TemplateLimitConfig>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateLimitConfigJsonConverter" /> class.
        /// </summary>
        public TemplateLimitConfigJsonConverter()
        {
            OnCreated();
        }
