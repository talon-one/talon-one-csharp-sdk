...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class UpdateRewardJsonConverter : JsonConverter<UpdateReward>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRewardJsonConverter" /> class.
        /// </summary>
        public UpdateRewardJsonConverter()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "status":
                            ...
                            {
                                UpdateReward.StatusEnum? statusValue = UpdateReward.StatusEnumFromStringOrDefault(statusRawValue);
                                if (statusValue == null)
                                    throw new JsonException();
                                status = new Option<UpdateReward.StatusEnum?>(statusValue);
                            }
                            break;
                        case "description":
