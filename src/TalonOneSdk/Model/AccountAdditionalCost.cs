...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class AccountAdditionalCostJsonConverter : JsonConverter<AccountAdditionalCost>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="AccountAdditionalCostJsonConverter" /> class.
        /// </summary>
        public AccountAdditionalCostJsonConverter()
        {
            OnCreated();
        }
