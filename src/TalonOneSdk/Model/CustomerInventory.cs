...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CustomerInventoryJsonConverter : JsonConverter<CustomerInventory>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerInventoryJsonConverter" /> class.
        /// </summary>
        public CustomerInventoryJsonConverter()
        {
            OnCreated();
        }
