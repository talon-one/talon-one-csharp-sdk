...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class NewApplicationJsonConverter : JsonConverter<NewApplication>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="NewApplicationJsonConverter" /> class.
        /// </summary>
        public NewApplicationJsonConverter()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "caseSensitivity":
                            ...
                            {
                                NewApplication.CaseSensitivityEnum? caseSensitivityValue = NewApplication.CaseSensitivityEnumFromStringOrDefault(caseSensitivityRawValue);
                                if (caseSensitivityValue == null)
                                    throw new JsonException();
                                caseSensitivity = new Option<NewApplication.CaseSensitivityEnum?>(caseSensitivityValue);
                            }
                            break;
                        case "attributes":
                        ...
                        case "defaultDiscountScope":
                            ...
                            {
                                NewApplication.DefaultDiscountScopeEnum? defaultDiscountScopeValue = NewApplication.DefaultDiscountScopeEnumFromStringOrDefault(defaultDiscountScopeRawValue);
                                if (defaultDiscountScopeValue == null)
                                    throw new JsonException();
                                defaultDiscountScope = new Option<NewApplication.DefaultDiscountScopeEnum?>(defaultDiscountScopeValue);
                            }
                            break;
                        ...
                        case "defaultDiscountAdditionalCostPerItemScope":
                            ...
                            {
                                NewApplication.DefaultDiscountAdditionalCostPerItemScopeEnum? defaultDiscountAdditionalCostPerItemScopeValue = NewApplication.DefaultDiscountAdditionalCostPerItemScopeEnumFromStringOrDefault(defaultDiscountAdditionalCostPerItemScopeRawValue);
                                if (defaultDiscountAdditionalCostPerItemScopeValue == null)
                                    throw new JsonException();
                                defaultDiscountAdditionalCostPerItemScope = new Option<NewApplication.DefaultDiscountAdditionalCostPerItemScopeEnum?>(defaultDiscountAdditionalCostPerItemScopeValue);
                            }
                            break;
                        case "key":
        ...
        public void WriteProperties(Utf8JsonWriter writer, NewApplication newApplication, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (newApplication.CaseSensitivityOption.IsSet)
            {
                var caseSensitivityRawValue = NewApplication.CaseSensitivityEnumToJsonValue(newApplication.CaseSensitivityOption.Value);
            ...
            if (newApplication.DefaultDiscountScopeOption.IsSet)
            {
                var defaultDiscountScopeRawValue = NewApplication.DefaultDiscountScopeEnumToJsonValue(newApplication.DefaultDiscountScopeOption.Value);
            ...
            if (newApplication.DefaultDiscountAdditionalCostPerItemScopeOption.IsSet)
            {
                var defaultDiscountAdditionalCostPerItemScopeRawValue = NewApplication.DefaultDiscountAdditionalCostPerItemScopeEnumToJsonValue(newApplication.DefaultDiscountAdditionalCostPerItemScopeOption.Value);
            ...
            if (newApplication.BestPriorPriceSettingsOption.IsSet)
            {
                writer.WritePropertyName("bestPriorPriceSettings");
                JsonSerializer.Serialize(writer, newApplication.BestPriorPriceSettings, jsonSerializerOptions);
            }
        }
    }
}
