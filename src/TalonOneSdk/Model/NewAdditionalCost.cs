...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class NewAdditionalCostJsonConverter : JsonConverter<NewAdditionalCost>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="NewAdditionalCostJsonConverter" /> class.
        /// </summary>
        public NewAdditionalCostJsonConverter()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            {
                                NewAdditionalCost.TypeEnum? typeValue = NewAdditionalCost.TypeEnumFromStringOrDefault(typeRawValue);
                                if (typeValue == null)
                                    throw new JsonException();
                                type = new Option<NewAdditionalCost.TypeEnum?>(typeValue);
                            }
                            break;
                        default:
                            break;
        ...
        public void WriteProperties(Utf8JsonWriter writer, NewAdditionalCost newAdditionalCost, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (newAdditionalCost.TypeOption.IsSet)
            {
                var typeRawValue = NewAdditionalCost.TypeEnumToJsonValue(newAdditionalCost.TypeOption.Value);
