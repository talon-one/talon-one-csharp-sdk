...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class RewardJsonConverter : JsonConverter<Reward>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="RewardJsonConverter" /> class.
        /// </summary>
        public RewardJsonConverter()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "status":
                            ...
                            {
                                Reward.StatusEnum? statusValue = Reward.StatusEnumFromStringOrDefault(statusRawValue);
                                if (statusValue == null)
                                    throw new JsonException();
                                status = new Option<Reward.StatusEnum?>(statusValue);
                            }
                            break;
                        case "description":
        ...
        public void WriteProperties(Utf8JsonWriter writer, Reward reward, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (reward.EligibilityConditionsOption.IsSet)
            {
                writer.WritePropertyName("eligibilityConditions");
                JsonSerializer.Serialize(writer, reward.EligibilityConditions, jsonSerializerOptions);
            }
