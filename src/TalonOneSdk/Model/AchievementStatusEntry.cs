...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class AchievementStatusEntry : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="AchievementStatusEntry" />
    /// </summary>
    public partial class AchievementStatusEntryJsonConverter : JsonConverter<AchievementStatusEntry>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="AchievementStatusEntryJsonConverter" /> class.
        /// </summary>
        public AchievementStatusEntryJsonConverter()
        {
            OnCreated();
        }
        ...
        /// <summary>
        /// Deserializes json to <see cref="AchievementStatusEntry" />
        /// </summary>
        ...
        public override AchievementStatusEntry Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<AchievementStatusEntry.ActivationPolicyEnum?> activationPolicy = default;
            ...
            if (!id.IsSet)
                throw new ArgumentException("Property is required for class AchievementStatusEntry.", nameof(id));

            if (!created.IsSet)
                throw new ArgumentException("Property is required for class AchievementStatusEntry.", nameof(created));

            if (!name.IsSet)
                throw new ArgumentException("Property is required for class AchievementStatusEntry.", nameof(name));

            if (!title.IsSet)
                throw new ArgumentException("Property is required for class AchievementStatusEntry.", nameof(title));

            if (!description.IsSet)
                throw new ArgumentException("Property is required for class AchievementStatusEntry.", nameof(description));
        ...
        /// <summary>
        /// Serializes a <see cref="AchievementStatusEntry" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="achievementStatusEntry"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AchievementStatusEntry achievementStatusEntry, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, achievementStatusEntry, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AchievementStatusEntry" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="achievementStatusEntry"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AchievementStatusEntry achievementStatusEntry, JsonSerializerOptions jsonSerializerOptions)
        {
            if (achievementStatusEntry.Name == null)
                throw new ArgumentNullException(nameof(achievementStatusEntry.Name), "Property is required for class AchievementStatusEntry.");

            if (achievementStatusEntry.Title == null)
                throw new ArgumentNullException(nameof(achievementStatusEntry.Title), "Property is required for class AchievementStatusEntry.");
            ...
            writer.WriteString("name", achievementStatusEntry.Name);

            writer.WriteString("title", achievementStatusEntry.Title);

            writer.WriteString("description", achievementStatusEntry.Description);
            ...
            if (achievementStatusEntry.PeriodEndOverrideOption.IsSet)
            {
            ...
            if (achievementStatusEntry.EndDateOption.IsSet)
                writer.WriteString("endDate", achievementStatusEntry.EndDateOption.Value.Value.ToString(EndDateFormat));

            if (achievementStatusEntry.AllowRollbackAfterCompletionOption.IsSet)
                writer.WriteBoolean("allowRollbackAfterCompletion", achievementStatusEntry.AllowRollbackAfterCompletionOption.Value.Value);
            ...
            if (achievementStatusEntry.CurrentProgressOption.IsSet)
            {
                ...
                JsonSerializer.Serialize(writer, achievementStatusEntry.CurrentProgress, jsonSerializerOptions);
            }
        }
    }
}
