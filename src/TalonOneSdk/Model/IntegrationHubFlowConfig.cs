    ...
    public class IntegrationHubFlowConfigJsonConverter : JsonConverter<IntegrationHubFlowConfig>
    {
        ...
        public override IntegrationHubFlowConfig Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (workerCount.IsSet && workerCount.Value == null)
                throw new ArgumentNullException(nameof(workerCount), "Property is not nullable for class IntegrationHubFlowConfig.");

            if (maxEventsPerMessage.IsSet && maxEventsPerMessage.Value == null)
                throw new ArgumentNullException(nameof(maxEventsPerMessage), "Property is not nullable for class IntegrationHubFlowConfig.");

            if (maxRetries.IsSet && maxRetries.Value == null)
                throw new ArgumentNullException(nameof(maxRetries), "Property is not nullable for class IntegrationHubFlowConfig.");
