...
namespace TalonOneSdk.Model
{
    ...
    public class IntegrationResponseJsonConverter : JsonConverter<IntegrationResponse>
    {
        ...
        public override IntegrationResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new IntegrationResponse(effects.Value, createdCoupons.Value, createdReferrals.Value, customerProfile, loyalty, triggeredCampaigns, campaignEligibility, ruleFailureReasons, awardedGiveaways);
        }
