...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectAddNegativeLoyaltyPoints : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectAddNegativeLoyaltyPoints" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;addNegativeLoyaltyPoints&#x60;.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;addNegativeLoyaltyPoints&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum AddNegativeLoyaltyPoints for value: addNegativeLoyaltyPoints
            /// </summary>
            AddNegativeLoyaltyPoints = 1
        }
        ...
        {
            if (value.Equals("addNegativeLoyaltyPoints"))
                return EffectTypeEnum.AddNegativeLoyaltyPoints;
        ...
        {
            if (value == EffectTypeEnum.AddNegativeLoyaltyPoints)
                return "addNegativeLoyaltyPoints";
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectAddNegativeLoyaltyPoints" />
    /// </summary>
    public partial class EffectAddNegativeLoyaltyPointsJsonConverter : JsonConverter<EffectAddNegativeLoyaltyPoints>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectAddNegativeLoyaltyPointsJsonConverter" /> class.
        /// </summary>
        public EffectAddNegativeLoyaltyPointsJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectAddNegativeLoyaltyPoints" />
        /// </summary>
        ...
        public override EffectAddNegativeLoyaltyPoints Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectAddNegativeLoyaltyPoints.EffectTypeEnum?> effectType = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectAddNegativeLoyaltyPoints.EffectTypeEnum? effectTypeValue = EffectAddNegativeLoyaltyPoints.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectAddNegativeLoyaltyPoints.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectAddNegativeLoyaltyPoints.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectAddNegativeLoyaltyPoints.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectAddNegativeLoyaltyPoints.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectAddNegativeLoyaltyPoints.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectAddNegativeLoyaltyPoints.", nameof(effectType));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectAddNegativeLoyaltyPoints.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectAddNegativeLoyaltyPoints.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectAddNegativeLoyaltyPoints.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectAddNegativeLoyaltyPoints.");
        ...
        /// <summary>
        /// Serializes a <see cref="EffectAddNegativeLoyaltyPoints" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectAddNegativeLoyaltyPoints"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectAddNegativeLoyaltyPoints effectAddNegativeLoyaltyPoints, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectAddNegativeLoyaltyPoints, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectAddNegativeLoyaltyPoints" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectAddNegativeLoyaltyPoints"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectAddNegativeLoyaltyPoints effectAddNegativeLoyaltyPoints, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectAddNegativeLoyaltyPoints.RuleName == null)
                throw new ArgumentNullException(nameof(effectAddNegativeLoyaltyPoints.RuleName), "Property is required for class EffectAddNegativeLoyaltyPoints.");

            writer.WriteNumber("campaignId", effectAddNegativeLoyaltyPoints.CampaignId);

            writer.WriteNumber("rulesetId", effectAddNegativeLoyaltyPoints.RulesetId);

            writer.WriteNumber("ruleIndex", effectAddNegativeLoyaltyPoints.RuleIndex);

            writer.WriteString("ruleName", effectAddNegativeLoyaltyPoints.RuleName);

            var effectTypeRawValue = EffectAddNegativeLoyaltyPoints.EffectTypeEnumToJsonValue(effectAddNegativeLoyaltyPoints.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            if (effectAddNegativeLoyaltyPoints.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectAddNegativeLoyaltyPoints.ExperimentIdOption.Value.Value);

            if (effectAddNegativeLoyaltyPoints.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectAddNegativeLoyaltyPoints.TriggeredByCouponOption.Value.Value);

            if (effectAddNegativeLoyaltyPoints.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectAddNegativeLoyaltyPoints.TriggeredForCatalogItemOption.Value.Value);

            if (effectAddNegativeLoyaltyPoints.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectAddNegativeLoyaltyPoints.ConditionIndexOption.Value.Value);

            if (effectAddNegativeLoyaltyPoints.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectAddNegativeLoyaltyPoints.EvaluationGroupIDOption.Value.Value);

            if (effectAddNegativeLoyaltyPoints.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectAddNegativeLoyaltyPoints.EvaluationGroupMode);

            if (effectAddNegativeLoyaltyPoints.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectAddNegativeLoyaltyPoints.CampaignRevisionIdOption.Value.Value);

            if (effectAddNegativeLoyaltyPoints.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectAddNegativeLoyaltyPoints.CampaignRevisionVersionIdOption.Value.Value);

            if (effectAddNegativeLoyaltyPoints.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectAddNegativeLoyaltyPoints.SelectedPriceType);

            if (effectAddNegativeLoyaltyPoints.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectAddNegativeLoyaltyPoints.SelectedPriceOption.Value.Value);

            if (effectAddNegativeLoyaltyPoints.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectAddNegativeLoyaltyPoints.AdjustmentReferenceIdOption.Value.Value);
