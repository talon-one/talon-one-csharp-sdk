...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectIncreaseAchievementProgress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectIncreaseAchievementProgress" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;increaseAchievementProgress&#x60;.</param>
        /// <param name="props">The properties of the &#x60;increaseAchievementProgress&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;increaseAchievementProgress&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum IncreaseAchievementProgress for value: increaseAchievementProgress
            /// </summary>
            IncreaseAchievementProgress = 1
        }
        ...
        {
            if (value.Equals("increaseAchievementProgress"))
                return EffectTypeEnum.IncreaseAchievementProgress;
        ...
        {
            if (value == EffectTypeEnum.IncreaseAchievementProgress)
                return "increaseAchievementProgress";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;increaseAchievementProgress&#x60; effect.</value>
        [JsonPropertyName("props")]
        public IncreaseAchievementProgressEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectIncreaseAchievementProgress" />
    /// </summary>
    public partial class EffectIncreaseAchievementProgressJsonConverter : JsonConverter<EffectIncreaseAchievementProgress>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectIncreaseAchievementProgressJsonConverter" /> class.
        /// </summary>
        public EffectIncreaseAchievementProgressJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectIncreaseAchievementProgress" />
        /// </summary>
        ...
        public override EffectIncreaseAchievementProgress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectIncreaseAchievementProgress.EffectTypeEnum?> effectType = default;
            Option<IncreaseAchievementProgressEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectIncreaseAchievementProgress.EffectTypeEnum? effectTypeValue = EffectIncreaseAchievementProgress.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectIncreaseAchievementProgress.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<IncreaseAchievementProgressEffectProps>(JsonSerializer.Deserialize<IncreaseAchievementProgressEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectIncreaseAchievementProgress.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectIncreaseAchievementProgress.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectIncreaseAchievementProgress.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectIncreaseAchievementProgress.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectIncreaseAchievementProgress.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectIncreaseAchievementProgress.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectIncreaseAchievementProgress.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectIncreaseAchievementProgress.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectIncreaseAchievementProgress.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectIncreaseAchievementProgress.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectIncreaseAchievementProgress.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectIncreaseAchievementProgress.");

            return new EffectIncreaseAchievementProgress(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectIncreaseAchievementProgress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectIncreaseAchievementProgress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectIncreaseAchievementProgress effectIncreaseAchievementProgress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectIncreaseAchievementProgress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectIncreaseAchievementProgress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectIncreaseAchievementProgress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectIncreaseAchievementProgress effectIncreaseAchievementProgress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectIncreaseAchievementProgress.RuleName == null)
                throw new ArgumentNullException(nameof(effectIncreaseAchievementProgress.RuleName), "Property is required for class EffectIncreaseAchievementProgress.");

            if (effectIncreaseAchievementProgress.Props == null)
                throw new ArgumentNullException(nameof(effectIncreaseAchievementProgress.Props), "Property is required for class EffectIncreaseAchievementProgress.");

            writer.WriteNumber("campaignId", effectIncreaseAchievementProgress.CampaignId);

            writer.WriteNumber("rulesetId", effectIncreaseAchievementProgress.RulesetId);

            writer.WriteNumber("ruleIndex", effectIncreaseAchievementProgress.RuleIndex);

            writer.WriteString("ruleName", effectIncreaseAchievementProgress.RuleName);

            var effectTypeRawValue = EffectIncreaseAchievementProgress.EffectTypeEnumToJsonValue(effectIncreaseAchievementProgress.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectIncreaseAchievementProgress.Props, jsonSerializerOptions);
            if (effectIncreaseAchievementProgress.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectIncreaseAchievementProgress.ExperimentIdOption.Value.Value);

            if (effectIncreaseAchievementProgress.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectIncreaseAchievementProgress.TriggeredByCouponOption.Value.Value);

            if (effectIncreaseAchievementProgress.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectIncreaseAchievementProgress.TriggeredForCatalogItemOption.Value.Value);

            if (effectIncreaseAchievementProgress.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectIncreaseAchievementProgress.ConditionIndexOption.Value.Value);

            if (effectIncreaseAchievementProgress.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectIncreaseAchievementProgress.EvaluationGroupIDOption.Value.Value);

            if (effectIncreaseAchievementProgress.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectIncreaseAchievementProgress.EvaluationGroupMode);

            if (effectIncreaseAchievementProgress.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectIncreaseAchievementProgress.CampaignRevisionIdOption.Value.Value);

            if (effectIncreaseAchievementProgress.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectIncreaseAchievementProgress.CampaignRevisionVersionIdOption.Value.Value);

            if (effectIncreaseAchievementProgress.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectIncreaseAchievementProgress.SelectedPriceType);

            if (effectIncreaseAchievementProgress.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectIncreaseAchievementProgress.SelectedPriceOption.Value.Value);

            if (effectIncreaseAchievementProgress.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectIncreaseAchievementProgress.AdjustmentReferenceIdOption.Value.Value);

            if (effectIncreaseAchievementProgress.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectIncreaseAchievementProgress.RewardIdOption.Value.Value);
        }
    }
}
