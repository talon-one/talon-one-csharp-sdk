...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class ScimServiceProviderConfigResponsePatchJsonConverter : JsonConverter<ScimServiceProviderConfigResponsePatch>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ScimServiceProviderConfigResponsePatchJsonConverter" /> class.
        /// </summary>
        public ScimServiceProviderConfigResponsePatchJsonConverter()
        {
            OnCreated();
        }
