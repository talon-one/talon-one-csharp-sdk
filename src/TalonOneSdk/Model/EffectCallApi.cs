...
namespace TalonOneSdk.Model
{
    ...
    /// EffectCallApi
    /// </summary>
    public partial class EffectCallApi : IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;callApi&#x60;.</value>
        ...
        {
            if (value == EffectTypeEnum.CallApi)
                return "callApi";
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectCallApi" />
    /// </summary>
    public partial class EffectCallApiJsonConverter : JsonConverter<EffectCallApi>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectCallApiJsonConverter" /> class.
        /// </summary>
        public EffectCallApiJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectCallApi" />
        /// </summary>
        ...
        public override EffectCallApi Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectCallApi.EffectTypeEnum? effectTypeValue = EffectCallApi.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectCallApi.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
        ...
        /// <summary>
        /// Serializes a <see cref="EffectCallApi" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectCallApi"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectCallApi effectCallApi, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectCallApi, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectCallApi" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectCallApi"></param>
        /// <param name="jsonSerializerOptions"></param>
