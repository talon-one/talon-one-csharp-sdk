...
namespace TalonOneSdk.Model
{
    ...
    /// EffectError
    /// </summary>
    public partial class EffectError : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectError" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;error&#x60;.</param>
        /// <param name="props">The properties of the &#x60;error&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;error&#x60;.</value>
        ...
        /// </summary>
        /// <value>The properties of the &#x60;error&#x60; effect.</value>
        [JsonPropertyName("props")]
        public ErrorEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectError" />
    /// </summary>
    public partial class EffectErrorJsonConverter : JsonConverter<EffectError>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectErrorJsonConverter" /> class.
        /// </summary>
        public EffectErrorJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectError" />
        /// </summary>
        ...
        public override EffectError Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectError.EffectTypeEnum?> effectType = default;
            Option<ErrorEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectError.EffectTypeEnum? effectTypeValue = EffectError.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectError.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<ErrorEffectProps>(JsonSerializer.Deserialize<ErrorEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectError.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectError.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectError.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectError.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectError.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectError.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectError.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectError.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectError.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectError.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectError.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectError.");

            return new EffectError(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectError" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectError"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectError effectError, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectError, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectError" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectError"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectError effectError, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectError.RuleName == null)
                throw new ArgumentNullException(nameof(effectError.RuleName), "Property is required for class EffectError.");

            if (effectError.Props == null)
                throw new ArgumentNullException(nameof(effectError.Props), "Property is required for class EffectError.");

            writer.WriteNumber("campaignId", effectError.CampaignId);

            writer.WriteNumber("rulesetId", effectError.RulesetId);

            writer.WriteNumber("ruleIndex", effectError.RuleIndex);

            writer.WriteString("ruleName", effectError.RuleName);

            var effectTypeRawValue = EffectError.EffectTypeEnumToJsonValue(effectError.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectError.Props, jsonSerializerOptions);
            if (effectError.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectError.ExperimentIdOption.Value.Value);

            if (effectError.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectError.TriggeredByCouponOption.Value.Value);

            if (effectError.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectError.TriggeredForCatalogItemOption.Value.Value);

            if (effectError.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectError.ConditionIndexOption.Value.Value);

            if (effectError.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectError.EvaluationGroupIDOption.Value.Value);

            if (effectError.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectError.EvaluationGroupMode);

            if (effectError.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectError.CampaignRevisionIdOption.Value.Value);

            if (effectError.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectError.CampaignRevisionVersionIdOption.Value.Value);

            if (effectError.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectError.SelectedPriceType);

            if (effectError.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectError.SelectedPriceOption.Value.Value);

            if (effectError.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectError.AdjustmentReferenceIdOption.Value.Value);

            if (effectError.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectError.RewardIdOption.Value.Value);
        }
    }
}
