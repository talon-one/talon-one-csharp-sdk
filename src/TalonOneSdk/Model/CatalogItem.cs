...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CatalogItemJsonConverter : JsonConverter<CatalogItem>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogItemJsonConverter" /> class.
        /// </summary>
        public CatalogItemJsonConverter()
        {
            OnCreated();
        }
