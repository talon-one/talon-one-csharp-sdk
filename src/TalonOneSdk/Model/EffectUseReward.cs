...
namespace TalonOneSdk.Model
{
    ...
    /// EffectUseReward
    /// </summary>
    public partial class EffectUseReward : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectUseReward" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;useReward&#x60;.</param>
        /// <param name="props">The properties of the &#x60;useReward&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;useReward&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum UseReward for value: useReward
            /// </summary>
            UseReward = 1
        }
        ...
        {
            if (value.Equals("useReward"))
                return EffectTypeEnum.UseReward;
        ...
        {
            if (value == EffectTypeEnum.UseReward)
                return "useReward";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;useReward&#x60; effect.</value>
        [JsonPropertyName("props")]
        public UseRewardEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectUseReward" />
    /// </summary>
    public partial class EffectUseRewardJsonConverter : JsonConverter<EffectUseReward>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectUseRewardJsonConverter" /> class.
        /// </summary>
        public EffectUseRewardJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectUseReward" />
        /// </summary>
        ...
        public override EffectUseReward Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectUseReward.EffectTypeEnum?> effectType = default;
            Option<UseRewardEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectUseReward.EffectTypeEnum? effectTypeValue = EffectUseReward.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectUseReward.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<UseRewardEffectProps>(JsonSerializer.Deserialize<UseRewardEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectUseReward.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectUseReward.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectUseReward.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectUseReward.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectUseReward.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectUseReward.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectUseReward.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectUseReward.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectUseReward.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectUseReward.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectUseReward.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectUseReward.");

            return new EffectUseReward(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectUseReward" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectUseReward"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectUseReward effectUseReward, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectUseReward, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectUseReward" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectUseReward"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectUseReward effectUseReward, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectUseReward.RuleName == null)
                throw new ArgumentNullException(nameof(effectUseReward.RuleName), "Property is required for class EffectUseReward.");

            if (effectUseReward.Props == null)
                throw new ArgumentNullException(nameof(effectUseReward.Props), "Property is required for class EffectUseReward.");

            writer.WriteNumber("campaignId", effectUseReward.CampaignId);

            writer.WriteNumber("rulesetId", effectUseReward.RulesetId);

            writer.WriteNumber("ruleIndex", effectUseReward.RuleIndex);

            writer.WriteString("ruleName", effectUseReward.RuleName);

            var effectTypeRawValue = EffectUseReward.EffectTypeEnumToJsonValue(effectUseReward.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectUseReward.Props, jsonSerializerOptions);
            if (effectUseReward.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectUseReward.ExperimentIdOption.Value.Value);

            if (effectUseReward.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectUseReward.TriggeredByCouponOption.Value.Value);

            if (effectUseReward.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectUseReward.TriggeredForCatalogItemOption.Value.Value);

            if (effectUseReward.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectUseReward.ConditionIndexOption.Value.Value);

            if (effectUseReward.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectUseReward.EvaluationGroupIDOption.Value.Value);

            if (effectUseReward.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectUseReward.EvaluationGroupMode);

            if (effectUseReward.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectUseReward.CampaignRevisionIdOption.Value.Value);

            if (effectUseReward.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectUseReward.CampaignRevisionVersionIdOption.Value.Value);

            if (effectUseReward.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectUseReward.SelectedPriceType);

            if (effectUseReward.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectUseReward.SelectedPriceOption.Value.Value);

            if (effectUseReward.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectUseReward.AdjustmentReferenceIdOption.Value.Value);

            if (effectUseReward.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectUseReward.RewardIdOption.Value.Value);
        }
    }
}
