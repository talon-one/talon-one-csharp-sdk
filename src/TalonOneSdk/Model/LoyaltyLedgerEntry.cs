...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class LoyaltyLedgerEntryJsonConverter : JsonConverter<LoyaltyLedgerEntry>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyLedgerEntryJsonConverter" /> class.
        /// </summary>
        public LoyaltyLedgerEntryJsonConverter()
        {
            OnCreated();
        }
