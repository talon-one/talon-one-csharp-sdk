...
namespace TalonOneSdk.Model
{
    ...
    public partial class InventoryReferral : IValidatableObject
    {
        ...
        public string FriendProfileIntegrationId { get { return this.FriendProfileIntegrationIdOption.Value; } set { this.FriendProfileIntegrationIdOption = new Option<string>(value); } }
    ...
    /// </summary>
    public partial class InventoryReferralJsonConverter : JsonConverter<InventoryReferral>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryReferralJsonConverter" /> class.
        /// </summary>
        public InventoryReferralJsonConverter()
        {
            OnCreated();
        }
