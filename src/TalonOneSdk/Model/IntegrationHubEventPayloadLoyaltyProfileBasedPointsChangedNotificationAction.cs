...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotificationActionJsonConverter : JsonConverter<IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotificationAction>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotificationActionJsonConverter" /> class.
        /// </summary>
        public IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotificationActionJsonConverter()
        {
            OnCreated();
        }
