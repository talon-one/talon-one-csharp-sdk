...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectAcceptReferral : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectAcceptReferral" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;acceptReferral&#x60;.</param>
        /// <param name="props">The properties of the &#x60;acceptReferral&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;acceptReferral&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum AcceptReferral for value: acceptReferral
            /// </summary>
            AcceptReferral = 1
        }
        ...
        {
            if (value.Equals("acceptReferral"))
                return EffectTypeEnum.AcceptReferral;
        ...
        {
            if (value == EffectTypeEnum.AcceptReferral)
        ...
        /// </summary>
        /// <value>The properties of the &#x60;acceptReferral&#x60; effect.</value>
        [JsonPropertyName("props")]
        public AcceptReferralEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectAcceptReferral" />
    /// </summary>
    public partial class EffectAcceptReferralJsonConverter : JsonConverter<EffectAcceptReferral>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectAcceptReferralJsonConverter" /> class.
        /// </summary>
        public EffectAcceptReferralJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectAcceptReferral" />
        /// </summary>
        ...
        public override EffectAcceptReferral Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectAcceptReferral.EffectTypeEnum?> effectType = default;
            Option<AcceptReferralEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectAcceptReferral.EffectTypeEnum? effectTypeValue = EffectAcceptReferral.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectAcceptReferral.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<AcceptReferralEffectProps>(JsonSerializer.Deserialize<AcceptReferralEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectAcceptReferral.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectAcceptReferral.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectAcceptReferral.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectAcceptReferral.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectAcceptReferral.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectAcceptReferral.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectAcceptReferral.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectAcceptReferral.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectAcceptReferral.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectAcceptReferral.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectAcceptReferral.");
        ...
        /// <summary>
        /// Serializes a <see cref="EffectAcceptReferral" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectAcceptReferral"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectAcceptReferral effectAcceptReferral, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectAcceptReferral, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectAcceptReferral" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectAcceptReferral"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectAcceptReferral effectAcceptReferral, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectAcceptReferral.RuleName == null)
                throw new ArgumentNullException(nameof(effectAcceptReferral.RuleName), "Property is required for class EffectAcceptReferral.");

            if (effectAcceptReferral.Props == null)
                throw new ArgumentNullException(nameof(effectAcceptReferral.Props), "Property is required for class EffectAcceptReferral.");

            writer.WriteNumber("campaignId", effectAcceptReferral.CampaignId);

            writer.WriteNumber("rulesetId", effectAcceptReferral.RulesetId);

            writer.WriteNumber("ruleIndex", effectAcceptReferral.RuleIndex);

            writer.WriteString("ruleName", effectAcceptReferral.RuleName);

            var effectTypeRawValue = EffectAcceptReferral.EffectTypeEnumToJsonValue(effectAcceptReferral.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectAcceptReferral.Props, jsonSerializerOptions);
            if (effectAcceptReferral.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectAcceptReferral.ExperimentIdOption.Value.Value);

            if (effectAcceptReferral.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectAcceptReferral.TriggeredByCouponOption.Value.Value);

            if (effectAcceptReferral.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectAcceptReferral.TriggeredForCatalogItemOption.Value.Value);

            if (effectAcceptReferral.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectAcceptReferral.ConditionIndexOption.Value.Value);

            if (effectAcceptReferral.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectAcceptReferral.EvaluationGroupIDOption.Value.Value);

            if (effectAcceptReferral.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectAcceptReferral.EvaluationGroupMode);

            if (effectAcceptReferral.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectAcceptReferral.CampaignRevisionIdOption.Value.Value);

            if (effectAcceptReferral.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectAcceptReferral.CampaignRevisionVersionIdOption.Value.Value);

            if (effectAcceptReferral.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectAcceptReferral.SelectedPriceType);

            if (effectAcceptReferral.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectAcceptReferral.SelectedPriceOption.Value.Value);

            if (effectAcceptReferral.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectAcceptReferral.AdjustmentReferenceIdOption.Value.Value);
