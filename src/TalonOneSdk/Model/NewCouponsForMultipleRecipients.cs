...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class NewCouponsForMultipleRecipientsJsonConverter : JsonConverter<NewCouponsForMultipleRecipients>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="NewCouponsForMultipleRecipientsJsonConverter" /> class.
        /// </summary>
        public NewCouponsForMultipleRecipientsJsonConverter()
        {
            OnCreated();
        }
