...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EventV3JsonConverter : JsonConverter<EventV3>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EventV3JsonConverter" /> class.
        /// </summary>
        public EventV3JsonConverter()
        {
            OnCreated();
        }
