...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectChangeLoyaltyTierLevel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectChangeLoyaltyTierLevel" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;changeLoyaltyTierLevel&#x60;.</param>
        /// <param name="props">The properties of the &#x60;changeLoyaltyTierLevel&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;changeLoyaltyTierLevel&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum ChangeLoyaltyTierLevel for value: changeLoyaltyTierLevel
            /// </summary>
            ChangeLoyaltyTierLevel = 1
        }
        ...
        {
            if (value.Equals("changeLoyaltyTierLevel"))
                return EffectTypeEnum.ChangeLoyaltyTierLevel;
        ...
        {
            if (value == EffectTypeEnum.ChangeLoyaltyTierLevel)
                return "changeLoyaltyTierLevel";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;changeLoyaltyTierLevel&#x60; effect.</value>
        [JsonPropertyName("props")]
        public ChangeLoyaltyTierLevelEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectChangeLoyaltyTierLevel" />
    /// </summary>
    public partial class EffectChangeLoyaltyTierLevelJsonConverter : JsonConverter<EffectChangeLoyaltyTierLevel>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectChangeLoyaltyTierLevelJsonConverter" /> class.
        /// </summary>
        public EffectChangeLoyaltyTierLevelJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectChangeLoyaltyTierLevel" />
        /// </summary>
        ...
        public override EffectChangeLoyaltyTierLevel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectChangeLoyaltyTierLevel.EffectTypeEnum?> effectType = default;
            Option<ChangeLoyaltyTierLevelEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectChangeLoyaltyTierLevel.EffectTypeEnum? effectTypeValue = EffectChangeLoyaltyTierLevel.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectChangeLoyaltyTierLevel.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<ChangeLoyaltyTierLevelEffectProps>(JsonSerializer.Deserialize<ChangeLoyaltyTierLevelEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectChangeLoyaltyTierLevel.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectChangeLoyaltyTierLevel.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectChangeLoyaltyTierLevel.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectChangeLoyaltyTierLevel.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectChangeLoyaltyTierLevel.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectChangeLoyaltyTierLevel.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectChangeLoyaltyTierLevel.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectChangeLoyaltyTierLevel.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectChangeLoyaltyTierLevel.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectChangeLoyaltyTierLevel.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectChangeLoyaltyTierLevel.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectChangeLoyaltyTierLevel.");

            return new EffectChangeLoyaltyTierLevel(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectChangeLoyaltyTierLevel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectChangeLoyaltyTierLevel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectChangeLoyaltyTierLevel effectChangeLoyaltyTierLevel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectChangeLoyaltyTierLevel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectChangeLoyaltyTierLevel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectChangeLoyaltyTierLevel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectChangeLoyaltyTierLevel effectChangeLoyaltyTierLevel, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectChangeLoyaltyTierLevel.RuleName == null)
                throw new ArgumentNullException(nameof(effectChangeLoyaltyTierLevel.RuleName), "Property is required for class EffectChangeLoyaltyTierLevel.");

            if (effectChangeLoyaltyTierLevel.Props == null)
                throw new ArgumentNullException(nameof(effectChangeLoyaltyTierLevel.Props), "Property is required for class EffectChangeLoyaltyTierLevel.");

            writer.WriteNumber("campaignId", effectChangeLoyaltyTierLevel.CampaignId);

            writer.WriteNumber("rulesetId", effectChangeLoyaltyTierLevel.RulesetId);

            writer.WriteNumber("ruleIndex", effectChangeLoyaltyTierLevel.RuleIndex);

            writer.WriteString("ruleName", effectChangeLoyaltyTierLevel.RuleName);

            var effectTypeRawValue = EffectChangeLoyaltyTierLevel.EffectTypeEnumToJsonValue(effectChangeLoyaltyTierLevel.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectChangeLoyaltyTierLevel.Props, jsonSerializerOptions);
            if (effectChangeLoyaltyTierLevel.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectChangeLoyaltyTierLevel.ExperimentIdOption.Value.Value);

            if (effectChangeLoyaltyTierLevel.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectChangeLoyaltyTierLevel.TriggeredByCouponOption.Value.Value);

            if (effectChangeLoyaltyTierLevel.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectChangeLoyaltyTierLevel.TriggeredForCatalogItemOption.Value.Value);

            if (effectChangeLoyaltyTierLevel.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectChangeLoyaltyTierLevel.ConditionIndexOption.Value.Value);

            if (effectChangeLoyaltyTierLevel.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectChangeLoyaltyTierLevel.EvaluationGroupIDOption.Value.Value);

            if (effectChangeLoyaltyTierLevel.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectChangeLoyaltyTierLevel.EvaluationGroupMode);

            if (effectChangeLoyaltyTierLevel.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectChangeLoyaltyTierLevel.CampaignRevisionIdOption.Value.Value);

            if (effectChangeLoyaltyTierLevel.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectChangeLoyaltyTierLevel.CampaignRevisionVersionIdOption.Value.Value);

            if (effectChangeLoyaltyTierLevel.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectChangeLoyaltyTierLevel.SelectedPriceType);

            if (effectChangeLoyaltyTierLevel.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectChangeLoyaltyTierLevel.SelectedPriceOption.Value.Value);

            if (effectChangeLoyaltyTierLevel.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectChangeLoyaltyTierLevel.AdjustmentReferenceIdOption.Value.Value);

            if (effectChangeLoyaltyTierLevel.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectChangeLoyaltyTierLevel.RewardIdOption.Value.Value);
        }
    }
}
