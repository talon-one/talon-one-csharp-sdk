...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class ApplicationCIFJsonConverter : JsonConverter<ApplicationCIF>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationCIFJsonConverter" /> class.
        /// </summary>
        public ApplicationCIFJsonConverter()
        {
            OnCreated();
        }
