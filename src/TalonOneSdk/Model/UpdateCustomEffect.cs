...
namespace TalonOneSdk.Model
{
    ...
    /// UpdateCustomEffect
    /// </summary>
    public partial class UpdateCustomEffect : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public UpdateCustomEffect(List<long> applicationIds, string name, string title, string payload, bool enabled, Option<bool?> isPerItem = default, Option<string> description = default, Option<List<TemplateArgDef>> @params = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="UpdateCustomEffect" />
    /// </summary>
    public class UpdateCustomEffectJsonConverter : JsonConverter<UpdateCustomEffect>
    {
        /// <summary>
        /// Deserializes json to <see cref="UpdateCustomEffect" />
        /// </summary>
        ...
        public override UpdateCustomEffect Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!applicationIds.IsSet)
                throw new ArgumentException("Property is required for class UpdateCustomEffect.", nameof(applicationIds));

            if (!name.IsSet)
                throw new ArgumentException("Property is required for class UpdateCustomEffect.", nameof(name));

            if (!title.IsSet)
                throw new ArgumentException("Property is required for class UpdateCustomEffect.", nameof(title));

            if (!payload.IsSet)
                throw new ArgumentException("Property is required for class UpdateCustomEffect.", nameof(payload));
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class UpdateCustomEffect.");

            if (varParams.IsSet && varParams.Value == null)
                throw new ArgumentNullException(nameof(varParams), "Property is not nullable for class UpdateCustomEffect.");
        ...
        /// <summary>
        /// Serializes a <see cref="UpdateCustomEffect" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateCustomEffect"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateCustomEffect updateCustomEffect, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, updateCustomEffect, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateCustomEffect" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateCustomEffect"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UpdateCustomEffect updateCustomEffect, JsonSerializerOptions jsonSerializerOptions)
        {
            if (updateCustomEffect.ApplicationIds == null)
                throw new ArgumentNullException(nameof(updateCustomEffect.ApplicationIds), "Property is required for class UpdateCustomEffect.");

            if (updateCustomEffect.Name == null)
                throw new ArgumentNullException(nameof(updateCustomEffect.Name), "Property is required for class UpdateCustomEffect.");

            if (updateCustomEffect.Title == null)
                throw new ArgumentNullException(nameof(updateCustomEffect.Title), "Property is required for class UpdateCustomEffect.");
            ...
            writer.WriteString("name", updateCustomEffect.Name);

            writer.WriteString("title", updateCustomEffect.Title);

            writer.WriteString("payload", updateCustomEffect.Payload);

            writer.WriteBoolean("enabled", updateCustomEffect.Enabled);

            if (updateCustomEffect.IsPerItemOption.IsSet)
                writer.WriteBoolean("isPerItem", updateCustomEffect.IsPerItemOption.Value.Value);

            if (updateCustomEffect.DescriptionOption.IsSet)
                writer.WriteString("description", updateCustomEffect.Description);

            if (updateCustomEffect.ParamsOption.IsSet)
            {
                writer.WritePropertyName("params");
                JsonSerializer.Serialize(writer, updateCustomEffect.Params, jsonSerializerOptions);
            }
        }
    }
}
