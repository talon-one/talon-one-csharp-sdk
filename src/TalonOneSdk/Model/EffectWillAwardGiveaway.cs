...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectWillAwardGiveaway : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectWillAwardGiveaway" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;willAwardGiveaway&#x60;.</param>
        /// <param name="props">The properties of the &#x60;willAwardGiveaway&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>The properties of the &#x60;willAwardGiveaway&#x60; effect.</value>
        [JsonPropertyName("props")]
        public WillAwardGiveawayEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectWillAwardGiveaway" />
    /// </summary>
    public partial class EffectWillAwardGiveawayJsonConverter : JsonConverter<EffectWillAwardGiveaway>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectWillAwardGiveawayJsonConverter" /> class.
        /// </summary>
        public EffectWillAwardGiveawayJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectWillAwardGiveaway" />
        /// </summary>
        ...
        public override EffectWillAwardGiveaway Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectWillAwardGiveaway.EffectTypeEnum?> effectType = default;
            Option<WillAwardGiveawayEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectWillAwardGiveaway.EffectTypeEnum? effectTypeValue = EffectWillAwardGiveaway.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectWillAwardGiveaway.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<WillAwardGiveawayEffectProps>(JsonSerializer.Deserialize<WillAwardGiveawayEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectWillAwardGiveaway.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectWillAwardGiveaway.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectWillAwardGiveaway.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectWillAwardGiveaway.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectWillAwardGiveaway.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectWillAwardGiveaway.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectWillAwardGiveaway.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectWillAwardGiveaway.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectWillAwardGiveaway.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectWillAwardGiveaway.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectWillAwardGiveaway.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectWillAwardGiveaway.");

            return new EffectWillAwardGiveaway(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectWillAwardGiveaway" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectWillAwardGiveaway"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectWillAwardGiveaway effectWillAwardGiveaway, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectWillAwardGiveaway, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectWillAwardGiveaway" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectWillAwardGiveaway"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectWillAwardGiveaway effectWillAwardGiveaway, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectWillAwardGiveaway.RuleName == null)
                throw new ArgumentNullException(nameof(effectWillAwardGiveaway.RuleName), "Property is required for class EffectWillAwardGiveaway.");

            if (effectWillAwardGiveaway.Props == null)
                throw new ArgumentNullException(nameof(effectWillAwardGiveaway.Props), "Property is required for class EffectWillAwardGiveaway.");

            writer.WriteNumber("campaignId", effectWillAwardGiveaway.CampaignId);

            writer.WriteNumber("rulesetId", effectWillAwardGiveaway.RulesetId);

            writer.WriteNumber("ruleIndex", effectWillAwardGiveaway.RuleIndex);

            writer.WriteString("ruleName", effectWillAwardGiveaway.RuleName);

            var effectTypeRawValue = EffectWillAwardGiveaway.EffectTypeEnumToJsonValue(effectWillAwardGiveaway.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectWillAwardGiveaway.Props, jsonSerializerOptions);
            if (effectWillAwardGiveaway.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectWillAwardGiveaway.ExperimentIdOption.Value.Value);

            if (effectWillAwardGiveaway.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectWillAwardGiveaway.TriggeredByCouponOption.Value.Value);

            if (effectWillAwardGiveaway.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectWillAwardGiveaway.TriggeredForCatalogItemOption.Value.Value);

            if (effectWillAwardGiveaway.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectWillAwardGiveaway.ConditionIndexOption.Value.Value);

            if (effectWillAwardGiveaway.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectWillAwardGiveaway.EvaluationGroupIDOption.Value.Value);

            if (effectWillAwardGiveaway.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectWillAwardGiveaway.EvaluationGroupMode);

            if (effectWillAwardGiveaway.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectWillAwardGiveaway.CampaignRevisionIdOption.Value.Value);

            if (effectWillAwardGiveaway.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectWillAwardGiveaway.CampaignRevisionVersionIdOption.Value.Value);

            if (effectWillAwardGiveaway.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectWillAwardGiveaway.SelectedPriceType);

            if (effectWillAwardGiveaway.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectWillAwardGiveaway.SelectedPriceOption.Value.Value);

            if (effectWillAwardGiveaway.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectWillAwardGiveaway.AdjustmentReferenceIdOption.Value.Value);

            if (effectWillAwardGiveaway.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectWillAwardGiveaway.RewardIdOption.Value.Value);
        }
    }
}
