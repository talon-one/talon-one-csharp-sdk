...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class LedgerTransactionLogEntryIntegrationAPIJsonConverter : JsonConverter<LedgerTransactionLogEntryIntegrationAPI>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="LedgerTransactionLogEntryIntegrationAPIJsonConverter" /> class.
        /// </summary>
        public LedgerTransactionLogEntryIntegrationAPIJsonConverter()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            {
                                LedgerTransactionLogEntryIntegrationAPI.TypeEnum? typeValue = LedgerTransactionLogEntryIntegrationAPI.TypeEnumFromStringOrDefault(typeRawValue);
                                if (typeValue == null)
                                    throw new JsonException();
                                type = new Option<LedgerTransactionLogEntryIntegrationAPI.TypeEnum?>(typeValue);
                            }
                            break;
                        case "name":
