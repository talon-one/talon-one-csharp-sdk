...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectReferralCreated : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectReferralCreated" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;referralCreated&#x60;.</param>
        /// <param name="props">The properties of the &#x60;referralCreated&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;referralCreated&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum ReferralCreated for value: referralCreated
            /// </summary>
            ReferralCreated = 1
        }
        ...
        {
            if (value.Equals("referralCreated"))
                return EffectTypeEnum.ReferralCreated;
        ...
        {
            if (value == EffectTypeEnum.ReferralCreated)
        ...
        /// </summary>
        /// <value>The properties of the &#x60;referralCreated&#x60; effect.</value>
        [JsonPropertyName("props")]
        public ReferralCreatedEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectReferralCreated" />
    /// </summary>
    public partial class EffectReferralCreatedJsonConverter : JsonConverter<EffectReferralCreated>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectReferralCreatedJsonConverter" /> class.
        /// </summary>
        public EffectReferralCreatedJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectReferralCreated" />
        /// </summary>
        ...
        public override EffectReferralCreated Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectReferralCreated.EffectTypeEnum?> effectType = default;
            Option<ReferralCreatedEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectReferralCreated.EffectTypeEnum? effectTypeValue = EffectReferralCreated.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectReferralCreated.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<ReferralCreatedEffectProps>(JsonSerializer.Deserialize<ReferralCreatedEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectReferralCreated.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectReferralCreated.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectReferralCreated.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectReferralCreated.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectReferralCreated.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectReferralCreated.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectReferralCreated.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectReferralCreated.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectReferralCreated.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectReferralCreated.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectReferralCreated.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectReferralCreated.");

            return new EffectReferralCreated(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectReferralCreated" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectReferralCreated"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectReferralCreated effectReferralCreated, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectReferralCreated, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectReferralCreated" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectReferralCreated"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectReferralCreated effectReferralCreated, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectReferralCreated.RuleName == null)
                throw new ArgumentNullException(nameof(effectReferralCreated.RuleName), "Property is required for class EffectReferralCreated.");

            if (effectReferralCreated.Props == null)
                throw new ArgumentNullException(nameof(effectReferralCreated.Props), "Property is required for class EffectReferralCreated.");

            writer.WriteNumber("campaignId", effectReferralCreated.CampaignId);

            writer.WriteNumber("rulesetId", effectReferralCreated.RulesetId);

            writer.WriteNumber("ruleIndex", effectReferralCreated.RuleIndex);

            writer.WriteString("ruleName", effectReferralCreated.RuleName);

            var effectTypeRawValue = EffectReferralCreated.EffectTypeEnumToJsonValue(effectReferralCreated.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectReferralCreated.Props, jsonSerializerOptions);
            if (effectReferralCreated.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectReferralCreated.ExperimentIdOption.Value.Value);

            if (effectReferralCreated.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectReferralCreated.TriggeredByCouponOption.Value.Value);

            if (effectReferralCreated.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectReferralCreated.TriggeredForCatalogItemOption.Value.Value);

            if (effectReferralCreated.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectReferralCreated.ConditionIndexOption.Value.Value);

            if (effectReferralCreated.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectReferralCreated.EvaluationGroupIDOption.Value.Value);

            if (effectReferralCreated.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectReferralCreated.EvaluationGroupMode);

            if (effectReferralCreated.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectReferralCreated.CampaignRevisionIdOption.Value.Value);

            if (effectReferralCreated.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectReferralCreated.CampaignRevisionVersionIdOption.Value.Value);

            if (effectReferralCreated.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectReferralCreated.SelectedPriceType);

            if (effectReferralCreated.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectReferralCreated.SelectedPriceOption.Value.Value);

            if (effectReferralCreated.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectReferralCreated.AdjustmentReferenceIdOption.Value.Value);

            if (effectReferralCreated.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectReferralCreated.RewardIdOption.Value.Value);
        }
    }
}
