...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CouponsNotificationPolicyJsonConverter : JsonConverter<CouponsNotificationPolicy>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CouponsNotificationPolicyJsonConverter" /> class.
        /// </summary>
        public CouponsNotificationPolicyJsonConverter()
        {
            OnCreated();
        }
