...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class InventoryCouponJsonConverter : JsonConverter<InventoryCoupon>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryCouponJsonConverter" /> class.
        /// </summary>
        public InventoryCouponJsonConverter()
        {
            OnCreated();
        }
