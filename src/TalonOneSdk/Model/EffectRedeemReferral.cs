...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectRedeemReferral : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRedeemReferral" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;redeemReferral&#x60;.</param>
        /// <param name="props">The properties of the &#x60;redeemReferral&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;redeemReferral&#x60;.</value>
        ...
        public static EffectTypeEnum EffectTypeEnumFromString(string value)
        {
            if (value.Equals("redeemReferral"))
                return EffectTypeEnum.RedeemReferral;
        ...
        {
            if (value == EffectTypeEnum.RedeemReferral)
        ...
        /// </summary>
        /// <value>The properties of the &#x60;redeemReferral&#x60; effect.</value>
        [JsonPropertyName("props")]
        [Obsolete]
        public RedeemReferralEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectRedeemReferral" />
    /// </summary>
    public partial class EffectRedeemReferralJsonConverter : JsonConverter<EffectRedeemReferral>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRedeemReferralJsonConverter" /> class.
        /// </summary>
        public EffectRedeemReferralJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectRedeemReferral" />
        /// </summary>
        ...
        public override EffectRedeemReferral Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectRedeemReferral.EffectTypeEnum?> effectType = default;
            Option<RedeemReferralEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectRedeemReferral.EffectTypeEnum? effectTypeValue = EffectRedeemReferral.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectRedeemReferral.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<RedeemReferralEffectProps>(JsonSerializer.Deserialize<RedeemReferralEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectRedeemReferral.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectRedeemReferral.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectRedeemReferral.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectRedeemReferral.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectRedeemReferral.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectRedeemReferral.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectRedeemReferral.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectRedeemReferral.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectRedeemReferral.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectRedeemReferral.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectRedeemReferral.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectRedeemReferral.");

            return new EffectRedeemReferral(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectRedeemReferral" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRedeemReferral"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectRedeemReferral effectRedeemReferral, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectRedeemReferral, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectRedeemReferral" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRedeemReferral"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectRedeemReferral effectRedeemReferral, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectRedeemReferral.RuleName == null)
                throw new ArgumentNullException(nameof(effectRedeemReferral.RuleName), "Property is required for class EffectRedeemReferral.");

            if (effectRedeemReferral.Props == null)
                throw new ArgumentNullException(nameof(effectRedeemReferral.Props), "Property is required for class EffectRedeemReferral.");

            writer.WriteNumber("campaignId", effectRedeemReferral.CampaignId);

            writer.WriteNumber("rulesetId", effectRedeemReferral.RulesetId);

            writer.WriteNumber("ruleIndex", effectRedeemReferral.RuleIndex);

            writer.WriteString("ruleName", effectRedeemReferral.RuleName);

            var effectTypeRawValue = EffectRedeemReferral.EffectTypeEnumToJsonValue(effectRedeemReferral.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectRedeemReferral.Props, jsonSerializerOptions);
            if (effectRedeemReferral.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectRedeemReferral.ExperimentIdOption.Value.Value);

            if (effectRedeemReferral.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectRedeemReferral.TriggeredByCouponOption.Value.Value);

            if (effectRedeemReferral.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectRedeemReferral.TriggeredForCatalogItemOption.Value.Value);

            if (effectRedeemReferral.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectRedeemReferral.ConditionIndexOption.Value.Value);

            if (effectRedeemReferral.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectRedeemReferral.EvaluationGroupIDOption.Value.Value);

            if (effectRedeemReferral.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectRedeemReferral.EvaluationGroupMode);

            if (effectRedeemReferral.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectRedeemReferral.CampaignRevisionIdOption.Value.Value);

            if (effectRedeemReferral.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectRedeemReferral.CampaignRevisionVersionIdOption.Value.Value);

            if (effectRedeemReferral.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectRedeemReferral.SelectedPriceType);

            if (effectRedeemReferral.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectRedeemReferral.SelectedPriceOption.Value.Value);

            if (effectRedeemReferral.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectRedeemReferral.AdjustmentReferenceIdOption.Value.Value);

            if (effectRedeemReferral.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectRedeemReferral.RewardIdOption.Value.Value);
        }
    }
}
