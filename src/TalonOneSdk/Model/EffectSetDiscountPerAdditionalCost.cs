...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectSetDiscountPerAdditionalCost : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectSetDiscountPerAdditionalCost" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;setDiscountPerAdditionalCost&#x60;.</param>
        /// <param name="props">The properties of the &#x60;setDiscountPerAdditionalCost&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;setDiscountPerAdditionalCost&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum SetDiscountPerAdditionalCost for value: setDiscountPerAdditionalCost
            /// </summary>
            SetDiscountPerAdditionalCost = 1
        }
        ...
        {
            if (value.Equals("setDiscountPerAdditionalCost"))
                return EffectTypeEnum.SetDiscountPerAdditionalCost;
        ...
        {
            if (value == EffectTypeEnum.SetDiscountPerAdditionalCost)
                return "setDiscountPerAdditionalCost";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;setDiscountPerAdditionalCost&#x60; effect.</value>
        [JsonPropertyName("props")]
        public SetDiscountPerAdditionalCostEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectSetDiscountPerAdditionalCost" />
    /// </summary>
    public partial class EffectSetDiscountPerAdditionalCostJsonConverter : JsonConverter<EffectSetDiscountPerAdditionalCost>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectSetDiscountPerAdditionalCostJsonConverter" /> class.
        /// </summary>
        public EffectSetDiscountPerAdditionalCostJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectSetDiscountPerAdditionalCost" />
        /// </summary>
        ...
        public override EffectSetDiscountPerAdditionalCost Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectSetDiscountPerAdditionalCost.EffectTypeEnum?> effectType = default;
            Option<SetDiscountPerAdditionalCostEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectSetDiscountPerAdditionalCost.EffectTypeEnum? effectTypeValue = EffectSetDiscountPerAdditionalCost.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectSetDiscountPerAdditionalCost.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<SetDiscountPerAdditionalCostEffectProps>(JsonSerializer.Deserialize<SetDiscountPerAdditionalCostEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerAdditionalCost.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerAdditionalCost.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerAdditionalCost.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerAdditionalCost.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerAdditionalCost.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerAdditionalCost.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectSetDiscountPerAdditionalCost.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectSetDiscountPerAdditionalCost.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectSetDiscountPerAdditionalCost.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectSetDiscountPerAdditionalCost.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectSetDiscountPerAdditionalCost.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectSetDiscountPerAdditionalCost.");

            return new EffectSetDiscountPerAdditionalCost(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectSetDiscountPerAdditionalCost" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectSetDiscountPerAdditionalCost"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectSetDiscountPerAdditionalCost effectSetDiscountPerAdditionalCost, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectSetDiscountPerAdditionalCost, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectSetDiscountPerAdditionalCost" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectSetDiscountPerAdditionalCost"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectSetDiscountPerAdditionalCost effectSetDiscountPerAdditionalCost, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectSetDiscountPerAdditionalCost.RuleName == null)
                throw new ArgumentNullException(nameof(effectSetDiscountPerAdditionalCost.RuleName), "Property is required for class EffectSetDiscountPerAdditionalCost.");

            if (effectSetDiscountPerAdditionalCost.Props == null)
                throw new ArgumentNullException(nameof(effectSetDiscountPerAdditionalCost.Props), "Property is required for class EffectSetDiscountPerAdditionalCost.");

            writer.WriteNumber("campaignId", effectSetDiscountPerAdditionalCost.CampaignId);

            writer.WriteNumber("rulesetId", effectSetDiscountPerAdditionalCost.RulesetId);

            writer.WriteNumber("ruleIndex", effectSetDiscountPerAdditionalCost.RuleIndex);

            writer.WriteString("ruleName", effectSetDiscountPerAdditionalCost.RuleName);

            var effectTypeRawValue = EffectSetDiscountPerAdditionalCost.EffectTypeEnumToJsonValue(effectSetDiscountPerAdditionalCost.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectSetDiscountPerAdditionalCost.Props, jsonSerializerOptions);
            if (effectSetDiscountPerAdditionalCost.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectSetDiscountPerAdditionalCost.ExperimentIdOption.Value.Value);

            if (effectSetDiscountPerAdditionalCost.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectSetDiscountPerAdditionalCost.TriggeredByCouponOption.Value.Value);

            if (effectSetDiscountPerAdditionalCost.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectSetDiscountPerAdditionalCost.TriggeredForCatalogItemOption.Value.Value);

            if (effectSetDiscountPerAdditionalCost.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectSetDiscountPerAdditionalCost.ConditionIndexOption.Value.Value);

            if (effectSetDiscountPerAdditionalCost.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectSetDiscountPerAdditionalCost.EvaluationGroupIDOption.Value.Value);

            if (effectSetDiscountPerAdditionalCost.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectSetDiscountPerAdditionalCost.EvaluationGroupMode);

            if (effectSetDiscountPerAdditionalCost.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectSetDiscountPerAdditionalCost.CampaignRevisionIdOption.Value.Value);

            if (effectSetDiscountPerAdditionalCost.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectSetDiscountPerAdditionalCost.CampaignRevisionVersionIdOption.Value.Value);

            if (effectSetDiscountPerAdditionalCost.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectSetDiscountPerAdditionalCost.SelectedPriceType);

            if (effectSetDiscountPerAdditionalCost.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectSetDiscountPerAdditionalCost.SelectedPriceOption.Value.Value);

            if (effectSetDiscountPerAdditionalCost.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectSetDiscountPerAdditionalCost.AdjustmentReferenceIdOption.Value.Value);

            if (effectSetDiscountPerAdditionalCost.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectSetDiscountPerAdditionalCost.RewardIdOption.Value.Value);
        }
    }
}
