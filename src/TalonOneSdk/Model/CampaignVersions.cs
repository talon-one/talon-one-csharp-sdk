...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CampaignVersionsJsonConverter : JsonConverter<CampaignVersions>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignVersionsJsonConverter" /> class.
        /// </summary>
        public CampaignVersionsJsonConverter()
        {
            OnCreated();
        }
