...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class LoyaltyProgramJsonConverter : JsonConverter<LoyaltyProgram>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyProgramJsonConverter" /> class.
        /// </summary>
        public LoyaltyProgramJsonConverter()
        {
            OnCreated();
        }
