...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectSetLoyaltyPointsExpiryDate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectSetLoyaltyPointsExpiryDate" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;setLoyaltyPointsExpiryDate&#x60;.</param>
        /// <param name="props">The properties of the &#x60;setLoyaltyPointsExpiryDate&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;setLoyaltyPointsExpiryDate&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum SetLoyaltyPointsExpiryDate for value: setLoyaltyPointsExpiryDate
            /// </summary>
            SetLoyaltyPointsExpiryDate = 1
        }
        ...
        {
            if (value.Equals("setLoyaltyPointsExpiryDate"))
                return EffectTypeEnum.SetLoyaltyPointsExpiryDate;
        ...
        {
            if (value == EffectTypeEnum.SetLoyaltyPointsExpiryDate)
                return "setLoyaltyPointsExpiryDate";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;setLoyaltyPointsExpiryDate&#x60; effect.</value>
        [JsonPropertyName("props")]
        public SetLoyaltyPointsExpiryDateEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectSetLoyaltyPointsExpiryDate" />
    /// </summary>
    public partial class EffectSetLoyaltyPointsExpiryDateJsonConverter : JsonConverter<EffectSetLoyaltyPointsExpiryDate>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectSetLoyaltyPointsExpiryDateJsonConverter" /> class.
        /// </summary>
        public EffectSetLoyaltyPointsExpiryDateJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectSetLoyaltyPointsExpiryDate" />
        /// </summary>
        ...
        public override EffectSetLoyaltyPointsExpiryDate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectSetLoyaltyPointsExpiryDate.EffectTypeEnum?> effectType = default;
            Option<SetLoyaltyPointsExpiryDateEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectSetLoyaltyPointsExpiryDate.EffectTypeEnum? effectTypeValue = EffectSetLoyaltyPointsExpiryDate.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectSetLoyaltyPointsExpiryDate.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<SetLoyaltyPointsExpiryDateEffectProps>(JsonSerializer.Deserialize<SetLoyaltyPointsExpiryDateEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectSetLoyaltyPointsExpiryDate.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectSetLoyaltyPointsExpiryDate.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectSetLoyaltyPointsExpiryDate.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectSetLoyaltyPointsExpiryDate.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectSetLoyaltyPointsExpiryDate.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectSetLoyaltyPointsExpiryDate.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectSetLoyaltyPointsExpiryDate.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectSetLoyaltyPointsExpiryDate.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectSetLoyaltyPointsExpiryDate.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectSetLoyaltyPointsExpiryDate.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectSetLoyaltyPointsExpiryDate.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectSetLoyaltyPointsExpiryDate.");

            return new EffectSetLoyaltyPointsExpiryDate(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectSetLoyaltyPointsExpiryDate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectSetLoyaltyPointsExpiryDate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectSetLoyaltyPointsExpiryDate effectSetLoyaltyPointsExpiryDate, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectSetLoyaltyPointsExpiryDate, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectSetLoyaltyPointsExpiryDate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectSetLoyaltyPointsExpiryDate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectSetLoyaltyPointsExpiryDate effectSetLoyaltyPointsExpiryDate, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectSetLoyaltyPointsExpiryDate.RuleName == null)
                throw new ArgumentNullException(nameof(effectSetLoyaltyPointsExpiryDate.RuleName), "Property is required for class EffectSetLoyaltyPointsExpiryDate.");

            if (effectSetLoyaltyPointsExpiryDate.Props == null)
                throw new ArgumentNullException(nameof(effectSetLoyaltyPointsExpiryDate.Props), "Property is required for class EffectSetLoyaltyPointsExpiryDate.");

            writer.WriteNumber("campaignId", effectSetLoyaltyPointsExpiryDate.CampaignId);

            writer.WriteNumber("rulesetId", effectSetLoyaltyPointsExpiryDate.RulesetId);

            writer.WriteNumber("ruleIndex", effectSetLoyaltyPointsExpiryDate.RuleIndex);

            writer.WriteString("ruleName", effectSetLoyaltyPointsExpiryDate.RuleName);

            var effectTypeRawValue = EffectSetLoyaltyPointsExpiryDate.EffectTypeEnumToJsonValue(effectSetLoyaltyPointsExpiryDate.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectSetLoyaltyPointsExpiryDate.Props, jsonSerializerOptions);
            if (effectSetLoyaltyPointsExpiryDate.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectSetLoyaltyPointsExpiryDate.ExperimentIdOption.Value.Value);

            if (effectSetLoyaltyPointsExpiryDate.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectSetLoyaltyPointsExpiryDate.TriggeredByCouponOption.Value.Value);

            if (effectSetLoyaltyPointsExpiryDate.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectSetLoyaltyPointsExpiryDate.TriggeredForCatalogItemOption.Value.Value);

            if (effectSetLoyaltyPointsExpiryDate.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectSetLoyaltyPointsExpiryDate.ConditionIndexOption.Value.Value);

            if (effectSetLoyaltyPointsExpiryDate.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectSetLoyaltyPointsExpiryDate.EvaluationGroupIDOption.Value.Value);

            if (effectSetLoyaltyPointsExpiryDate.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectSetLoyaltyPointsExpiryDate.EvaluationGroupMode);

            if (effectSetLoyaltyPointsExpiryDate.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectSetLoyaltyPointsExpiryDate.CampaignRevisionIdOption.Value.Value);

            if (effectSetLoyaltyPointsExpiryDate.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectSetLoyaltyPointsExpiryDate.CampaignRevisionVersionIdOption.Value.Value);

            if (effectSetLoyaltyPointsExpiryDate.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectSetLoyaltyPointsExpiryDate.SelectedPriceType);

            if (effectSetLoyaltyPointsExpiryDate.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectSetLoyaltyPointsExpiryDate.SelectedPriceOption.Value.Value);

            if (effectSetLoyaltyPointsExpiryDate.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectSetLoyaltyPointsExpiryDate.AdjustmentReferenceIdOption.Value.Value);

            if (effectSetLoyaltyPointsExpiryDate.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectSetLoyaltyPointsExpiryDate.RewardIdOption.Value.Value);
        }
    }
}
