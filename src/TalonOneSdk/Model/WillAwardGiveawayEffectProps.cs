...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class WillAwardGiveawayEffectPropsJsonConverter : JsonConverter<WillAwardGiveawayEffectProps>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="WillAwardGiveawayEffectPropsJsonConverter" /> class.
        /// </summary>
        public WillAwardGiveawayEffectPropsJsonConverter()
        {
            OnCreated();
        }
