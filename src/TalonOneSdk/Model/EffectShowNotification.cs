...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectShowNotification : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectShowNotification" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;showNotification&#x60;.</param>
        /// <param name="props">The properties of the &#x60;showNotification&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;showNotification&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum ShowNotification for value: showNotification
            /// </summary>
            ShowNotification = 1
        }
        ...
        {
            if (value.Equals("showNotification"))
                return EffectTypeEnum.ShowNotification;
        ...
        {
            if (value == EffectTypeEnum.ShowNotification)
        ...
        /// </summary>
        /// <value>The properties of the &#x60;showNotification&#x60; effect.</value>
        [JsonPropertyName("props")]
        public ShowNotificationEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectShowNotification" />
    /// </summary>
    public partial class EffectShowNotificationJsonConverter : JsonConverter<EffectShowNotification>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectShowNotificationJsonConverter" /> class.
        /// </summary>
        public EffectShowNotificationJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectShowNotification" />
        /// </summary>
        ...
        public override EffectShowNotification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectShowNotification.EffectTypeEnum?> effectType = default;
            Option<ShowNotificationEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectShowNotification.EffectTypeEnum? effectTypeValue = EffectShowNotification.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectShowNotification.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<ShowNotificationEffectProps>(JsonSerializer.Deserialize<ShowNotificationEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectShowNotification.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectShowNotification.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectShowNotification.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectShowNotification.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectShowNotification.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectShowNotification.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectShowNotification.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectShowNotification.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectShowNotification.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectShowNotification.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectShowNotification.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectShowNotification.");

            return new EffectShowNotification(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectShowNotification" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectShowNotification"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectShowNotification effectShowNotification, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectShowNotification, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectShowNotification" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectShowNotification"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectShowNotification effectShowNotification, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectShowNotification.RuleName == null)
                throw new ArgumentNullException(nameof(effectShowNotification.RuleName), "Property is required for class EffectShowNotification.");

            if (effectShowNotification.Props == null)
                throw new ArgumentNullException(nameof(effectShowNotification.Props), "Property is required for class EffectShowNotification.");

            writer.WriteNumber("campaignId", effectShowNotification.CampaignId);

            writer.WriteNumber("rulesetId", effectShowNotification.RulesetId);

            writer.WriteNumber("ruleIndex", effectShowNotification.RuleIndex);

            writer.WriteString("ruleName", effectShowNotification.RuleName);

            var effectTypeRawValue = EffectShowNotification.EffectTypeEnumToJsonValue(effectShowNotification.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectShowNotification.Props, jsonSerializerOptions);
            if (effectShowNotification.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectShowNotification.ExperimentIdOption.Value.Value);

            if (effectShowNotification.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectShowNotification.TriggeredByCouponOption.Value.Value);

            if (effectShowNotification.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectShowNotification.TriggeredForCatalogItemOption.Value.Value);

            if (effectShowNotification.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectShowNotification.ConditionIndexOption.Value.Value);

            if (effectShowNotification.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectShowNotification.EvaluationGroupIDOption.Value.Value);

            if (effectShowNotification.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectShowNotification.EvaluationGroupMode);

            if (effectShowNotification.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectShowNotification.CampaignRevisionIdOption.Value.Value);

            if (effectShowNotification.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectShowNotification.CampaignRevisionVersionIdOption.Value.Value);

            if (effectShowNotification.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectShowNotification.SelectedPriceType);

            if (effectShowNotification.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectShowNotification.SelectedPriceOption.Value.Value);

            if (effectShowNotification.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectShowNotification.AdjustmentReferenceIdOption.Value.Value);

            if (effectShowNotification.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectShowNotification.RewardIdOption.Value.Value);
        }
    }
}
