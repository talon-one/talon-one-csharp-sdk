...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectShowBundleMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectShowBundleMetadata" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;showBundleMetadata&#x60;.</param>
        /// <param name="props">The properties of the &#x60;showBundleMetadata&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;showBundleMetadata&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum ShowBundleMetadata for value: showBundleMetadata
            /// </summary>
            ShowBundleMetadata = 1
        }
        ...
        {
            if (value.Equals("showBundleMetadata"))
                return EffectTypeEnum.ShowBundleMetadata;
        ...
        {
            if (value == EffectTypeEnum.ShowBundleMetadata)
                return "showBundleMetadata";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;showBundleMetadata&#x60; effect.</value>
        [JsonPropertyName("props")]
        [Obsolete]
        public ShowBundleMetadataEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectShowBundleMetadata" />
    /// </summary>
    public partial class EffectShowBundleMetadataJsonConverter : JsonConverter<EffectShowBundleMetadata>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectShowBundleMetadataJsonConverter" /> class.
        /// </summary>
        public EffectShowBundleMetadataJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectShowBundleMetadata" />
        /// </summary>
        ...
        public override EffectShowBundleMetadata Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectShowBundleMetadata.EffectTypeEnum?> effectType = default;
            Option<ShowBundleMetadataEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectShowBundleMetadata.EffectTypeEnum? effectTypeValue = EffectShowBundleMetadata.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectShowBundleMetadata.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<ShowBundleMetadataEffectProps>(JsonSerializer.Deserialize<ShowBundleMetadataEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectShowBundleMetadata.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectShowBundleMetadata.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectShowBundleMetadata.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectShowBundleMetadata.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectShowBundleMetadata.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectShowBundleMetadata.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectShowBundleMetadata.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectShowBundleMetadata.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectShowBundleMetadata.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectShowBundleMetadata.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectShowBundleMetadata.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectShowBundleMetadata.");

            return new EffectShowBundleMetadata(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectShowBundleMetadata" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectShowBundleMetadata"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectShowBundleMetadata effectShowBundleMetadata, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectShowBundleMetadata, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectShowBundleMetadata" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectShowBundleMetadata"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectShowBundleMetadata effectShowBundleMetadata, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectShowBundleMetadata.RuleName == null)
                throw new ArgumentNullException(nameof(effectShowBundleMetadata.RuleName), "Property is required for class EffectShowBundleMetadata.");

            if (effectShowBundleMetadata.Props == null)
                throw new ArgumentNullException(nameof(effectShowBundleMetadata.Props), "Property is required for class EffectShowBundleMetadata.");

            writer.WriteNumber("campaignId", effectShowBundleMetadata.CampaignId);

            writer.WriteNumber("rulesetId", effectShowBundleMetadata.RulesetId);

            writer.WriteNumber("ruleIndex", effectShowBundleMetadata.RuleIndex);

            writer.WriteString("ruleName", effectShowBundleMetadata.RuleName);

            var effectTypeRawValue = EffectShowBundleMetadata.EffectTypeEnumToJsonValue(effectShowBundleMetadata.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectShowBundleMetadata.Props, jsonSerializerOptions);
            if (effectShowBundleMetadata.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectShowBundleMetadata.ExperimentIdOption.Value.Value);

            if (effectShowBundleMetadata.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectShowBundleMetadata.TriggeredByCouponOption.Value.Value);

            if (effectShowBundleMetadata.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectShowBundleMetadata.TriggeredForCatalogItemOption.Value.Value);

            if (effectShowBundleMetadata.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectShowBundleMetadata.ConditionIndexOption.Value.Value);

            if (effectShowBundleMetadata.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectShowBundleMetadata.EvaluationGroupIDOption.Value.Value);

            if (effectShowBundleMetadata.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectShowBundleMetadata.EvaluationGroupMode);

            if (effectShowBundleMetadata.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectShowBundleMetadata.CampaignRevisionIdOption.Value.Value);

            if (effectShowBundleMetadata.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectShowBundleMetadata.CampaignRevisionVersionIdOption.Value.Value);

            if (effectShowBundleMetadata.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectShowBundleMetadata.SelectedPriceType);

            if (effectShowBundleMetadata.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectShowBundleMetadata.SelectedPriceOption.Value.Value);

            if (effectShowBundleMetadata.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectShowBundleMetadata.AdjustmentReferenceIdOption.Value.Value);

            if (effectShowBundleMetadata.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectShowBundleMetadata.RewardIdOption.Value.Value);
        }
    }
}
