...
namespace TalonOneSdk.Model
{
    ...
    /// BaseLoyaltyProgram
    /// </summary>
    public partial class BaseLoyaltyProgram : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public BaseLoyaltyProgram(Option<string> title = default, Option<string> description = default, Option<List<long>> subscribedApplications = default, Option<string> defaultValidity = default, Option<string> defaultPending = default, Option<bool?> allowSubledger = default, Option<long?> usersPerCardLimit = default, Option<bool?> sandbox = default, Option<ProgramJoinPolicyEnum?> programJoinPolicy = default, Option<TiersExpirationPolicyEnum?> tiersExpirationPolicy = default, Option<DateTime?> tierCycleStartDate = default, Option<string> tiersExpireIn = default, Option<TiersDowngradePolicyEnum?> tiersDowngradePolicy = default, Option<CodeGeneratorSettings> cardCodeSettings = default, Option<ReturnPolicyEnum?> returnPolicy = default)
        {
            TitleOption = title;
    ...
    /// <summary>
    /// A Json converter for type <see cref="BaseLoyaltyProgram" />
    /// </summary>
    public partial class BaseLoyaltyProgramJsonConverter : JsonConverter<BaseLoyaltyProgram>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="BaseLoyaltyProgramJsonConverter" /> class.
        /// </summary>
        public BaseLoyaltyProgramJsonConverter()
        {
            OnCreated();
        }
        ...
        /// <summary>
        /// Deserializes json to <see cref="BaseLoyaltyProgram" />
        /// </summary>
        ...
        public override BaseLoyaltyProgram Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<BaseLoyaltyProgram.ProgramJoinPolicyEnum?> programJoinPolicy = default;
            Option<BaseLoyaltyProgram.TiersExpirationPolicyEnum?> tiersExpirationPolicy = default;
            Option<DateTime?> tierCycleStartDate = default;
            Option<string> tiersExpireIn = default;
            Option<BaseLoyaltyProgram.TiersDowngradePolicyEnum?> tiersDowngradePolicy = default;
            Option<CodeGeneratorSettings> cardCodeSettings = default;
            Option<BaseLoyaltyProgram.ReturnPolicyEnum?> returnPolicy = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "programJoinPolicy":
                            ...
                            {
                                BaseLoyaltyProgram.ProgramJoinPolicyEnum? programJoinPolicyValue = BaseLoyaltyProgram.ProgramJoinPolicyEnumFromStringOrDefault(programJoinPolicyRawValue);
                                if (programJoinPolicyValue == null)
                                    throw new JsonException();
                                programJoinPolicy = new Option<BaseLoyaltyProgram.ProgramJoinPolicyEnum?>(programJoinPolicyValue);
                            }
                            break;
                        case "tiersExpirationPolicy":
                            ...
                            {
                                BaseLoyaltyProgram.TiersExpirationPolicyEnum? tiersExpirationPolicyValue = BaseLoyaltyProgram.TiersExpirationPolicyEnumFromStringOrDefault(tiersExpirationPolicyRawValue);
                                if (tiersExpirationPolicyValue == null)
                                    throw new JsonException();
                                tiersExpirationPolicy = new Option<BaseLoyaltyProgram.TiersExpirationPolicyEnum?>(tiersExpirationPolicyValue);
                            }
                            break;
                        ...
                        case "tiersDowngradePolicy":
                            ...
                            {
                                BaseLoyaltyProgram.TiersDowngradePolicyEnum? tiersDowngradePolicyValue = BaseLoyaltyProgram.TiersDowngradePolicyEnumFromStringOrDefault(tiersDowngradePolicyRawValue);
                                if (tiersDowngradePolicyValue == null)
                                    throw new JsonException();
                                tiersDowngradePolicy = new Option<BaseLoyaltyProgram.TiersDowngradePolicyEnum?>(tiersDowngradePolicyValue);
                            }
                            break;
                        ...
                        case "returnPolicy":
                            ...
                            {
                                BaseLoyaltyProgram.ReturnPolicyEnum? returnPolicyValue = BaseLoyaltyProgram.ReturnPolicyEnumFromStringOrDefault(returnPolicyRawValue);
                                if (returnPolicyValue == null)
                                    throw new JsonException();
                                returnPolicy = new Option<BaseLoyaltyProgram.ReturnPolicyEnum?>(returnPolicyValue);
                            }
                            break;
                        default:
                            break;
        ...
        /// <summary>
        /// Serializes a <see cref="BaseLoyaltyProgram" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="baseLoyaltyProgram"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BaseLoyaltyProgram baseLoyaltyProgram, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, baseLoyaltyProgram, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BaseLoyaltyProgram" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="baseLoyaltyProgram"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, BaseLoyaltyProgram baseLoyaltyProgram, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (baseLoyaltyProgram.DescriptionOption.IsSet)
                writer.WriteString("description", baseLoyaltyProgram.Description);

            if (baseLoyaltyProgram.SubscribedApplicationsOption.IsSet)
            {
                writer.WritePropertyName("subscribedApplications");
                JsonSerializer.Serialize(writer, baseLoyaltyProgram.SubscribedApplications, jsonSerializerOptions);
            }
            if (baseLoyaltyProgram.DefaultValidityOption.IsSet)
                writer.WriteString("defaultValidity", baseLoyaltyProgram.DefaultValidity);

            if (baseLoyaltyProgram.DefaultPendingOption.IsSet)
                writer.WriteString("defaultPending", baseLoyaltyProgram.DefaultPending);

            if (baseLoyaltyProgram.AllowSubledgerOption.IsSet)
                writer.WriteBoolean("allowSubledger", baseLoyaltyProgram.AllowSubledgerOption.Value.Value);

            if (baseLoyaltyProgram.UsersPerCardLimitOption.IsSet)
                writer.WriteNumber("usersPerCardLimit", baseLoyaltyProgram.UsersPerCardLimitOption.Value.Value);

            if (baseLoyaltyProgram.SandboxOption.IsSet)
                writer.WriteBoolean("sandbox", baseLoyaltyProgram.SandboxOption.Value.Value);

            if (baseLoyaltyProgram.ProgramJoinPolicyOption.IsSet)
            {
                var programJoinPolicyRawValue = BaseLoyaltyProgram.ProgramJoinPolicyEnumToJsonValue(baseLoyaltyProgram.ProgramJoinPolicyOption.Value);
                writer.WriteString("programJoinPolicy", programJoinPolicyRawValue);
            }
            if (baseLoyaltyProgram.TiersExpirationPolicyOption.IsSet)
            {
                var tiersExpirationPolicyRawValue = BaseLoyaltyProgram.TiersExpirationPolicyEnumToJsonValue(baseLoyaltyProgram.TiersExpirationPolicyOption.Value);
                writer.WriteString("tiersExpirationPolicy", tiersExpirationPolicyRawValue);
            }
            if (baseLoyaltyProgram.TierCycleStartDateOption.IsSet)
                writer.WriteString("tierCycleStartDate", baseLoyaltyProgram.TierCycleStartDateOption.Value.Value.ToString(TierCycleStartDateFormat));

            if (baseLoyaltyProgram.TiersExpireInOption.IsSet)
                writer.WriteString("tiersExpireIn", baseLoyaltyProgram.TiersExpireIn);

            if (baseLoyaltyProgram.TiersDowngradePolicyOption.IsSet)
            {
                var tiersDowngradePolicyRawValue = BaseLoyaltyProgram.TiersDowngradePolicyEnumToJsonValue(baseLoyaltyProgram.TiersDowngradePolicyOption.Value);
                writer.WriteString("tiersDowngradePolicy", tiersDowngradePolicyRawValue);
            }
            if (baseLoyaltyProgram.CardCodeSettingsOption.IsSet)
            {
                writer.WritePropertyName("cardCodeSettings");
                JsonSerializer.Serialize(writer, baseLoyaltyProgram.CardCodeSettings, jsonSerializerOptions);
            }
            if (baseLoyaltyProgram.ReturnPolicyOption.IsSet)
            {
                var returnPolicyRawValue = BaseLoyaltyProgram.ReturnPolicyEnumToJsonValue(baseLoyaltyProgram.ReturnPolicyOption.Value);
