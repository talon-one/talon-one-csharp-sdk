...
namespace TalonOneSdk.Model
{
    ...
    public partial class CheckCouponBlock : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CheckCouponBlock(string id, string type, bool redeem, Option<List<string>> tags = default, Option<List<PromotionBlock>> onFailure = default)
        {
            Id = id;
            Type = type;
            Redeem = redeem;
    ...
    /// </summary>
    public partial class CheckCouponBlockJsonConverter : JsonConverter<CheckCouponBlock>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CheckCouponBlockJsonConverter" /> class.
        /// </summary>
        public CheckCouponBlockJsonConverter()
        {
            OnCreated();
        }
