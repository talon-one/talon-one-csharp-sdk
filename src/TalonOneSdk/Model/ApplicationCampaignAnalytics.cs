...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class ApplicationCampaignAnalyticsJsonConverter : JsonConverter<ApplicationCampaignAnalytics>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationCampaignAnalyticsJsonConverter" /> class.
        /// </summary>
        public ApplicationCampaignAnalyticsJsonConverter()
        {
            OnCreated();
        }
