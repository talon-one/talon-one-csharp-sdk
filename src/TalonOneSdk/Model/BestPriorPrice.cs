...
namespace TalonOneSdk.Model
{
    ...
    public class BestPriorPriceJsonConverter : JsonConverter<BestPriorPrice>
    {
        ...
        public override BestPriorPrice Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!contextId.IsSet)
                throw new ArgumentException("Property is required for class BestPriorPrice.", nameof(contextId));
        ...
        public void WriteProperties(Utf8JsonWriter writer, BestPriorPrice bestPriorPrice, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (bestPriorPrice.ContextId == null)
                throw new ArgumentNullException(nameof(bestPriorPrice.ContextId), "Property is required for class BestPriorPrice.");
