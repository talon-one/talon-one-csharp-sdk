...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class IntegrationCampaignJsonConverter : JsonConverter<IntegrationCampaign>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="IntegrationCampaignJsonConverter" /> class.
        /// </summary>
        public IntegrationCampaignJsonConverter()
        {
            OnCreated();
        }
        ...
        public override IntegrationCampaign Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "state":
                            ...
                            {
                                IntegrationCampaign.StateEnum? stateValue = IntegrationCampaign.StateEnumFromStringOrDefault(stateRawValue);
                                if (stateValue == null)
                                    throw new JsonException();
                                state = new Option<IntegrationCampaign.StateEnum?>(stateValue);
                            }
                            break;
                        case "linkedStoreIds":
            ...
            if (!rules.IsSet)
                throw new ArgumentException("Property is required for class IntegrationCampaign.", nameof(rules));
            ...
            if (rules.IsSet && rules.Value == null)
                throw new ArgumentNullException(nameof(rules), "Property is not nullable for class IntegrationCampaign.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, IntegrationCampaign integrationCampaign, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (integrationCampaign.Rules == null)
                throw new ArgumentNullException(nameof(integrationCampaign.Rules), "Property is required for class IntegrationCampaign.");
