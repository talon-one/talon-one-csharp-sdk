...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class WebhookWithOutgoingIntegrationDetailsJsonConverter : JsonConverter<WebhookWithOutgoingIntegrationDetails>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookWithOutgoingIntegrationDetailsJsonConverter" /> class.
        /// </summary>
        public WebhookWithOutgoingIntegrationDetailsJsonConverter()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "verb":
                            ...
                            {
                                WebhookWithOutgoingIntegrationDetails.VerbEnum? verbValue = WebhookWithOutgoingIntegrationDetails.VerbEnumFromStringOrDefault(verbRawValue);
                                if (verbValue == null)
                                    throw new JsonException();
                                verb = new Option<WebhookWithOutgoingIntegrationDetails.VerbEnum?>(verbValue);
                            }
                            break;
                        case "url":
