...
namespace TalonOneSdk.Model
{
    ...
    /// EffectRejectCoupon
    /// </summary>
    public partial class EffectRejectCoupon : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRejectCoupon" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;rejectCoupon&#x60;.</param>
        /// <param name="props">The properties of the &#x60;rejectCoupon&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;rejectCoupon&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum RejectCoupon for value: rejectCoupon
            /// </summary>
            RejectCoupon = 1
        }
        ...
        {
            if (value.Equals("rejectCoupon"))
                return EffectTypeEnum.RejectCoupon;
        ...
        {
            if (value == EffectTypeEnum.RejectCoupon)
                return "rejectCoupon";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;rejectCoupon&#x60; effect.</value>
        [JsonPropertyName("props")]
        public RejectCouponEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectRejectCoupon" />
    /// </summary>
    public partial class EffectRejectCouponJsonConverter : JsonConverter<EffectRejectCoupon>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRejectCouponJsonConverter" /> class.
        /// </summary>
        public EffectRejectCouponJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectRejectCoupon" />
        /// </summary>
        ...
        public override EffectRejectCoupon Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectRejectCoupon.EffectTypeEnum?> effectType = default;
            Option<RejectCouponEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectRejectCoupon.EffectTypeEnum? effectTypeValue = EffectRejectCoupon.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectRejectCoupon.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<RejectCouponEffectProps>(JsonSerializer.Deserialize<RejectCouponEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectRejectCoupon.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectRejectCoupon.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectRejectCoupon.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectRejectCoupon.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectRejectCoupon.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectRejectCoupon.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectRejectCoupon.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectRejectCoupon.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectRejectCoupon.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectRejectCoupon.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectRejectCoupon.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectRejectCoupon.");

            return new EffectRejectCoupon(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectRejectCoupon" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRejectCoupon"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectRejectCoupon effectRejectCoupon, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectRejectCoupon, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectRejectCoupon" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRejectCoupon"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectRejectCoupon effectRejectCoupon, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectRejectCoupon.RuleName == null)
                throw new ArgumentNullException(nameof(effectRejectCoupon.RuleName), "Property is required for class EffectRejectCoupon.");

            if (effectRejectCoupon.Props == null)
                throw new ArgumentNullException(nameof(effectRejectCoupon.Props), "Property is required for class EffectRejectCoupon.");

            writer.WriteNumber("campaignId", effectRejectCoupon.CampaignId);

            writer.WriteNumber("rulesetId", effectRejectCoupon.RulesetId);

            writer.WriteNumber("ruleIndex", effectRejectCoupon.RuleIndex);

            writer.WriteString("ruleName", effectRejectCoupon.RuleName);

            var effectTypeRawValue = EffectRejectCoupon.EffectTypeEnumToJsonValue(effectRejectCoupon.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectRejectCoupon.Props, jsonSerializerOptions);
            if (effectRejectCoupon.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectRejectCoupon.ExperimentIdOption.Value.Value);

            if (effectRejectCoupon.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectRejectCoupon.TriggeredByCouponOption.Value.Value);

            if (effectRejectCoupon.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectRejectCoupon.TriggeredForCatalogItemOption.Value.Value);

            if (effectRejectCoupon.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectRejectCoupon.ConditionIndexOption.Value.Value);

            if (effectRejectCoupon.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectRejectCoupon.EvaluationGroupIDOption.Value.Value);

            if (effectRejectCoupon.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectRejectCoupon.EvaluationGroupMode);

            if (effectRejectCoupon.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectRejectCoupon.CampaignRevisionIdOption.Value.Value);

            if (effectRejectCoupon.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectRejectCoupon.CampaignRevisionVersionIdOption.Value.Value);

            if (effectRejectCoupon.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectRejectCoupon.SelectedPriceType);

            if (effectRejectCoupon.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectRejectCoupon.SelectedPriceOption.Value.Value);

            if (effectRejectCoupon.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectRejectCoupon.AdjustmentReferenceIdOption.Value.Value);

            if (effectRejectCoupon.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectRejectCoupon.RewardIdOption.Value.Value);
        }
    }
}
