...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectRollbackDiscount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRollbackDiscount" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;rollbackDiscount&#x60;.</param>
        /// <param name="props">The properties of the &#x60;rollbackDiscount&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;rollbackDiscount&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum RollbackDiscount for value: rollbackDiscount
            /// </summary>
            RollbackDiscount = 1
        }
        ...
        {
            if (value.Equals("rollbackDiscount"))
                return EffectTypeEnum.RollbackDiscount;
        ...
        {
            if (value == EffectTypeEnum.RollbackDiscount)
        ...
        /// </summary>
        /// <value>The properties of the &#x60;rollbackDiscount&#x60; effect.</value>
        [JsonPropertyName("props")]
        public RollbackDiscountEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectRollbackDiscount" />
    /// </summary>
    public partial class EffectRollbackDiscountJsonConverter : JsonConverter<EffectRollbackDiscount>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRollbackDiscountJsonConverter" /> class.
        /// </summary>
        public EffectRollbackDiscountJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectRollbackDiscount" />
        /// </summary>
        ...
        public override EffectRollbackDiscount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectRollbackDiscount.EffectTypeEnum?> effectType = default;
            Option<RollbackDiscountEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectRollbackDiscount.EffectTypeEnum? effectTypeValue = EffectRollbackDiscount.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectRollbackDiscount.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<RollbackDiscountEffectProps>(JsonSerializer.Deserialize<RollbackDiscountEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackDiscount.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackDiscount.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackDiscount.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackDiscount.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackDiscount.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackDiscount.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectRollbackDiscount.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectRollbackDiscount.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectRollbackDiscount.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectRollbackDiscount.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectRollbackDiscount.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectRollbackDiscount.");

            return new EffectRollbackDiscount(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectRollbackDiscount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRollbackDiscount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectRollbackDiscount effectRollbackDiscount, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectRollbackDiscount, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectRollbackDiscount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRollbackDiscount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectRollbackDiscount effectRollbackDiscount, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectRollbackDiscount.RuleName == null)
                throw new ArgumentNullException(nameof(effectRollbackDiscount.RuleName), "Property is required for class EffectRollbackDiscount.");

            if (effectRollbackDiscount.Props == null)
                throw new ArgumentNullException(nameof(effectRollbackDiscount.Props), "Property is required for class EffectRollbackDiscount.");

            writer.WriteNumber("campaignId", effectRollbackDiscount.CampaignId);

            writer.WriteNumber("rulesetId", effectRollbackDiscount.RulesetId);

            writer.WriteNumber("ruleIndex", effectRollbackDiscount.RuleIndex);

            writer.WriteString("ruleName", effectRollbackDiscount.RuleName);

            var effectTypeRawValue = EffectRollbackDiscount.EffectTypeEnumToJsonValue(effectRollbackDiscount.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectRollbackDiscount.Props, jsonSerializerOptions);
            if (effectRollbackDiscount.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectRollbackDiscount.ExperimentIdOption.Value.Value);

            if (effectRollbackDiscount.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectRollbackDiscount.TriggeredByCouponOption.Value.Value);

            if (effectRollbackDiscount.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectRollbackDiscount.TriggeredForCatalogItemOption.Value.Value);

            if (effectRollbackDiscount.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectRollbackDiscount.ConditionIndexOption.Value.Value);

            if (effectRollbackDiscount.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectRollbackDiscount.EvaluationGroupIDOption.Value.Value);

            if (effectRollbackDiscount.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectRollbackDiscount.EvaluationGroupMode);

            if (effectRollbackDiscount.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectRollbackDiscount.CampaignRevisionIdOption.Value.Value);

            if (effectRollbackDiscount.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectRollbackDiscount.CampaignRevisionVersionIdOption.Value.Value);

            if (effectRollbackDiscount.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectRollbackDiscount.SelectedPriceType);

            if (effectRollbackDiscount.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectRollbackDiscount.SelectedPriceOption.Value.Value);

            if (effectRollbackDiscount.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectRollbackDiscount.AdjustmentReferenceIdOption.Value.Value);

            if (effectRollbackDiscount.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectRollbackDiscount.RewardIdOption.Value.Value);
        }
    }
}
