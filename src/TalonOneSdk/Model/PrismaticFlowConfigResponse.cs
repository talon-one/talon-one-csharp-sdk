...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class PrismaticFlowConfigResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PrismaticFlowConfigResponse" /> class.
        /// </summary>
        /// <param name="workerCount">Number of Prismatic workers to run in parallel for this flow (maximum 500).</param>
        /// <param name="maxEventsPerMessage">Maximum number of events to send in a single message to Prismatic.</param>
        /// <param name="maxRetries">Maximum number of retries for a Prismatic event before it is ignored.</param>
        [JsonConstructor]
        public PrismaticFlowConfigResponse(Option<long?> workerCount = default, Option<long?> maxEventsPerMessage = default, Option<long?> maxRetries = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="PrismaticFlowConfigResponse" />
    /// </summary>
    public class PrismaticFlowConfigResponseJsonConverter : JsonConverter<PrismaticFlowConfigResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="PrismaticFlowConfigResponse" />
        /// </summary>
        ...
        public override PrismaticFlowConfigResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (workerCount.IsSet && workerCount.Value == null)
                throw new ArgumentNullException(nameof(workerCount), "Property is not nullable for class PrismaticFlowConfigResponse.");

            if (maxEventsPerMessage.IsSet && maxEventsPerMessage.Value == null)
                throw new ArgumentNullException(nameof(maxEventsPerMessage), "Property is not nullable for class PrismaticFlowConfigResponse.");

            if (maxRetries.IsSet && maxRetries.Value == null)
                throw new ArgumentNullException(nameof(maxRetries), "Property is not nullable for class PrismaticFlowConfigResponse.");

            return new PrismaticFlowConfigResponse(workerCount, maxEventsPerMessage, maxRetries);
        }

        /// <summary>
        /// Serializes a <see cref="PrismaticFlowConfigResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="prismaticFlowConfigResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PrismaticFlowConfigResponse prismaticFlowConfigResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, prismaticFlowConfigResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PrismaticFlowConfigResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="prismaticFlowConfigResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PrismaticFlowConfigResponse prismaticFlowConfigResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            if (prismaticFlowConfigResponse.WorkerCountOption.IsSet)
                writer.WriteNumber("WorkerCount", prismaticFlowConfigResponse.WorkerCountOption.Value.Value);

            if (prismaticFlowConfigResponse.MaxEventsPerMessageOption.IsSet)
                writer.WriteNumber("MaxEventsPerMessage", prismaticFlowConfigResponse.MaxEventsPerMessageOption.Value.Value);

            if (prismaticFlowConfigResponse.MaxRetriesOption.IsSet)
                writer.WriteNumber("MaxRetries", prismaticFlowConfigResponse.MaxRetriesOption.Value.Value);
        }
    }
}
