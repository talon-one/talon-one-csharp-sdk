...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class ReferralJsonConverter : JsonConverter<Referral>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ReferralJsonConverter" /> class.
        /// </summary>
        public ReferralJsonConverter()
        {
            OnCreated();
        }
