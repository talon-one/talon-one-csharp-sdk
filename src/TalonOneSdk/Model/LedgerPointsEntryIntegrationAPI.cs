...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class LedgerPointsEntryIntegrationAPIJsonConverter : JsonConverter<LedgerPointsEntryIntegrationAPI>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="LedgerPointsEntryIntegrationAPIJsonConverter" /> class.
        /// </summary>
        public LedgerPointsEntryIntegrationAPIJsonConverter()
        {
            OnCreated();
        }
