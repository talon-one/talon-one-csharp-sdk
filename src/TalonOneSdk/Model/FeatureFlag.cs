...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class FeatureFlagJsonConverter : JsonConverter<FeatureFlag>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="FeatureFlagJsonConverter" /> class.
        /// </summary>
        public FeatureFlagJsonConverter()
        {
            OnCreated();
        }
