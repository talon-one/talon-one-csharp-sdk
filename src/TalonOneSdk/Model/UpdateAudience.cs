...
namespace TalonOneSdk.Model
{
    ...
    /// UpdateAudience
    /// </summary>
    public partial class UpdateAudience : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="UpdateAudience" />
    /// </summary>
    public partial class UpdateAudienceJsonConverter : JsonConverter<UpdateAudience>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAudienceJsonConverter" /> class.
        /// </summary>
        public UpdateAudienceJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="UpdateAudience" />
        /// </summary>
        ...
        public override UpdateAudience Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class UpdateAudience.", nameof(name));
        ...
        /// <summary>
        /// Serializes a <see cref="UpdateAudience" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateAudience"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateAudience updateAudience, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, updateAudience, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateAudience" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateAudience"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UpdateAudience updateAudience, JsonSerializerOptions jsonSerializerOptions)
        {
            if (updateAudience.Name == null)
