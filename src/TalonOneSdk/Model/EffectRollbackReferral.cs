...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectRollbackReferral : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRollbackReferral" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;rollbackReferral&#x60;.</param>
        /// <param name="props">The properties of the &#x60;rollbackReferral&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;rollbackReferral&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum RollbackReferral for value: rollbackReferral
            /// </summary>
            RollbackReferral = 1
        }
        ...
        {
            if (value.Equals("rollbackReferral"))
                return EffectTypeEnum.RollbackReferral;
        ...
        {
            if (value == EffectTypeEnum.RollbackReferral)
                return "rollbackReferral";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;rollbackReferral&#x60; effect.</value>
        [JsonPropertyName("props")]
        public RollbackReferralEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectRollbackReferral" />
    /// </summary>
    public partial class EffectRollbackReferralJsonConverter : JsonConverter<EffectRollbackReferral>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRollbackReferralJsonConverter" /> class.
        /// </summary>
        public EffectRollbackReferralJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectRollbackReferral" />
        /// </summary>
        ...
        public override EffectRollbackReferral Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectRollbackReferral.EffectTypeEnum?> effectType = default;
            Option<RollbackReferralEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectRollbackReferral.EffectTypeEnum? effectTypeValue = EffectRollbackReferral.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectRollbackReferral.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<RollbackReferralEffectProps>(JsonSerializer.Deserialize<RollbackReferralEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackReferral.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackReferral.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackReferral.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackReferral.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackReferral.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackReferral.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectRollbackReferral.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectRollbackReferral.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectRollbackReferral.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectRollbackReferral.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectRollbackReferral.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectRollbackReferral.");

            return new EffectRollbackReferral(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectRollbackReferral" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRollbackReferral"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectRollbackReferral effectRollbackReferral, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectRollbackReferral, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectRollbackReferral" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRollbackReferral"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectRollbackReferral effectRollbackReferral, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectRollbackReferral.RuleName == null)
                throw new ArgumentNullException(nameof(effectRollbackReferral.RuleName), "Property is required for class EffectRollbackReferral.");

            if (effectRollbackReferral.Props == null)
                throw new ArgumentNullException(nameof(effectRollbackReferral.Props), "Property is required for class EffectRollbackReferral.");

            writer.WriteNumber("campaignId", effectRollbackReferral.CampaignId);

            writer.WriteNumber("rulesetId", effectRollbackReferral.RulesetId);

            writer.WriteNumber("ruleIndex", effectRollbackReferral.RuleIndex);

            writer.WriteString("ruleName", effectRollbackReferral.RuleName);

            var effectTypeRawValue = EffectRollbackReferral.EffectTypeEnumToJsonValue(effectRollbackReferral.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectRollbackReferral.Props, jsonSerializerOptions);
            if (effectRollbackReferral.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectRollbackReferral.ExperimentIdOption.Value.Value);

            if (effectRollbackReferral.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectRollbackReferral.TriggeredByCouponOption.Value.Value);

            if (effectRollbackReferral.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectRollbackReferral.TriggeredForCatalogItemOption.Value.Value);

            if (effectRollbackReferral.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectRollbackReferral.ConditionIndexOption.Value.Value);

            if (effectRollbackReferral.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectRollbackReferral.EvaluationGroupIDOption.Value.Value);

            if (effectRollbackReferral.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectRollbackReferral.EvaluationGroupMode);

            if (effectRollbackReferral.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectRollbackReferral.CampaignRevisionIdOption.Value.Value);

            if (effectRollbackReferral.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectRollbackReferral.CampaignRevisionVersionIdOption.Value.Value);

            if (effectRollbackReferral.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectRollbackReferral.SelectedPriceType);

            if (effectRollbackReferral.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectRollbackReferral.SelectedPriceOption.Value.Value);

            if (effectRollbackReferral.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectRollbackReferral.AdjustmentReferenceIdOption.Value.Value);

            if (effectRollbackReferral.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectRollbackReferral.RewardIdOption.Value.Value);
        }
    }
}
