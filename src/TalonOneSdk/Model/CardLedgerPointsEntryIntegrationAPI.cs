...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CardLedgerPointsEntryIntegrationAPI : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="created">Date and time the loyalty card points were added.</param>
        ...
        [JsonConstructor]
        public CardLedgerPointsEntryIntegrationAPI(long id, string transactionUUID, DateTime created, long programId, string name, string startDate, string expiryDate, string subledgerId, decimal amount, Option<string> customerProfileID = default, Option<string> customerSessionId = default, Option<string> validityDuration = default)
        {
            Id = id;
    ...
    public class CardLedgerPointsEntryIntegrationAPIJsonConverter : JsonConverter<CardLedgerPointsEntryIntegrationAPI>
    {
        ...
        public override CardLedgerPointsEntryIntegrationAPI Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!id.IsSet)
                throw new ArgumentException("Property is required for class CardLedgerPointsEntryIntegrationAPI.", nameof(id));

            if (!transactionUUID.IsSet)
                throw new ArgumentException("Property is required for class CardLedgerPointsEntryIntegrationAPI.", nameof(transactionUUID));

            if (!created.IsSet)
                throw new ArgumentException("Property is required for class CardLedgerPointsEntryIntegrationAPI.", nameof(created));

            if (!programId.IsSet)
                throw new ArgumentException("Property is required for class CardLedgerPointsEntryIntegrationAPI.", nameof(programId));

            if (!name.IsSet)
                throw new ArgumentException("Property is required for class CardLedgerPointsEntryIntegrationAPI.", nameof(name));

            if (!startDate.IsSet)
                throw new ArgumentException("Property is required for class CardLedgerPointsEntryIntegrationAPI.", nameof(startDate));

            if (!expiryDate.IsSet)
                throw new ArgumentException("Property is required for class CardLedgerPointsEntryIntegrationAPI.", nameof(expiryDate));

            if (!subledgerId.IsSet)
                throw new ArgumentException("Property is required for class CardLedgerPointsEntryIntegrationAPI.", nameof(subledgerId));
        ...
        /// <summary>
        /// Serializes a <see cref="CardLedgerPointsEntryIntegrationAPI" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="cardLedgerPointsEntryIntegrationAPI"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CardLedgerPointsEntryIntegrationAPI cardLedgerPointsEntryIntegrationAPI, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, cardLedgerPointsEntryIntegrationAPI, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CardLedgerPointsEntryIntegrationAPI" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="cardLedgerPointsEntryIntegrationAPI"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CardLedgerPointsEntryIntegrationAPI cardLedgerPointsEntryIntegrationAPI, JsonSerializerOptions jsonSerializerOptions)
        {
            if (cardLedgerPointsEntryIntegrationAPI.TransactionUUID == null)
                throw new ArgumentNullException(nameof(cardLedgerPointsEntryIntegrationAPI.TransactionUUID), "Property is required for class CardLedgerPointsEntryIntegrationAPI.");

            if (cardLedgerPointsEntryIntegrationAPI.Name == null)
                throw new ArgumentNullException(nameof(cardLedgerPointsEntryIntegrationAPI.Name), "Property is required for class CardLedgerPointsEntryIntegrationAPI.");

            if (cardLedgerPointsEntryIntegrationAPI.StartDate == null)
                throw new ArgumentNullException(nameof(cardLedgerPointsEntryIntegrationAPI.StartDate), "Property is required for class CardLedgerPointsEntryIntegrationAPI.");

            if (cardLedgerPointsEntryIntegrationAPI.ExpiryDate == null)
                throw new ArgumentNullException(nameof(cardLedgerPointsEntryIntegrationAPI.ExpiryDate), "Property is required for class CardLedgerPointsEntryIntegrationAPI.");

            if (cardLedgerPointsEntryIntegrationAPI.SubledgerId == null)
                throw new ArgumentNullException(nameof(cardLedgerPointsEntryIntegrationAPI.SubledgerId), "Property is required for class CardLedgerPointsEntryIntegrationAPI.");

            if (cardLedgerPointsEntryIntegrationAPI.CustomerProfileIDOption.IsSet && cardLedgerPointsEntryIntegrationAPI.CustomerProfileID == null)
                throw new ArgumentNullException(nameof(cardLedgerPointsEntryIntegrationAPI.CustomerProfileID), "Property is required for class CardLedgerPointsEntryIntegrationAPI.");

            if (cardLedgerPointsEntryIntegrationAPI.CustomerSessionIdOption.IsSet && cardLedgerPointsEntryIntegrationAPI.CustomerSessionId == null)
                throw new ArgumentNullException(nameof(cardLedgerPointsEntryIntegrationAPI.CustomerSessionId), "Property is required for class CardLedgerPointsEntryIntegrationAPI.");

            if (cardLedgerPointsEntryIntegrationAPI.ValidityDurationOption.IsSet && cardLedgerPointsEntryIntegrationAPI.ValidityDuration == null)
                throw new ArgumentNullException(nameof(cardLedgerPointsEntryIntegrationAPI.ValidityDuration), "Property is required for class CardLedgerPointsEntryIntegrationAPI.");

            writer.WriteNumber("id", cardLedgerPointsEntryIntegrationAPI.Id);

            writer.WriteString("transactionUUID", cardLedgerPointsEntryIntegrationAPI.TransactionUUID);

            writer.WriteString("created", cardLedgerPointsEntryIntegrationAPI.Created.ToString(CreatedFormat));

            writer.WriteNumber("programId", cardLedgerPointsEntryIntegrationAPI.ProgramId);

            writer.WriteString("name", cardLedgerPointsEntryIntegrationAPI.Name);

            writer.WriteString("startDate", cardLedgerPointsEntryIntegrationAPI.StartDate);

            writer.WriteString("expiryDate", cardLedgerPointsEntryIntegrationAPI.ExpiryDate);

            writer.WriteString("subledgerId", cardLedgerPointsEntryIntegrationAPI.SubledgerId);

            writer.WriteNumber("amount", cardLedgerPointsEntryIntegrationAPI.Amount);

            if (cardLedgerPointsEntryIntegrationAPI.CustomerProfileIDOption.IsSet)
                writer.WriteString("customerProfileID", cardLedgerPointsEntryIntegrationAPI.CustomerProfileID);

            if (cardLedgerPointsEntryIntegrationAPI.CustomerSessionIdOption.IsSet)
                writer.WriteString("customerSessionId", cardLedgerPointsEntryIntegrationAPI.CustomerSessionId);

            if (cardLedgerPointsEntryIntegrationAPI.ValidityDurationOption.IsSet)
                writer.WriteString("validityDuration", cardLedgerPointsEntryIntegrationAPI.ValidityDuration);
        }
    }
}
