...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CustomerActivityReportJsonConverter : JsonConverter<CustomerActivityReport>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerActivityReportJsonConverter" /> class.
        /// </summary>
        public CustomerActivityReportJsonConverter()
        {
            OnCreated();
        }
