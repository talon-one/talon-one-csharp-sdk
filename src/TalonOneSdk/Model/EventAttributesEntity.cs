...
namespace TalonOneSdk.Model
{
    ...
    public class EventAttributesEntityJsonConverter : JsonConverter<EventAttributesEntity>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, EventAttributesEntity eventAttributesEntity, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (eventAttributesEntity.AttributesOption.IsSet && eventAttributesEntity.Attributes == null)
                throw new ArgumentNullException(nameof(eventAttributesEntity.Attributes), "Property is required for class EventAttributesEntity.");
