...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class LoyaltyLedgerJsonConverter : JsonConverter<LoyaltyLedger>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyLedgerJsonConverter" /> class.
        /// </summary>
        public LoyaltyLedgerJsonConverter()
        {
            OnCreated();
        }
