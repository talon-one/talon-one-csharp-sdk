...
namespace TalonOneSdk.Model
{
    ...
    public class IntegrationEventV2ResponseJsonConverter : JsonConverter<IntegrationEventV2Response>
    {
        ...
        public override IntegrationEventV2Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new IntegrationEventV2Response(effects.Value, createdCoupons.Value, createdReferrals.Value, customerProfile, loyalty, triggeredCampaigns, campaignEligibility, ruleFailureReasons, awardedGiveaways, varEvent);
        }
