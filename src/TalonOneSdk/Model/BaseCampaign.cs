...
namespace TalonOneSdk.Model
{
    ...
    /// BaseCampaign
    /// </summary>
    public partial class BaseCampaign : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public BaseCampaign(string name, List<string> tags, List<BaseCampaign.FeaturesEnum> features, List<LimitConfig> limits, Option<string> description = default, Option<DateTime?> startTime = default, Option<DateTime?> endTime = default, Option<Object> attributes = default, StateEnum state = StateEnum.Enabled, Option<long?> activeRulesetId = default, Option<bool?> reevaluateOnReturn = default, Option<CodeGeneratorSettings> couponSettings = default, Option<CodeGeneratorSettings> referralSettings = default, Option<List<long>> campaignGroups = default, Option<TypeEnum?> type = default, Option<List<long>> linkedStoreIds = default)
        {
            Name = name;
            Tags = tags;
            Features = features;
        ...
        public List<BaseCampaign.FeaturesEnum> Features { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="BaseCampaign" />
    /// </summary>
    public class BaseCampaignJsonConverter : JsonConverter<BaseCampaign>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="BaseCampaign" />
        /// </summary>
        ...
        public override BaseCampaign Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<BaseCampaign.FeaturesEnum>> features = default;
            ...
            Option<BaseCampaign.StateEnum?> state = default;
            ...
            Option<BaseCampaign.TypeEnum?> type = default;
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class BaseCampaign.", nameof(name));

            if (!tags.IsSet)
                throw new ArgumentException("Property is required for class BaseCampaign.", nameof(tags));

            if (!features.IsSet)
                throw new ArgumentException("Property is required for class BaseCampaign.", nameof(features));

            if (!limits.IsSet)
                throw new ArgumentException("Property is required for class BaseCampaign.", nameof(limits));
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class BaseCampaign.");
            ...
            if (attributes.IsSet && attributes.Value == null)
                throw new ArgumentNullException(nameof(attributes), "Property is not nullable for class BaseCampaign.");
            ...
            if (couponSettings.IsSet && couponSettings.Value == null)
                throw new ArgumentNullException(nameof(couponSettings), "Property is not nullable for class BaseCampaign.");

            if (referralSettings.IsSet && referralSettings.Value == null)
                throw new ArgumentNullException(nameof(referralSettings), "Property is not nullable for class BaseCampaign.");

            if (campaignGroups.IsSet && campaignGroups.Value == null)
                throw new ArgumentNullException(nameof(campaignGroups), "Property is not nullable for class BaseCampaign.");
            ...
            if (linkedStoreIds.IsSet && linkedStoreIds.Value == null)
                throw new ArgumentNullException(nameof(linkedStoreIds), "Property is not nullable for class BaseCampaign.");

            return new BaseCampaign(name.Value, tags.Value, features.Value, limits.Value, description, startTime, endTime, attributes, state.Value.Value, activeRulesetId, reevaluateOnReturn, couponSettings, referralSettings, campaignGroups, type, linkedStoreIds);
        }

        /// <summary>
        /// Serializes a <see cref="BaseCampaign" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="baseCampaign"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BaseCampaign baseCampaign, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, baseCampaign, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BaseCampaign" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="baseCampaign"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BaseCampaign baseCampaign, JsonSerializerOptions jsonSerializerOptions)
        {
            if (baseCampaign.Name == null)
                throw new ArgumentNullException(nameof(baseCampaign.Name), "Property is required for class BaseCampaign.");

            if (baseCampaign.Tags == null)
                throw new ArgumentNullException(nameof(baseCampaign.Tags), "Property is required for class BaseCampaign.");

            if (baseCampaign.Features == null)
                throw new ArgumentNullException(nameof(baseCampaign.Features), "Property is required for class BaseCampaign.");
            ...
            if (baseCampaign.DescriptionOption.IsSet)
                writer.WriteString("description", baseCampaign.Description);

            if (baseCampaign.StartTimeOption.IsSet)
                writer.WriteString("startTime", baseCampaign.StartTimeOption.Value.Value.ToString(StartTimeFormat));

            if (baseCampaign.EndTimeOption.IsSet)
                writer.WriteString("endTime", baseCampaign.EndTimeOption.Value.Value.ToString(EndTimeFormat));

            if (baseCampaign.AttributesOption.IsSet)
            {
                writer.WritePropertyName("attributes");
                JsonSerializer.Serialize(writer, baseCampaign.Attributes, jsonSerializerOptions);
            }
            var stateRawValue = BaseCampaign.StateEnumToJsonValue(baseCampaign.State);
            writer.WriteString("state", stateRawValue);
            if (baseCampaign.ActiveRulesetIdOption.IsSet)
                writer.WriteNumber("activeRulesetId", baseCampaign.ActiveRulesetIdOption.Value.Value);

            if (baseCampaign.ReevaluateOnReturnOption.IsSet)
                writer.WriteBoolean("reevaluateOnReturn", baseCampaign.ReevaluateOnReturnOption.Value.Value);

            if (baseCampaign.CouponSettingsOption.IsSet)
            {
                writer.WritePropertyName("couponSettings");
                JsonSerializer.Serialize(writer, baseCampaign.CouponSettings, jsonSerializerOptions);
            }
            if (baseCampaign.ReferralSettingsOption.IsSet)
            {
                writer.WritePropertyName("referralSettings");
                JsonSerializer.Serialize(writer, baseCampaign.ReferralSettings, jsonSerializerOptions);
            }
            if (baseCampaign.CampaignGroupsOption.IsSet)
            {
            ...
            if (baseCampaign.LinkedStoreIdsOption.IsSet)
            {
                ...
                JsonSerializer.Serialize(writer, baseCampaign.LinkedStoreIds, jsonSerializerOptions);
            }
        }
    }
}
