...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class BaseCampaignJsonConverter : JsonConverter<BaseCampaign>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="BaseCampaignJsonConverter" /> class.
        /// </summary>
        public BaseCampaignJsonConverter()
        {
            OnCreated();
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, BaseCampaign baseCampaign, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (baseCampaign.CouponAttributesOption.IsSet)
            {
                writer.WritePropertyName("couponAttributes");
                JsonSerializer.Serialize(writer, baseCampaign.CouponAttributes, jsonSerializerOptions);
            }
        }
    }
}
