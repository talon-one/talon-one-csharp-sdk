...
namespace TalonOneSdk.Model
{
    ...
    public partial class UpdateCampaignTemplate : IValidatableObject
    {
        ...
        public List<UpdateCampaignTemplate.FeaturesEnum> Features { get { return this.FeaturesOption.Value; } set { this.FeaturesOption = new Option<List<UpdateCampaignTemplate.FeaturesEnum>>(value); } }
    ...
    /// </summary>
    public partial class UpdateCampaignTemplateJsonConverter : JsonConverter<UpdateCampaignTemplate>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCampaignTemplateJsonConverter" /> class.
        /// </summary>
        public UpdateCampaignTemplateJsonConverter()
        {
            OnCreated();
        }
