    ...
    public class UpdateCampaignTemplateJsonConverter : JsonConverter<UpdateCampaignTemplate>
    {
        ...
        public override UpdateCampaignTemplate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (reevaluateOnReturn.IsSet && reevaluateOnReturn.Value == null)
                throw new ArgumentNullException(nameof(reevaluateOnReturn), "Property is not nullable for class UpdateCampaignTemplate.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, UpdateCampaignTemplate updateCampaignTemplate, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (updateCampaignTemplate.ReevaluateOnReturnOption.IsSet)
                writer.WriteBoolean("reevaluateOnReturn", updateCampaignTemplate.ReevaluateOnReturnOption.Value.Value);
