...
namespace TalonOneSdk.Model
{
    ...
    /// UpdateAchievement
    /// </summary>
    public partial class UpdateAchievement : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public UpdateAchievement(Option<string> name = default, Option<string> title = default, Option<string> description = default, Option<decimal?> target = default, Option<string> period = default, Option<TimePoint> periodEndOverride = default, Option<RecurrencePolicyEnum?> recurrencePolicy = default, Option<ActivationPolicyEnum?> activationPolicy = default, Option<DateTime?> fixedStartDate = default, Option<DateTime?> endDate = default, Option<bool?> allowRollbackAfterCompletion = default)
        {
            NameOption = name;
            TitleOption = title;
    ...
    /// <summary>
    /// A Json converter for type <see cref="UpdateAchievement" />
    /// </summary>
    public partial class UpdateAchievementJsonConverter : JsonConverter<UpdateAchievement>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAchievementJsonConverter" /> class.
        /// </summary>
        public UpdateAchievementJsonConverter()
        {
            OnCreated();
        }
        ...
        /// <summary>
        /// Deserializes json to <see cref="UpdateAchievement" />
        /// </summary>
        ...
        public override UpdateAchievement Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<UpdateAchievement.RecurrencePolicyEnum?> recurrencePolicy = default;
            Option<UpdateAchievement.ActivationPolicyEnum?> activationPolicy = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "recurrencePolicy":
                            ...
                            {
                                UpdateAchievement.RecurrencePolicyEnum? recurrencePolicyValue = UpdateAchievement.RecurrencePolicyEnumFromStringOrDefault(recurrencePolicyRawValue);
                                if (recurrencePolicyValue == null)
                                    throw new JsonException();
                                recurrencePolicy = new Option<UpdateAchievement.RecurrencePolicyEnum?>(recurrencePolicyValue);
                            }
                            break;
                        case "activationPolicy":
                            ...
                            {
                                UpdateAchievement.ActivationPolicyEnum? activationPolicyValue = UpdateAchievement.ActivationPolicyEnumFromStringOrDefault(activationPolicyRawValue);
                                if (activationPolicyValue == null)
                                    throw new JsonException();
                                activationPolicy = new Option<UpdateAchievement.ActivationPolicyEnum?>(activationPolicyValue);
                            }
                            break;
                        case "fixedStartDate":
        ...
        /// <summary>
        /// Serializes a <see cref="UpdateAchievement" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateAchievement"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateAchievement updateAchievement, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, updateAchievement, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateAchievement" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateAchievement"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, UpdateAchievement updateAchievement, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (updateAchievement.TitleOption.IsSet)
                writer.WriteString("title", updateAchievement.Title);

            if (updateAchievement.DescriptionOption.IsSet)
                writer.WriteString("description", updateAchievement.Description);

            if (updateAchievement.TargetOption.IsSet)
                writer.WriteNumber("target", updateAchievement.TargetOption.Value.Value);

            if (updateAchievement.PeriodOption.IsSet)
                writer.WriteString("period", updateAchievement.Period);

            if (updateAchievement.PeriodEndOverrideOption.IsSet)
            {
            ...
            if (updateAchievement.EndDateOption.IsSet)
                writer.WriteString("endDate", updateAchievement.EndDateOption.Value.Value.ToString(EndDateFormat));

            if (updateAchievement.AllowRollbackAfterCompletionOption.IsSet)
                writer.WriteBoolean("allowRollbackAfterCompletion", updateAchievement.AllowRollbackAfterCompletionOption.Value.Value);
        }
    }
}
