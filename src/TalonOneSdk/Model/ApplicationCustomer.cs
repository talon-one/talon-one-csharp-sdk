...
namespace TalonOneSdk.Model
{
    ...
    public partial class ApplicationCustomer : IValidatableObject
    {
        ...
        public string AdvocateIntegrationId { get { return this.AdvocateIntegrationIdOption.Value; } set { this.AdvocateIntegrationIdOption = new Option<string>(value); } }
    ...
    /// </summary>
    public partial class ApplicationCustomerJsonConverter : JsonConverter<ApplicationCustomer>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationCustomerJsonConverter" /> class.
        /// </summary>
        public ApplicationCustomerJsonConverter()
        {
            OnCreated();
        }
