...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectRollbackDeductedLoyaltyPoints : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRollbackDeductedLoyaltyPoints" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;rollbackDeductedLoyaltyPoints&#x60;.</param>
        /// <param name="props">The properties of the &#x60;rollbackDeductedLoyaltyPoints&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;rollbackDeductedLoyaltyPoints&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum RollbackDeductedLoyaltyPoints for value: rollbackDeductedLoyaltyPoints
            /// </summary>
            RollbackDeductedLoyaltyPoints = 1
        }
        ...
        {
            if (value.Equals("rollbackDeductedLoyaltyPoints"))
                return EffectTypeEnum.RollbackDeductedLoyaltyPoints;
        ...
        {
            if (value == EffectTypeEnum.RollbackDeductedLoyaltyPoints)
                return "rollbackDeductedLoyaltyPoints";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;rollbackDeductedLoyaltyPoints&#x60; effect.</value>
        [JsonPropertyName("props")]
        public RollbackDeductedLoyaltyPointsEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectRollbackDeductedLoyaltyPoints" />
    /// </summary>
    public partial class EffectRollbackDeductedLoyaltyPointsJsonConverter : JsonConverter<EffectRollbackDeductedLoyaltyPoints>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectRollbackDeductedLoyaltyPointsJsonConverter" /> class.
        /// </summary>
        public EffectRollbackDeductedLoyaltyPointsJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectRollbackDeductedLoyaltyPoints" />
        /// </summary>
        ...
        public override EffectRollbackDeductedLoyaltyPoints Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectRollbackDeductedLoyaltyPoints.EffectTypeEnum?> effectType = default;
            Option<RollbackDeductedLoyaltyPointsEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectRollbackDeductedLoyaltyPoints.EffectTypeEnum? effectTypeValue = EffectRollbackDeductedLoyaltyPoints.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectRollbackDeductedLoyaltyPoints.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<RollbackDeductedLoyaltyPointsEffectProps>(JsonSerializer.Deserialize<RollbackDeductedLoyaltyPointsEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackDeductedLoyaltyPoints.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackDeductedLoyaltyPoints.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackDeductedLoyaltyPoints.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackDeductedLoyaltyPoints.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackDeductedLoyaltyPoints.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectRollbackDeductedLoyaltyPoints.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectRollbackDeductedLoyaltyPoints.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectRollbackDeductedLoyaltyPoints.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectRollbackDeductedLoyaltyPoints.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectRollbackDeductedLoyaltyPoints.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectRollbackDeductedLoyaltyPoints.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectRollbackDeductedLoyaltyPoints.");

            return new EffectRollbackDeductedLoyaltyPoints(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectRollbackDeductedLoyaltyPoints" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRollbackDeductedLoyaltyPoints"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectRollbackDeductedLoyaltyPoints effectRollbackDeductedLoyaltyPoints, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectRollbackDeductedLoyaltyPoints, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectRollbackDeductedLoyaltyPoints" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectRollbackDeductedLoyaltyPoints"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectRollbackDeductedLoyaltyPoints effectRollbackDeductedLoyaltyPoints, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectRollbackDeductedLoyaltyPoints.RuleName == null)
                throw new ArgumentNullException(nameof(effectRollbackDeductedLoyaltyPoints.RuleName), "Property is required for class EffectRollbackDeductedLoyaltyPoints.");

            if (effectRollbackDeductedLoyaltyPoints.Props == null)
                throw new ArgumentNullException(nameof(effectRollbackDeductedLoyaltyPoints.Props), "Property is required for class EffectRollbackDeductedLoyaltyPoints.");

            writer.WriteNumber("campaignId", effectRollbackDeductedLoyaltyPoints.CampaignId);

            writer.WriteNumber("rulesetId", effectRollbackDeductedLoyaltyPoints.RulesetId);

            writer.WriteNumber("ruleIndex", effectRollbackDeductedLoyaltyPoints.RuleIndex);

            writer.WriteString("ruleName", effectRollbackDeductedLoyaltyPoints.RuleName);

            var effectTypeRawValue = EffectRollbackDeductedLoyaltyPoints.EffectTypeEnumToJsonValue(effectRollbackDeductedLoyaltyPoints.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectRollbackDeductedLoyaltyPoints.Props, jsonSerializerOptions);
            if (effectRollbackDeductedLoyaltyPoints.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectRollbackDeductedLoyaltyPoints.ExperimentIdOption.Value.Value);

            if (effectRollbackDeductedLoyaltyPoints.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectRollbackDeductedLoyaltyPoints.TriggeredByCouponOption.Value.Value);

            if (effectRollbackDeductedLoyaltyPoints.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectRollbackDeductedLoyaltyPoints.TriggeredForCatalogItemOption.Value.Value);

            if (effectRollbackDeductedLoyaltyPoints.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectRollbackDeductedLoyaltyPoints.ConditionIndexOption.Value.Value);

            if (effectRollbackDeductedLoyaltyPoints.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectRollbackDeductedLoyaltyPoints.EvaluationGroupIDOption.Value.Value);

            if (effectRollbackDeductedLoyaltyPoints.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectRollbackDeductedLoyaltyPoints.EvaluationGroupMode);

            if (effectRollbackDeductedLoyaltyPoints.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectRollbackDeductedLoyaltyPoints.CampaignRevisionIdOption.Value.Value);

            if (effectRollbackDeductedLoyaltyPoints.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectRollbackDeductedLoyaltyPoints.CampaignRevisionVersionIdOption.Value.Value);

            if (effectRollbackDeductedLoyaltyPoints.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectRollbackDeductedLoyaltyPoints.SelectedPriceType);

            if (effectRollbackDeductedLoyaltyPoints.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectRollbackDeductedLoyaltyPoints.SelectedPriceOption.Value.Value);

            if (effectRollbackDeductedLoyaltyPoints.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectRollbackDeductedLoyaltyPoints.AdjustmentReferenceIdOption.Value.Value);

            if (effectRollbackDeductedLoyaltyPoints.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectRollbackDeductedLoyaltyPoints.RewardIdOption.Value.Value);
        }
    }
}
