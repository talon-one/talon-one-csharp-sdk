...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectSetDiscountPerAdditionalCostPerItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectSetDiscountPerAdditionalCostPerItem" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;setDiscountPerAdditionalCostPerItem&#x60;.</param>
        /// <param name="props">The properties of the &#x60;setDiscountPerAdditionalCostPerItem&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;setDiscountPerAdditionalCostPerItem&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum SetDiscountPerAdditionalCostPerItem for value: setDiscountPerAdditionalCostPerItem
            /// </summary>
            SetDiscountPerAdditionalCostPerItem = 1
        }
        ...
        {
            if (value.Equals("setDiscountPerAdditionalCostPerItem"))
                return EffectTypeEnum.SetDiscountPerAdditionalCostPerItem;
        ...
        {
            if (value == EffectTypeEnum.SetDiscountPerAdditionalCostPerItem)
                return "setDiscountPerAdditionalCostPerItem";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;setDiscountPerAdditionalCostPerItem&#x60; effect.</value>
        [JsonPropertyName("props")]
        public SetDiscountPerAdditionalCostPerItemEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectSetDiscountPerAdditionalCostPerItem" />
    /// </summary>
    public partial class EffectSetDiscountPerAdditionalCostPerItemJsonConverter : JsonConverter<EffectSetDiscountPerAdditionalCostPerItem>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectSetDiscountPerAdditionalCostPerItemJsonConverter" /> class.
        /// </summary>
        public EffectSetDiscountPerAdditionalCostPerItemJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectSetDiscountPerAdditionalCostPerItem" />
        /// </summary>
        ...
        public override EffectSetDiscountPerAdditionalCostPerItem Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectSetDiscountPerAdditionalCostPerItem.EffectTypeEnum?> effectType = default;
            Option<SetDiscountPerAdditionalCostPerItemEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectSetDiscountPerAdditionalCostPerItem.EffectTypeEnum? effectTypeValue = EffectSetDiscountPerAdditionalCostPerItem.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectSetDiscountPerAdditionalCostPerItem.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<SetDiscountPerAdditionalCostPerItemEffectProps>(JsonSerializer.Deserialize<SetDiscountPerAdditionalCostPerItemEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerAdditionalCostPerItem.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerAdditionalCostPerItem.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerAdditionalCostPerItem.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerAdditionalCostPerItem.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerAdditionalCostPerItem.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectSetDiscountPerAdditionalCostPerItem.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectSetDiscountPerAdditionalCostPerItem.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectSetDiscountPerAdditionalCostPerItem.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectSetDiscountPerAdditionalCostPerItem.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectSetDiscountPerAdditionalCostPerItem.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectSetDiscountPerAdditionalCostPerItem.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectSetDiscountPerAdditionalCostPerItem.");

            return new EffectSetDiscountPerAdditionalCostPerItem(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectSetDiscountPerAdditionalCostPerItem" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectSetDiscountPerAdditionalCostPerItem"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectSetDiscountPerAdditionalCostPerItem effectSetDiscountPerAdditionalCostPerItem, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectSetDiscountPerAdditionalCostPerItem, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectSetDiscountPerAdditionalCostPerItem" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectSetDiscountPerAdditionalCostPerItem"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectSetDiscountPerAdditionalCostPerItem effectSetDiscountPerAdditionalCostPerItem, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectSetDiscountPerAdditionalCostPerItem.RuleName == null)
                throw new ArgumentNullException(nameof(effectSetDiscountPerAdditionalCostPerItem.RuleName), "Property is required for class EffectSetDiscountPerAdditionalCostPerItem.");

            if (effectSetDiscountPerAdditionalCostPerItem.Props == null)
                throw new ArgumentNullException(nameof(effectSetDiscountPerAdditionalCostPerItem.Props), "Property is required for class EffectSetDiscountPerAdditionalCostPerItem.");

            writer.WriteNumber("campaignId", effectSetDiscountPerAdditionalCostPerItem.CampaignId);

            writer.WriteNumber("rulesetId", effectSetDiscountPerAdditionalCostPerItem.RulesetId);

            writer.WriteNumber("ruleIndex", effectSetDiscountPerAdditionalCostPerItem.RuleIndex);

            writer.WriteString("ruleName", effectSetDiscountPerAdditionalCostPerItem.RuleName);

            var effectTypeRawValue = EffectSetDiscountPerAdditionalCostPerItem.EffectTypeEnumToJsonValue(effectSetDiscountPerAdditionalCostPerItem.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectSetDiscountPerAdditionalCostPerItem.Props, jsonSerializerOptions);
            if (effectSetDiscountPerAdditionalCostPerItem.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectSetDiscountPerAdditionalCostPerItem.ExperimentIdOption.Value.Value);

            if (effectSetDiscountPerAdditionalCostPerItem.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectSetDiscountPerAdditionalCostPerItem.TriggeredByCouponOption.Value.Value);

            if (effectSetDiscountPerAdditionalCostPerItem.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectSetDiscountPerAdditionalCostPerItem.TriggeredForCatalogItemOption.Value.Value);

            if (effectSetDiscountPerAdditionalCostPerItem.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectSetDiscountPerAdditionalCostPerItem.ConditionIndexOption.Value.Value);

            if (effectSetDiscountPerAdditionalCostPerItem.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectSetDiscountPerAdditionalCostPerItem.EvaluationGroupIDOption.Value.Value);

            if (effectSetDiscountPerAdditionalCostPerItem.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectSetDiscountPerAdditionalCostPerItem.EvaluationGroupMode);

            if (effectSetDiscountPerAdditionalCostPerItem.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectSetDiscountPerAdditionalCostPerItem.CampaignRevisionIdOption.Value.Value);

            if (effectSetDiscountPerAdditionalCostPerItem.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectSetDiscountPerAdditionalCostPerItem.CampaignRevisionVersionIdOption.Value.Value);

            if (effectSetDiscountPerAdditionalCostPerItem.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectSetDiscountPerAdditionalCostPerItem.SelectedPriceType);

            if (effectSetDiscountPerAdditionalCostPerItem.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectSetDiscountPerAdditionalCostPerItem.SelectedPriceOption.Value.Value);

            if (effectSetDiscountPerAdditionalCostPerItem.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectSetDiscountPerAdditionalCostPerItem.AdjustmentReferenceIdOption.Value.Value);

            if (effectSetDiscountPerAdditionalCostPerItem.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectSetDiscountPerAdditionalCostPerItem.RewardIdOption.Value.Value);
        }
    }
}
