...
namespace TalonOneSdk.Model
{
    ...
    /// EffectSet
    /// </summary>
    public partial class EffectSet : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectSet" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;set&#x60;.</param>
        /// <param name="props">The properties of the &#x60;set&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;set&#x60;.</value>
        ...
        /// </summary>
        /// <value>The properties of the &#x60;set&#x60; effect.</value>
        [JsonPropertyName("props")]
        public UpdateAttributeEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectSet" />
    /// </summary>
    public partial class EffectSetJsonConverter : JsonConverter<EffectSet>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectSetJsonConverter" /> class.
        /// </summary>
        public EffectSetJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectSet" />
        /// </summary>
        ...
        public override EffectSet Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectSet.EffectTypeEnum?> effectType = default;
            Option<UpdateAttributeEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectSet.EffectTypeEnum? effectTypeValue = EffectSet.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectSet.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<UpdateAttributeEffectProps>(JsonSerializer.Deserialize<UpdateAttributeEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectSet.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectSet.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectSet.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectSet.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectSet.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectSet.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectSet.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectSet.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectSet.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectSet.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectSet.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectSet.");
        ...
        /// <summary>
        /// Serializes a <see cref="EffectSet" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectSet"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectSet effectSet, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectSet, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectSet" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectSet"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectSet effectSet, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectSet.RuleName == null)
                throw new ArgumentNullException(nameof(effectSet.RuleName), "Property is required for class EffectSet.");

            if (effectSet.Props == null)
                throw new ArgumentNullException(nameof(effectSet.Props), "Property is required for class EffectSet.");

            writer.WriteNumber("campaignId", effectSet.CampaignId);

            writer.WriteNumber("rulesetId", effectSet.RulesetId);

            writer.WriteNumber("ruleIndex", effectSet.RuleIndex);

            writer.WriteString("ruleName", effectSet.RuleName);

            var effectTypeRawValue = EffectSet.EffectTypeEnumToJsonValue(effectSet.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectSet.Props, jsonSerializerOptions);
            if (effectSet.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectSet.ExperimentIdOption.Value.Value);

            if (effectSet.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectSet.TriggeredByCouponOption.Value.Value);

            if (effectSet.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectSet.TriggeredForCatalogItemOption.Value.Value);

            if (effectSet.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectSet.ConditionIndexOption.Value.Value);

            if (effectSet.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectSet.EvaluationGroupIDOption.Value.Value);

            if (effectSet.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectSet.EvaluationGroupMode);

            if (effectSet.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectSet.CampaignRevisionIdOption.Value.Value);

            if (effectSet.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectSet.CampaignRevisionVersionIdOption.Value.Value);

            if (effectSet.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectSet.SelectedPriceType);

            if (effectSet.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectSet.SelectedPriceOption.Value.Value);

            if (effectSet.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectSet.AdjustmentReferenceIdOption.Value.Value);

            if (effectSet.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectSet.RewardIdOption.Value.Value);
        }
    }
}
