...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CampaignGroupJsonConverter : JsonConverter<CampaignGroup>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignGroupJsonConverter" /> class.
        /// </summary>
        public CampaignGroupJsonConverter()
        {
            OnCreated();
        }
