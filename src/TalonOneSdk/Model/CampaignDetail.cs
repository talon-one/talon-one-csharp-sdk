...
namespace TalonOneSdk.Model
{
    ...
    public partial class CampaignDetail : IValidatableObject
    {
        ...
        public string CampaignName { get { return this.CampaignNameOption.Value; } set { this.CampaignNameOption = new Option<string>(value); } }
    ...
    /// </summary>
    public partial class CampaignDetailJsonConverter : JsonConverter<CampaignDetail>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignDetailJsonConverter" /> class.
        /// </summary>
        public CampaignDetailJsonConverter()
        {
            OnCreated();
        }
