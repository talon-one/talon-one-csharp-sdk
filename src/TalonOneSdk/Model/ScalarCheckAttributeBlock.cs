...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class ScalarCheckAttributeBlockJsonConverter : JsonConverter<ScalarCheckAttributeBlock>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ScalarCheckAttributeBlockJsonConverter" /> class.
        /// </summary>
        public ScalarCheckAttributeBlockJsonConverter()
        {
            OnCreated();
        }
