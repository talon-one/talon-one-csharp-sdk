...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class UpdateLoyaltyCardJsonConverter : JsonConverter<UpdateLoyaltyCard>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateLoyaltyCardJsonConverter" /> class.
        /// </summary>
        public UpdateLoyaltyCardJsonConverter()
        {
            OnCreated();
        }
