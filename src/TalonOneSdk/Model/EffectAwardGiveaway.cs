...
namespace TalonOneSdk.Model
{
    ...
    /// EffectAwardGiveaway
    /// </summary>
    public partial class EffectAwardGiveaway : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectAwardGiveaway" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;awardGiveaway&#x60;.</param>
        /// <param name="props">The properties of the &#x60;awardGiveaway&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;awardGiveaway&#x60;.</value>
        ...
        public static EffectTypeEnum EffectTypeEnumFromString(string value)
        {
            if (value.Equals("awardGiveaway"))
                return EffectTypeEnum.AwardGiveaway;
        ...
        {
            if (value == EffectTypeEnum.AwardGiveaway)
        ...
        /// </summary>
        /// <value>The properties of the &#x60;awardGiveaway&#x60; effect.</value>
        [JsonPropertyName("props")]
        public AwardGiveawayEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectAwardGiveaway" />
    /// </summary>
    public partial class EffectAwardGiveawayJsonConverter : JsonConverter<EffectAwardGiveaway>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectAwardGiveawayJsonConverter" /> class.
        /// </summary>
        public EffectAwardGiveawayJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectAwardGiveaway" />
        /// </summary>
        ...
        public override EffectAwardGiveaway Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectAwardGiveaway.EffectTypeEnum?> effectType = default;
            Option<AwardGiveawayEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectAwardGiveaway.EffectTypeEnum? effectTypeValue = EffectAwardGiveaway.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectAwardGiveaway.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<AwardGiveawayEffectProps>(JsonSerializer.Deserialize<AwardGiveawayEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectAwardGiveaway.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectAwardGiveaway.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectAwardGiveaway.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectAwardGiveaway.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectAwardGiveaway.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectAwardGiveaway.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectAwardGiveaway.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectAwardGiveaway.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectAwardGiveaway.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectAwardGiveaway.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectAwardGiveaway.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectAwardGiveaway.");

            return new EffectAwardGiveaway(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectAwardGiveaway" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectAwardGiveaway"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectAwardGiveaway effectAwardGiveaway, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectAwardGiveaway, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectAwardGiveaway" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectAwardGiveaway"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectAwardGiveaway effectAwardGiveaway, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectAwardGiveaway.RuleName == null)
                throw new ArgumentNullException(nameof(effectAwardGiveaway.RuleName), "Property is required for class EffectAwardGiveaway.");

            if (effectAwardGiveaway.Props == null)
                throw new ArgumentNullException(nameof(effectAwardGiveaway.Props), "Property is required for class EffectAwardGiveaway.");

            writer.WriteNumber("campaignId", effectAwardGiveaway.CampaignId);

            writer.WriteNumber("rulesetId", effectAwardGiveaway.RulesetId);

            writer.WriteNumber("ruleIndex", effectAwardGiveaway.RuleIndex);

            writer.WriteString("ruleName", effectAwardGiveaway.RuleName);

            var effectTypeRawValue = EffectAwardGiveaway.EffectTypeEnumToJsonValue(effectAwardGiveaway.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectAwardGiveaway.Props, jsonSerializerOptions);
            if (effectAwardGiveaway.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectAwardGiveaway.ExperimentIdOption.Value.Value);

            if (effectAwardGiveaway.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectAwardGiveaway.TriggeredByCouponOption.Value.Value);

            if (effectAwardGiveaway.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectAwardGiveaway.TriggeredForCatalogItemOption.Value.Value);

            if (effectAwardGiveaway.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectAwardGiveaway.ConditionIndexOption.Value.Value);

            if (effectAwardGiveaway.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectAwardGiveaway.EvaluationGroupIDOption.Value.Value);

            if (effectAwardGiveaway.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectAwardGiveaway.EvaluationGroupMode);

            if (effectAwardGiveaway.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectAwardGiveaway.CampaignRevisionIdOption.Value.Value);

            if (effectAwardGiveaway.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectAwardGiveaway.CampaignRevisionVersionIdOption.Value.Value);

            if (effectAwardGiveaway.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectAwardGiveaway.SelectedPriceType);

            if (effectAwardGiveaway.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectAwardGiveaway.SelectedPriceOption.Value.Value);

            if (effectAwardGiveaway.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectAwardGiveaway.AdjustmentReferenceIdOption.Value.Value);

            if (effectAwardGiveaway.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectAwardGiveaway.RewardIdOption.Value.Value);
        }
    }
}
