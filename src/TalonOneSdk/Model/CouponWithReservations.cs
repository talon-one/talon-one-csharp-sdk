...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CouponWithReservations : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CouponWithReservations" /> class.
        /// </summary>
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<CouponReservation>> ReservationsOption { get; private set; }

        /// <summary>
        /// The customer profile and timestamp of each reservation.
        /// </summary>
        /// <value>The customer profile and timestamp of each reservation.</value>
        [JsonPropertyName("reservations")]
        public List<CouponReservation> Reservations { get { return this.ReservationsOption.Value; } set { this.ReservationsOption = new Option<List<CouponReservation>>(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="CouponWithReservations" />
    /// </summary>
    public partial class CouponWithReservationsJsonConverter : JsonConverter<CouponWithReservations>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CouponWithReservationsJsonConverter" /> class.
        /// </summary>
        public CouponWithReservationsJsonConverter()
        {
            OnCreated();
        }
        ...
        /// <summary>
        /// Deserializes json to <see cref="CouponWithReservations" />
        /// </summary>
        ...
        public override CouponWithReservations Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<CouponReservation>> reservations = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "implicitlyReserved":
                            ...
                            break;
                        case "reservations":
                            reservations = new Option<List<CouponReservation>>(JsonSerializer.Deserialize<List<CouponReservation>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
            ...
            if (!id.IsSet)
                throw new ArgumentException("Property is required for class CouponWithReservations.", nameof(id));

            if (!created.IsSet)
                throw new ArgumentException("Property is required for class CouponWithReservations.", nameof(created));

            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class CouponWithReservations.", nameof(campaignId));

            if (!usageCounter.IsSet)
                throw new ArgumentException("Property is required for class CouponWithReservations.", nameof(usageCounter));

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class CouponWithReservations.");

            if (created.IsSet && created.Value == null)
                throw new ArgumentNullException(nameof(created), "Property is not nullable for class CouponWithReservations.");

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class CouponWithReservations.");

            if (usageCounter.IsSet && usageCounter.Value == null)
                throw new ArgumentNullException(nameof(usageCounter), "Property is not nullable for class CouponWithReservations.");

            return new CouponWithReservations(id.Value.Value, created.Value.Value, campaignId.Value.Value, usageCounter.Value.Value, value, usageLimit, discountLimit, reservationLimit, startDate, expiryDate, limits, discountCounter, discountRemainder, reservationCounter, attributes, referralId, recipientIntegrationId, importId, reservation, batchId, isReservationMandatory, implicitlyReserved, reservations);
        }

        /// <summary>
        /// Serializes a <see cref="CouponWithReservations" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="couponWithReservations"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CouponWithReservations couponWithReservations, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, couponWithReservations, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CouponWithReservations" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="couponWithReservations"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CouponWithReservations couponWithReservations, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteNumber("id", couponWithReservations.Id);

            writer.WriteString("created", couponWithReservations.Created.ToString(CreatedFormat));

            writer.WriteNumber("campaignId", couponWithReservations.CampaignId);

            writer.WriteNumber("usageCounter", couponWithReservations.UsageCounter);

            if (couponWithReservations.ValueOption.IsSet)
                writer.WriteString("value", couponWithReservations.Value);

            if (couponWithReservations.UsageLimitOption.IsSet)
                writer.WriteNumber("usageLimit", couponWithReservations.UsageLimitOption.Value.Value);

            if (couponWithReservations.DiscountLimitOption.IsSet)
                writer.WriteNumber("discountLimit", couponWithReservations.DiscountLimitOption.Value.Value);

            if (couponWithReservations.ReservationLimitOption.IsSet)
                writer.WriteNumber("reservationLimit", couponWithReservations.ReservationLimitOption.Value.Value);

            if (couponWithReservations.StartDateOption.IsSet)
                writer.WriteString("startDate", couponWithReservations.StartDateOption.Value.Value.ToString(StartDateFormat));

            if (couponWithReservations.ExpiryDateOption.IsSet)
                writer.WriteString("expiryDate", couponWithReservations.ExpiryDateOption.Value.Value.ToString(ExpiryDateFormat));

            if (couponWithReservations.LimitsOption.IsSet)
            {
                writer.WritePropertyName("limits");
                JsonSerializer.Serialize(writer, couponWithReservations.Limits, jsonSerializerOptions);
            }
            if (couponWithReservations.DiscountCounterOption.IsSet)
                writer.WriteNumber("discountCounter", couponWithReservations.DiscountCounterOption.Value.Value);

            if (couponWithReservations.DiscountRemainderOption.IsSet)
                writer.WriteNumber("discountRemainder", couponWithReservations.DiscountRemainderOption.Value.Value);

            if (couponWithReservations.ReservationCounterOption.IsSet)
                writer.WriteNumber("reservationCounter", couponWithReservations.ReservationCounterOption.Value.Value);

            if (couponWithReservations.AttributesOption.IsSet)
            {
                writer.WritePropertyName("attributes");
                JsonSerializer.Serialize(writer, couponWithReservations.Attributes, jsonSerializerOptions);
            }
            if (couponWithReservations.ReferralIdOption.IsSet)
                writer.WriteNumber("referralId", couponWithReservations.ReferralIdOption.Value.Value);

            if (couponWithReservations.RecipientIntegrationIdOption.IsSet)
                writer.WriteString("recipientIntegrationId", couponWithReservations.RecipientIntegrationId);

            if (couponWithReservations.ImportIdOption.IsSet)
                writer.WriteNumber("importId", couponWithReservations.ImportIdOption.Value.Value);

            if (couponWithReservations.ReservationOption.IsSet)
                writer.WriteBoolean("reservation", couponWithReservations.ReservationOption.Value.Value);

            if (couponWithReservations.BatchIdOption.IsSet)
                writer.WriteString("batchId", couponWithReservations.BatchId);

            if (couponWithReservations.IsReservationMandatoryOption.IsSet)
                writer.WriteBoolean("isReservationMandatory", couponWithReservations.IsReservationMandatoryOption.Value.Value);

            if (couponWithReservations.ImplicitlyReservedOption.IsSet)
                writer.WriteBoolean("implicitlyReserved", couponWithReservations.ImplicitlyReservedOption.Value.Value);

            if (couponWithReservations.ReservationsOption.IsSet)
            {
                writer.WritePropertyName("reservations");
                JsonSerializer.Serialize(writer, couponWithReservations.Reservations, jsonSerializerOptions);
            }
        }
    }
}
