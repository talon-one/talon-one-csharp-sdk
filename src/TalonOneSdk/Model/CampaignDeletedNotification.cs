...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class CampaignDeletedNotification : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public CampaignDeletedNotification(NotificationTypeEnum notificationType, long totalResultSize, Option<List<CampaignDeletedNotificationItem>> data = default)
        {
        ...
        public Option<List<CampaignDeletedNotificationItem>> DataOption { get; private set; }
        ...
        public List<CampaignDeletedNotificationItem> Data { get { return this.DataOption.Value; } set { this.DataOption = new Option<List<CampaignDeletedNotificationItem>>(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="CampaignDeletedNotification" />
    /// </summary>
    public partial class CampaignDeletedNotificationJsonConverter : JsonConverter<CampaignDeletedNotification>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignDeletedNotificationJsonConverter" /> class.
        /// </summary>
        public CampaignDeletedNotificationJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="CampaignDeletedNotification" />
        /// </summary>
        ...
        public override CampaignDeletedNotification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<CampaignDeletedNotification.NotificationTypeEnum?> notificationType = default;
            Option<long?> totalResultSize = default;
            Option<List<CampaignDeletedNotificationItem>> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "NotificationType":
                            ...
                            {
                                CampaignDeletedNotification.NotificationTypeEnum? notificationTypeValue = CampaignDeletedNotification.NotificationTypeEnumFromStringOrDefault(notificationTypeRawValue);
                                if (notificationTypeValue == null)
                                    throw new JsonException();
                                notificationType = new Option<CampaignDeletedNotification.NotificationTypeEnum?>(notificationTypeValue);
                            }
                            break;
                        case "TotalResultSize":
                            ...
                            break;
                        case "Data":
                            data = new Option<List<CampaignDeletedNotificationItem>>(JsonSerializer.Deserialize<List<CampaignDeletedNotificationItem>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
            ...
            if (!notificationType.IsSet)
                throw new ArgumentException("Property is required for class CampaignDeletedNotification.", nameof(notificationType));
        ...
        /// <summary>
        /// Serializes a <see cref="CampaignDeletedNotification" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="campaignDeletedNotification"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CampaignDeletedNotification campaignDeletedNotification, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, campaignDeletedNotification, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CampaignDeletedNotification" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="campaignDeletedNotification"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, CampaignDeletedNotification campaignDeletedNotification, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (campaignDeletedNotification.DataOption.IsSet)
            {
                writer.WritePropertyName("Data");
                JsonSerializer.Serialize(writer, campaignDeletedNotification.Data, jsonSerializerOptions);
            }
        }
    }
}
