...
namespace TalonOneSdk.Model
{
    ...
    /// AchievementBaseV2
    /// </summary>
    public partial class AchievementBaseV2 : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="AchievementBaseV2" />
    /// </summary>
    public class AchievementBaseV2JsonConverter : JsonConverter<AchievementBaseV2>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="AchievementBaseV2" />
        /// </summary>
        ...
        public override AchievementBaseV2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<AchievementBaseV2.RecurrencePolicyEnum?> recurrencePolicy = default;
            Option<AchievementBaseV2.ActivationPolicyEnum?> activationPolicy = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "recurrencePolicy":
                            ...
                            if (recurrencePolicyRawValue != null)
                                recurrencePolicy = new Option<AchievementBaseV2.RecurrencePolicyEnum?>(AchievementBaseV2.RecurrencePolicyEnumFromStringOrDefault(recurrencePolicyRawValue));
                            break;
                        case "activationPolicy":
                            string activationPolicyRawValue = utf8JsonReader.GetString();
                            if (activationPolicyRawValue != null)
                                activationPolicy = new Option<AchievementBaseV2.ActivationPolicyEnum?>(AchievementBaseV2.ActivationPolicyEnumFromStringOrDefault(activationPolicyRawValue));
                            break;
                        case "fixedStartDate":
            ...
            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class AchievementBaseV2.");

            if (title.IsSet && title.Value == null)
                throw new ArgumentNullException(nameof(title), "Property is not nullable for class AchievementBaseV2.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class AchievementBaseV2.");
            ...
            if (period.IsSet && period.Value == null)
                throw new ArgumentNullException(nameof(period), "Property is not nullable for class AchievementBaseV2.");
            ...
            if (subscribedApplications.IsSet && subscribedApplications.Value == null)
                throw new ArgumentNullException(nameof(subscribedApplications), "Property is not nullable for class AchievementBaseV2.");

            if (timezone.IsSet && timezone.Value == null)
                throw new ArgumentNullException(nameof(timezone), "Property is not nullable for class AchievementBaseV2.");
        ...
        /// <summary>
        /// Serializes a <see cref="AchievementBaseV2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="achievementBaseV2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AchievementBaseV2 achievementBaseV2, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, achievementBaseV2, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AchievementBaseV2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="achievementBaseV2"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, AchievementBaseV2 achievementBaseV2, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (achievementBaseV2.TitleOption.IsSet)
                writer.WriteString("title", achievementBaseV2.Title);

            if (achievementBaseV2.DescriptionOption.IsSet)
                writer.WriteString("description", achievementBaseV2.Description);

            if (achievementBaseV2.TargetOption.IsSet)
                writer.WriteNumber("target", achievementBaseV2.TargetOption.Value.Value);

            if (achievementBaseV2.PeriodOption.IsSet)
                writer.WriteString("period", achievementBaseV2.Period);

            if (achievementBaseV2.RecurrencePolicyOption.IsSet)
            {
                var recurrencePolicyRawValue = AchievementBaseV2.RecurrencePolicyEnumToJsonValue(achievementBaseV2.RecurrencePolicyOption.Value);
                writer.WriteString("recurrencePolicy", recurrencePolicyRawValue);
            }
            if (achievementBaseV2.ActivationPolicyOption.IsSet)
            {
                var activationPolicyRawValue = AchievementBaseV2.ActivationPolicyEnumToJsonValue(achievementBaseV2.ActivationPolicyOption.Value);
                writer.WriteString("activationPolicy", activationPolicyRawValue);
            }
            if (achievementBaseV2.FixedStartDateOption.IsSet)
                writer.WriteString("fixedStartDate", achievementBaseV2.FixedStartDateOption.Value.Value.ToString(FixedStartDateFormat));

            if (achievementBaseV2.EndDateOption.IsSet)
                writer.WriteString("endDate", achievementBaseV2.EndDateOption.Value.Value.ToString(EndDateFormat));
