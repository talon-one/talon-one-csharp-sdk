...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class PicklistJsonConverter : JsonConverter<Picklist>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="PicklistJsonConverter" /> class.
        /// </summary>
        public PicklistJsonConverter()
        {
            OnCreated();
        }
