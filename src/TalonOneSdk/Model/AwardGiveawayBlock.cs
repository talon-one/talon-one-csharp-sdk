...
namespace TalonOneSdk.Model
{
    ...
    public partial class AwardGiveawayBlock : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AwardGiveawayBlock(string id, string type, AwardGiveawayBlock1GiveawayPool giveawayPool, ProfileEnum profile, Option<List<string>> tags = default, Option<List<Object>> onFailure = default, Option<Dictionary<string, List<Object>>> onError = default)
        {
            Id = id;
            Type = type;
    ...
    /// </summary>
    public class AwardGiveawayBlockJsonConverter : JsonConverter<AwardGiveawayBlock>
    {
        /// <summary>
