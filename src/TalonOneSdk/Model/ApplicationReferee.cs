...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class ApplicationRefereeJsonConverter : JsonConverter<ApplicationReferee>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationRefereeJsonConverter" /> class.
        /// </summary>
        public ApplicationRefereeJsonConverter()
        {
            OnCreated();
        }
