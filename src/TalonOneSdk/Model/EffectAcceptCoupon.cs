...
namespace TalonOneSdk.Model
{
    ...
    /// EffectAcceptCoupon
    /// </summary>
    public partial class EffectAcceptCoupon : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectAcceptCoupon" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;acceptCoupon&#x60;.</param>
        /// <param name="props">The properties of the &#x60;acceptCoupon&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;acceptCoupon&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum AcceptCoupon for value: acceptCoupon
            /// </summary>
            AcceptCoupon = 1
        }
        ...
        {
            if (value.Equals("acceptCoupon"))
                return EffectTypeEnum.AcceptCoupon;
        ...
        {
            if (value == EffectTypeEnum.AcceptCoupon)
                return "acceptCoupon";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;acceptCoupon&#x60; effect.</value>
        [JsonPropertyName("props")]
        public AcceptCouponEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectAcceptCoupon" />
    /// </summary>
    public partial class EffectAcceptCouponJsonConverter : JsonConverter<EffectAcceptCoupon>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectAcceptCouponJsonConverter" /> class.
        /// </summary>
        public EffectAcceptCouponJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectAcceptCoupon" />
        /// </summary>
        ...
        public override EffectAcceptCoupon Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectAcceptCoupon.EffectTypeEnum?> effectType = default;
            Option<AcceptCouponEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectAcceptCoupon.EffectTypeEnum? effectTypeValue = EffectAcceptCoupon.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectAcceptCoupon.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<AcceptCouponEffectProps>(JsonSerializer.Deserialize<AcceptCouponEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectAcceptCoupon.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectAcceptCoupon.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectAcceptCoupon.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectAcceptCoupon.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectAcceptCoupon.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectAcceptCoupon.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectAcceptCoupon.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectAcceptCoupon.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectAcceptCoupon.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectAcceptCoupon.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectAcceptCoupon.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectAcceptCoupon.");

            return new EffectAcceptCoupon(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectAcceptCoupon" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectAcceptCoupon"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectAcceptCoupon effectAcceptCoupon, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectAcceptCoupon, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectAcceptCoupon" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectAcceptCoupon"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectAcceptCoupon effectAcceptCoupon, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectAcceptCoupon.RuleName == null)
                throw new ArgumentNullException(nameof(effectAcceptCoupon.RuleName), "Property is required for class EffectAcceptCoupon.");

            if (effectAcceptCoupon.Props == null)
                throw new ArgumentNullException(nameof(effectAcceptCoupon.Props), "Property is required for class EffectAcceptCoupon.");

            writer.WriteNumber("campaignId", effectAcceptCoupon.CampaignId);

            writer.WriteNumber("rulesetId", effectAcceptCoupon.RulesetId);

            writer.WriteNumber("ruleIndex", effectAcceptCoupon.RuleIndex);

            writer.WriteString("ruleName", effectAcceptCoupon.RuleName);

            var effectTypeRawValue = EffectAcceptCoupon.EffectTypeEnumToJsonValue(effectAcceptCoupon.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectAcceptCoupon.Props, jsonSerializerOptions);
            if (effectAcceptCoupon.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectAcceptCoupon.ExperimentIdOption.Value.Value);

            if (effectAcceptCoupon.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectAcceptCoupon.TriggeredByCouponOption.Value.Value);

            if (effectAcceptCoupon.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectAcceptCoupon.TriggeredForCatalogItemOption.Value.Value);

            if (effectAcceptCoupon.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectAcceptCoupon.ConditionIndexOption.Value.Value);

            if (effectAcceptCoupon.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectAcceptCoupon.EvaluationGroupIDOption.Value.Value);

            if (effectAcceptCoupon.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectAcceptCoupon.EvaluationGroupMode);

            if (effectAcceptCoupon.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectAcceptCoupon.CampaignRevisionIdOption.Value.Value);

            if (effectAcceptCoupon.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectAcceptCoupon.CampaignRevisionVersionIdOption.Value.Value);

            if (effectAcceptCoupon.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectAcceptCoupon.SelectedPriceType);

            if (effectAcceptCoupon.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectAcceptCoupon.SelectedPriceOption.Value.Value);

            if (effectAcceptCoupon.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectAcceptCoupon.AdjustmentReferenceIdOption.Value.Value);

            if (effectAcceptCoupon.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectAcceptCoupon.RewardIdOption.Value.Value);
        }
    }
}
