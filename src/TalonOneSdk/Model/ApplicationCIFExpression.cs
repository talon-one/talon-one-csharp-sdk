...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class ApplicationCIFExpressionJsonConverter : JsonConverter<ApplicationCIFExpression>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationCIFExpressionJsonConverter" /> class.
        /// </summary>
        public ApplicationCIFExpressionJsonConverter()
        {
            OnCreated();
        }
