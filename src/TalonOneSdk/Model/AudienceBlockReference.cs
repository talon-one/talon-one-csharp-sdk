...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class AudienceBlockReference : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AudienceBlockReference" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="AudienceBlockReference" />
    /// </summary>
    public partial class AudienceBlockReferenceJsonConverter : JsonConverter<AudienceBlockReference>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="AudienceBlockReferenceJsonConverter" /> class.
        /// </summary>
        public AudienceBlockReferenceJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="AudienceBlockReference" />
        /// </summary>
        ...
        public override AudienceBlockReference Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="AudienceBlockReference" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="audienceBlockReference"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AudienceBlockReference audienceBlockReference, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, audienceBlockReference, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AudienceBlockReference" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="audienceBlockReference"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, AudienceBlockReference audienceBlockReference, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (audienceBlockReference.IntegrationIdOption.IsSet)
                writer.WriteString("integrationId", audienceBlockReference.IntegrationId);
        }
    }
}
