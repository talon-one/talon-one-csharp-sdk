...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class NewCampaignJsonConverter : JsonConverter<NewCampaign>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="NewCampaignJsonConverter" /> class.
        /// </summary>
        public NewCampaignJsonConverter()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "state":
                            ...
                            {
                                NewCampaign.StateEnum? stateValue = NewCampaign.StateEnumFromStringOrDefault(stateRawValue);
                                if (stateValue == null)
                                    throw new JsonException();
                                state = new Option<NewCampaign.StateEnum?>(stateValue);
                            }
                            break;
                        ...
                        case "type":
                            ...
                            {
                                NewCampaign.TypeEnum? typeValue = NewCampaign.TypeEnumFromStringOrDefault(typeRawValue);
                                if (typeValue == null)
                                    throw new JsonException();
                                type = new Option<NewCampaign.TypeEnum?>(typeValue);
                            }
                            break;
                        case "linkedStoreIds":
