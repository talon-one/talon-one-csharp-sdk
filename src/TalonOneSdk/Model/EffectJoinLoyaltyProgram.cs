...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class EffectJoinLoyaltyProgram : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectJoinLoyaltyProgram" /> class.
        /// </summary>
        ...
        /// <param name="effectType">An effect discriminator of type &#x60;joinLoyaltyProgram&#x60;.</param>
        /// <param name="props">The properties of the &#x60;joinLoyaltyProgram&#x60; effect.</param>
        ...
        /// </summary>
        /// <value>An effect discriminator of type &#x60;joinLoyaltyProgram&#x60;.</value>
        public enum EffectTypeEnum
        {
            /// <summary>
            /// Enum JoinLoyaltyProgram for value: joinLoyaltyProgram
            /// </summary>
            JoinLoyaltyProgram = 1
        }
        ...
        {
            if (value.Equals("joinLoyaltyProgram"))
                return EffectTypeEnum.JoinLoyaltyProgram;
        ...
        {
            if (value == EffectTypeEnum.JoinLoyaltyProgram)
                return "joinLoyaltyProgram";
        ...
        /// </summary>
        /// <value>The properties of the &#x60;joinLoyaltyProgram&#x60; effect.</value>
        [JsonPropertyName("props")]
        public JoinLoyaltyProgramEffectProps Props { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="EffectJoinLoyaltyProgram" />
    /// </summary>
    public partial class EffectJoinLoyaltyProgramJsonConverter : JsonConverter<EffectJoinLoyaltyProgram>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="EffectJoinLoyaltyProgramJsonConverter" /> class.
        /// </summary>
        public EffectJoinLoyaltyProgramJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="EffectJoinLoyaltyProgram" />
        /// </summary>
        ...
        public override EffectJoinLoyaltyProgram Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EffectJoinLoyaltyProgram.EffectTypeEnum?> effectType = default;
            Option<JoinLoyaltyProgramEffectProps> props = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "effectType":
                            ...
                            {
                                EffectJoinLoyaltyProgram.EffectTypeEnum? effectTypeValue = EffectJoinLoyaltyProgram.EffectTypeEnumFromStringOrDefault(effectTypeRawValue);
                                if (effectTypeValue == null)
                                    throw new JsonException();
                                effectType = new Option<EffectJoinLoyaltyProgram.EffectTypeEnum?>(effectTypeValue);
                            }
                            break;
                        case "props":
                            props = new Option<JoinLoyaltyProgramEffectProps>(JsonSerializer.Deserialize<JoinLoyaltyProgramEffectProps>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "experimentId":
            ...
            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class EffectJoinLoyaltyProgram.", nameof(campaignId));

            if (!rulesetId.IsSet)
                throw new ArgumentException("Property is required for class EffectJoinLoyaltyProgram.", nameof(rulesetId));

            if (!ruleIndex.IsSet)
                throw new ArgumentException("Property is required for class EffectJoinLoyaltyProgram.", nameof(ruleIndex));

            if (!ruleName.IsSet)
                throw new ArgumentException("Property is required for class EffectJoinLoyaltyProgram.", nameof(ruleName));

            if (!effectType.IsSet)
                throw new ArgumentException("Property is required for class EffectJoinLoyaltyProgram.", nameof(effectType));

            if (!props.IsSet)
                throw new ArgumentException("Property is required for class EffectJoinLoyaltyProgram.", nameof(props));

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class EffectJoinLoyaltyProgram.");

            if (rulesetId.IsSet && rulesetId.Value == null)
                throw new ArgumentNullException(nameof(rulesetId), "Property is not nullable for class EffectJoinLoyaltyProgram.");

            if (ruleIndex.IsSet && ruleIndex.Value == null)
                throw new ArgumentNullException(nameof(ruleIndex), "Property is not nullable for class EffectJoinLoyaltyProgram.");

            if (ruleName.IsSet && ruleName.Value == null)
                throw new ArgumentNullException(nameof(ruleName), "Property is not nullable for class EffectJoinLoyaltyProgram.");

            if (effectType.IsSet && effectType.Value == null)
                throw new ArgumentNullException(nameof(effectType), "Property is not nullable for class EffectJoinLoyaltyProgram.");

            if (props.IsSet && props.Value == null)
                throw new ArgumentNullException(nameof(props), "Property is not nullable for class EffectJoinLoyaltyProgram.");

            return new EffectJoinLoyaltyProgram(campaignId.Value.Value, rulesetId.Value.Value, ruleIndex.Value.Value, ruleName.Value, effectType.Value.Value, props.Value, experimentId, triggeredByCoupon, triggeredForCatalogItem, conditionIndex, evaluationGroupID, evaluationGroupMode, campaignRevisionId, campaignRevisionVersionId, selectedPriceType, selectedPrice, adjustmentReferenceId, rewardId);
        }

        /// <summary>
        /// Serializes a <see cref="EffectJoinLoyaltyProgram" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectJoinLoyaltyProgram"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EffectJoinLoyaltyProgram effectJoinLoyaltyProgram, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, effectJoinLoyaltyProgram, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EffectJoinLoyaltyProgram" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="effectJoinLoyaltyProgram"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EffectJoinLoyaltyProgram effectJoinLoyaltyProgram, JsonSerializerOptions jsonSerializerOptions)
        {
            if (effectJoinLoyaltyProgram.RuleName == null)
                throw new ArgumentNullException(nameof(effectJoinLoyaltyProgram.RuleName), "Property is required for class EffectJoinLoyaltyProgram.");

            if (effectJoinLoyaltyProgram.Props == null)
                throw new ArgumentNullException(nameof(effectJoinLoyaltyProgram.Props), "Property is required for class EffectJoinLoyaltyProgram.");

            writer.WriteNumber("campaignId", effectJoinLoyaltyProgram.CampaignId);

            writer.WriteNumber("rulesetId", effectJoinLoyaltyProgram.RulesetId);

            writer.WriteNumber("ruleIndex", effectJoinLoyaltyProgram.RuleIndex);

            writer.WriteString("ruleName", effectJoinLoyaltyProgram.RuleName);

            var effectTypeRawValue = EffectJoinLoyaltyProgram.EffectTypeEnumToJsonValue(effectJoinLoyaltyProgram.EffectType);
            writer.WriteString("effectType", effectTypeRawValue);
            writer.WritePropertyName("props");
            JsonSerializer.Serialize(writer, effectJoinLoyaltyProgram.Props, jsonSerializerOptions);
            if (effectJoinLoyaltyProgram.ExperimentIdOption.IsSet)
                writer.WriteNumber("experimentId", effectJoinLoyaltyProgram.ExperimentIdOption.Value.Value);

            if (effectJoinLoyaltyProgram.TriggeredByCouponOption.IsSet)
                writer.WriteNumber("triggeredByCoupon", effectJoinLoyaltyProgram.TriggeredByCouponOption.Value.Value);

            if (effectJoinLoyaltyProgram.TriggeredForCatalogItemOption.IsSet)
                writer.WriteNumber("triggeredForCatalogItem", effectJoinLoyaltyProgram.TriggeredForCatalogItemOption.Value.Value);

            if (effectJoinLoyaltyProgram.ConditionIndexOption.IsSet)
                writer.WriteNumber("conditionIndex", effectJoinLoyaltyProgram.ConditionIndexOption.Value.Value);

            if (effectJoinLoyaltyProgram.EvaluationGroupIDOption.IsSet)
                writer.WriteNumber("evaluationGroupID", effectJoinLoyaltyProgram.EvaluationGroupIDOption.Value.Value);

            if (effectJoinLoyaltyProgram.EvaluationGroupModeOption.IsSet)
                writer.WriteString("evaluationGroupMode", effectJoinLoyaltyProgram.EvaluationGroupMode);

            if (effectJoinLoyaltyProgram.CampaignRevisionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionId", effectJoinLoyaltyProgram.CampaignRevisionIdOption.Value.Value);

            if (effectJoinLoyaltyProgram.CampaignRevisionVersionIdOption.IsSet)
                writer.WriteNumber("campaignRevisionVersionId", effectJoinLoyaltyProgram.CampaignRevisionVersionIdOption.Value.Value);

            if (effectJoinLoyaltyProgram.SelectedPriceTypeOption.IsSet)
                writer.WriteString("selectedPriceType", effectJoinLoyaltyProgram.SelectedPriceType);

            if (effectJoinLoyaltyProgram.SelectedPriceOption.IsSet)
                writer.WriteNumber("selectedPrice", effectJoinLoyaltyProgram.SelectedPriceOption.Value.Value);

            if (effectJoinLoyaltyProgram.AdjustmentReferenceIdOption.IsSet)
                writer.WriteString("adjustmentReferenceId", effectJoinLoyaltyProgram.AdjustmentReferenceIdOption.Value.Value);

            if (effectJoinLoyaltyProgram.RewardIdOption.IsSet)
                writer.WriteNumber("rewardId", effectJoinLoyaltyProgram.RewardIdOption.Value.Value);
        }
    }
}
