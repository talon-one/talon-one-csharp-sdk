...
namespace TalonOneSdk.Model
{
    ...
    /// </summary>
    public partial class ApplicationJsonConverter : JsonConverter<Application>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationJsonConverter" /> class.
        /// </summary>
        public ApplicationJsonConverter()
        {
            OnCreated();
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, Application application, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (application.BestPriorPriceSettingsOption.IsSet)
            {
                writer.WritePropertyName("bestPriorPriceSettings");
                JsonSerializer.Serialize(writer, application.BestPriorPriceSettings, jsonSerializerOptions);
            }
        }
    }
}
