...
namespace TalonOne.Model
{
    ...
    public partial class Collection : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Collection(long id, DateTime created, long accountId, DateTime modified, string name, long createdBy, Option<string> description = default, Option<List<long>> subscribedApplicationsIds = default, Option<long?> modifiedBy = default, Option<long?> applicationId = default, Option<long?> campaignId = default, Option<List<string>> payload = default)
        {
            Id = id;
            Created = created;
            AccountId = accountId;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<string>> PayloadOption { get; private set; }
    ...
    public class CollectionJsonConverter : JsonConverter<Collection>
    {
        ...
        public override Collection Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<string>> payload = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "campaignId":
                            ...
                            break;
                        case "payload":
                            payload = new Option<List<string>>(JsonSerializer.Deserialize<List<string>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
            ...
            if (!id.IsSet)
                throw new ArgumentException("Property is required for class Collection.", nameof(id));

            if (!created.IsSet)
                throw new ArgumentException("Property is required for class Collection.", nameof(created));

            if (!accountId.IsSet)
                throw new ArgumentException("Property is required for class Collection.", nameof(accountId));

            if (!modified.IsSet)
                throw new ArgumentException("Property is required for class Collection.", nameof(modified));

            if (!name.IsSet)
                throw new ArgumentException("Property is required for class Collection.", nameof(name));

            if (!createdBy.IsSet)
                throw new ArgumentException("Property is required for class Collection.", nameof(createdBy));

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class Collection.");

            if (created.IsSet && created.Value == null)
                throw new ArgumentNullException(nameof(created), "Property is not nullable for class Collection.");

            if (accountId.IsSet && accountId.Value == null)
                throw new ArgumentNullException(nameof(accountId), "Property is not nullable for class Collection.");

            if (modified.IsSet && modified.Value == null)
                throw new ArgumentNullException(nameof(modified), "Property is not nullable for class Collection.");
            ...
            if (createdBy.IsSet && createdBy.Value == null)
                throw new ArgumentNullException(nameof(createdBy), "Property is not nullable for class Collection.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class Collection.");

            if (subscribedApplicationsIds.IsSet && subscribedApplicationsIds.Value == null)
                throw new ArgumentNullException(nameof(subscribedApplicationsIds), "Property is not nullable for class Collection.");

            if (modifiedBy.IsSet && modifiedBy.Value == null)
                throw new ArgumentNullException(nameof(modifiedBy), "Property is not nullable for class Collection.");

            if (applicationId.IsSet && applicationId.Value == null)
                throw new ArgumentNullException(nameof(applicationId), "Property is not nullable for class Collection.");

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class Collection.");

            if (payload.IsSet && payload.Value == null)
                throw new ArgumentNullException(nameof(payload), "Property is not nullable for class Collection.");

            return new Collection(id.Value.Value, created.Value.Value, accountId.Value.Value, modified.Value.Value, name.Value, createdBy.Value.Value, description, subscribedApplicationsIds, modifiedBy, applicationId, campaignId, payload);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, Collection collection, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (collection.DescriptionOption.IsSet && collection.Description == null)
                throw new ArgumentNullException(nameof(collection.Description), "Property is required for class Collection.");

            if (collection.SubscribedApplicationsIdsOption.IsSet && collection.SubscribedApplicationsIds == null)
                throw new ArgumentNullException(nameof(collection.SubscribedApplicationsIds), "Property is required for class Collection.");

            if (collection.PayloadOption.IsSet && collection.Payload == null)
                throw new ArgumentNullException(nameof(collection.Payload), "Property is required for class Collection.");

            writer.WriteNumber("id", collection.Id);

            writer.WriteString("created", collection.Created.ToString(CreatedFormat));

            writer.WriteNumber("accountId", collection.AccountId);

            writer.WriteString("modified", collection.Modified.ToString(ModifiedFormat));

            writer.WriteString("name", collection.Name);

            writer.WriteNumber("createdBy", collection.CreatedBy);

            if (collection.DescriptionOption.IsSet)
                writer.WriteString("description", collection.Description);

            if (collection.SubscribedApplicationsIdsOption.IsSet)
            {
                writer.WritePropertyName("subscribedApplicationsIds");
                JsonSerializer.Serialize(writer, collection.SubscribedApplicationsIds, jsonSerializerOptions);
            }
            if (collection.ModifiedByOption.IsSet)
                writer.WriteNumber("modifiedBy", collection.ModifiedByOption.Value.Value);

            if (collection.ApplicationIdOption.IsSet)
                writer.WriteNumber("applicationId", collection.ApplicationIdOption.Value.Value);

            if (collection.CampaignIdOption.IsSet)
                writer.WriteNumber("campaignId", collection.CampaignIdOption.Value.Value);

            if (collection.PayloadOption.IsSet)
            {
                writer.WritePropertyName("payload");
                JsonSerializer.Serialize(writer, collection.Payload, jsonSerializerOptions);
            }
        }
    }
}
