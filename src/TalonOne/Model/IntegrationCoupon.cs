...
namespace TalonOne.Model
{
    ...
    /// IntegrationCoupon
    /// </summary>
    public partial class IntegrationCoupon : IValidatableObject
    {
        /// <summary>
    ...
    public class IntegrationCouponJsonConverter : JsonConverter<IntegrationCoupon>
    {
        ...
        public override IntegrationCoupon Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!id.IsSet)
                throw new ArgumentException("Property is required for class IntegrationCoupon.", nameof(id));

            if (!created.IsSet)
                throw new ArgumentException("Property is required for class IntegrationCoupon.", nameof(created));

            if (!campaignId.IsSet)
                throw new ArgumentException("Property is required for class IntegrationCoupon.", nameof(campaignId));

            if (!usageCounter.IsSet)
                throw new ArgumentException("Property is required for class IntegrationCoupon.", nameof(usageCounter));

            if (!profileRedemptionCount.IsSet)
                throw new ArgumentException("Property is required for class IntegrationCoupon.", nameof(profileRedemptionCount));

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class IntegrationCoupon.");

            if (created.IsSet && created.Value == null)
                throw new ArgumentNullException(nameof(created), "Property is not nullable for class IntegrationCoupon.");

            if (campaignId.IsSet && campaignId.Value == null)
                throw new ArgumentNullException(nameof(campaignId), "Property is not nullable for class IntegrationCoupon.");

            if (usageCounter.IsSet && usageCounter.Value == null)
                throw new ArgumentNullException(nameof(usageCounter), "Property is not nullable for class IntegrationCoupon.");

            if (profileRedemptionCount.IsSet && profileRedemptionCount.Value == null)
                throw new ArgumentNullException(nameof(profileRedemptionCount), "Property is not nullable for class IntegrationCoupon.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class IntegrationCoupon.");

            if (usageLimit.IsSet && usageLimit.Value == null)
                throw new ArgumentNullException(nameof(usageLimit), "Property is not nullable for class IntegrationCoupon.");

            if (discountLimit.IsSet && discountLimit.Value == null)
                throw new ArgumentNullException(nameof(discountLimit), "Property is not nullable for class IntegrationCoupon.");

            if (reservationLimit.IsSet && reservationLimit.Value == null)
                throw new ArgumentNullException(nameof(reservationLimit), "Property is not nullable for class IntegrationCoupon.");

            if (startDate.IsSet && startDate.Value == null)
                throw new ArgumentNullException(nameof(startDate), "Property is not nullable for class IntegrationCoupon.");

            if (expiryDate.IsSet && expiryDate.Value == null)
                throw new ArgumentNullException(nameof(expiryDate), "Property is not nullable for class IntegrationCoupon.");

            if (limits.IsSet && limits.Value == null)
                throw new ArgumentNullException(nameof(limits), "Property is not nullable for class IntegrationCoupon.");

            if (discountCounter.IsSet && discountCounter.Value == null)
                throw new ArgumentNullException(nameof(discountCounter), "Property is not nullable for class IntegrationCoupon.");

            if (discountRemainder.IsSet && discountRemainder.Value == null)
                throw new ArgumentNullException(nameof(discountRemainder), "Property is not nullable for class IntegrationCoupon.");

            if (reservationCounter.IsSet && reservationCounter.Value == null)
                throw new ArgumentNullException(nameof(reservationCounter), "Property is not nullable for class IntegrationCoupon.");

            if (attributes.IsSet && attributes.Value == null)
                throw new ArgumentNullException(nameof(attributes), "Property is not nullable for class IntegrationCoupon.");

            if (referralId.IsSet && referralId.Value == null)
                throw new ArgumentNullException(nameof(referralId), "Property is not nullable for class IntegrationCoupon.");

            if (recipientIntegrationId.IsSet && recipientIntegrationId.Value == null)
                throw new ArgumentNullException(nameof(recipientIntegrationId), "Property is not nullable for class IntegrationCoupon.");

            if (importId.IsSet && importId.Value == null)
                throw new ArgumentNullException(nameof(importId), "Property is not nullable for class IntegrationCoupon.");

            if (reservation.IsSet && reservation.Value == null)
                throw new ArgumentNullException(nameof(reservation), "Property is not nullable for class IntegrationCoupon.");

            if (batchId.IsSet && batchId.Value == null)
                throw new ArgumentNullException(nameof(batchId), "Property is not nullable for class IntegrationCoupon.");

            if (isReservationMandatory.IsSet && isReservationMandatory.Value == null)
                throw new ArgumentNullException(nameof(isReservationMandatory), "Property is not nullable for class IntegrationCoupon.");

            if (implicitlyReserved.IsSet && implicitlyReserved.Value == null)
                throw new ArgumentNullException(nameof(implicitlyReserved), "Property is not nullable for class IntegrationCoupon.");

            return new IntegrationCoupon(id.Value.Value, created.Value.Value, campaignId.Value.Value, usageCounter.Value.Value, profileRedemptionCount.Value.Value, value, usageLimit, discountLimit, reservationLimit, startDate, expiryDate, limits, discountCounter, discountRemainder, reservationCounter, attributes, referralId, recipientIntegrationId, importId, reservation, batchId, isReservationMandatory, implicitlyReserved);
        }

        /// <summary>
        /// Serializes a <see cref="IntegrationCoupon" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="integrationCoupon"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, IntegrationCoupon integrationCoupon, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, integrationCoupon, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="IntegrationCoupon" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="integrationCoupon"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, IntegrationCoupon integrationCoupon, JsonSerializerOptions jsonSerializerOptions)
        {
            if (integrationCoupon.ValueOption.IsSet && integrationCoupon.Value == null)
                throw new ArgumentNullException(nameof(integrationCoupon.Value), "Property is required for class IntegrationCoupon.");

            if (integrationCoupon.LimitsOption.IsSet && integrationCoupon.Limits == null)
                throw new ArgumentNullException(nameof(integrationCoupon.Limits), "Property is required for class IntegrationCoupon.");

            if (integrationCoupon.AttributesOption.IsSet && integrationCoupon.Attributes == null)
                throw new ArgumentNullException(nameof(integrationCoupon.Attributes), "Property is required for class IntegrationCoupon.");

            if (integrationCoupon.RecipientIntegrationIdOption.IsSet && integrationCoupon.RecipientIntegrationId == null)
                throw new ArgumentNullException(nameof(integrationCoupon.RecipientIntegrationId), "Property is required for class IntegrationCoupon.");

            if (integrationCoupon.BatchIdOption.IsSet && integrationCoupon.BatchId == null)
                throw new ArgumentNullException(nameof(integrationCoupon.BatchId), "Property is required for class IntegrationCoupon.");

            writer.WriteNumber("id", integrationCoupon.Id);

            writer.WriteString("created", integrationCoupon.Created.ToString(CreatedFormat));

            writer.WriteNumber("campaignId", integrationCoupon.CampaignId);

            writer.WriteNumber("usageCounter", integrationCoupon.UsageCounter);

            writer.WriteNumber("profileRedemptionCount", integrationCoupon.ProfileRedemptionCount);

            if (integrationCoupon.ValueOption.IsSet)
                writer.WriteString("value", integrationCoupon.Value);

            if (integrationCoupon.UsageLimitOption.IsSet)
                writer.WriteNumber("usageLimit", integrationCoupon.UsageLimitOption.Value.Value);

            if (integrationCoupon.DiscountLimitOption.IsSet)
                writer.WriteNumber("discountLimit", integrationCoupon.DiscountLimitOption.Value.Value);

            if (integrationCoupon.ReservationLimitOption.IsSet)
                writer.WriteNumber("reservationLimit", integrationCoupon.ReservationLimitOption.Value.Value);

            if (integrationCoupon.StartDateOption.IsSet)
                writer.WriteString("startDate", integrationCoupon.StartDateOption.Value.Value.ToString(StartDateFormat));

            if (integrationCoupon.ExpiryDateOption.IsSet)
                writer.WriteString("expiryDate", integrationCoupon.ExpiryDateOption.Value.Value.ToString(ExpiryDateFormat));

            if (integrationCoupon.LimitsOption.IsSet)
            {
                writer.WritePropertyName("limits");
                JsonSerializer.Serialize(writer, integrationCoupon.Limits, jsonSerializerOptions);
            }
            if (integrationCoupon.DiscountCounterOption.IsSet)
                writer.WriteNumber("discountCounter", integrationCoupon.DiscountCounterOption.Value.Value);

            if (integrationCoupon.DiscountRemainderOption.IsSet)
                writer.WriteNumber("discountRemainder", integrationCoupon.DiscountRemainderOption.Value.Value);

            if (integrationCoupon.ReservationCounterOption.IsSet)
                writer.WriteNumber("reservationCounter", integrationCoupon.ReservationCounterOption.Value.Value);

            if (integrationCoupon.AttributesOption.IsSet)
            {
                writer.WritePropertyName("attributes");
                JsonSerializer.Serialize(writer, integrationCoupon.Attributes, jsonSerializerOptions);
            }
            if (integrationCoupon.ReferralIdOption.IsSet)
                writer.WriteNumber("referralId", integrationCoupon.ReferralIdOption.Value.Value);

            if (integrationCoupon.RecipientIntegrationIdOption.IsSet)
                writer.WriteString("recipientIntegrationId", integrationCoupon.RecipientIntegrationId);

            if (integrationCoupon.ImportIdOption.IsSet)
                writer.WriteNumber("importId", integrationCoupon.ImportIdOption.Value.Value);

            if (integrationCoupon.ReservationOption.IsSet)
                writer.WriteBoolean("reservation", integrationCoupon.ReservationOption.Value.Value);

            if (integrationCoupon.BatchIdOption.IsSet)
                writer.WriteString("batchId", integrationCoupon.BatchId);

            if (integrationCoupon.IsReservationMandatoryOption.IsSet)
                writer.WriteBoolean("isReservationMandatory", integrationCoupon.IsReservationMandatoryOption.Value.Value);

            if (integrationCoupon.ImplicitlyReservedOption.IsSet)
                writer.WriteBoolean("implicitlyReserved", integrationCoupon.ImplicitlyReservedOption.Value.Value);
        }
    }
}
