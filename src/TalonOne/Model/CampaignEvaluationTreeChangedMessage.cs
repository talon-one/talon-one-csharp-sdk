...
namespace TalonOne.Model
{
    ...
    /// </summary>
    public partial class CampaignEvaluationTreeChangedMessage : IValidatableObject
    {
        /// <summary>
        ...
        public List<ApplicationNotification> Data { get { return this.DataOption; } set { this.DataOption = new Option<List<ApplicationNotification>>(value); } }
    ...
    public class CampaignEvaluationTreeChangedMessageJsonConverter : JsonConverter<CampaignEvaluationTreeChangedMessage>
    {
        ...
        public override CampaignEvaluationTreeChangedMessage Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "NotificationType":
                            ...
                            if (notificationTypeRawValue != null)
                                notificationType = new Option<CampaignEvaluationTreeChangedMessage.NotificationTypeEnum?>(CampaignEvaluationTreeChangedMessage.NotificationTypeEnumFromStringOrDefault(notificationTypeRawValue));
                            break;
            ...
            if (!notificationType.IsSet)
                throw new ArgumentException("Property is required for class CampaignEvaluationTreeChangedMessage.", nameof(notificationType));
        ...
        /// <summary>
        /// Serializes a <see cref="CampaignEvaluationTreeChangedMessage" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="campaignEvaluationTreeChangedMessage"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CampaignEvaluationTreeChangedMessage campaignEvaluationTreeChangedMessage, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, campaignEvaluationTreeChangedMessage, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CampaignEvaluationTreeChangedMessage" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="campaignEvaluationTreeChangedMessage"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        {
            if (campaignEvaluationTreeChangedMessage.DataOption.IsSet && campaignEvaluationTreeChangedMessage.Data == null)
