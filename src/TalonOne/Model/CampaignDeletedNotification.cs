...
namespace TalonOne.Model
{
    ...
    public partial class CampaignDeletedNotification : IValidatableObject
    {
        ...
        public List<CampaignDeletedNotificationItem> Data { get { return this.DataOption; } set { this.DataOption = new Option<List<CampaignDeletedNotificationItem>>(value); } }
    ...
    /// </summary>
    public class CampaignDeletedNotificationJsonConverter : JsonConverter<CampaignDeletedNotification>
    {
        /// <summary>
        ...
        public override CampaignDeletedNotification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class CampaignDeletedNotification.");
