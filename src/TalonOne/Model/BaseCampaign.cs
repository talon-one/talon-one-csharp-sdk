...
namespace TalonOne.Model
{
    ...
    public partial class BaseCampaign : IValidatableObject
    {
        ...
        [JsonConstructor]
        public BaseCampaign(string name, List<string> tags, List<BaseCampaign.FeaturesEnum> features, List<LimitConfig> limits, Option<string> description = default, Option<DateTime?> startTime = default, Option<DateTime?> endTime = default, Option<Object> attributes = default, StateEnum state = StateEnum.Enabled, Option<long?> activeRulesetId = default, Option<CodeGeneratorSettings> couponSettings = default, Option<CodeGeneratorSettings> referralSettings = default, Option<List<long>> campaignGroups = default, Option<TypeEnum?> type = default, Option<List<long>> linkedStoreIds = default)
        {
            Name = name;
            Tags = tags;
            Features = features;
    ...
    public class BaseCampaignJsonConverter : JsonConverter<BaseCampaign>
    {
        ...
        public override BaseCampaign Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new BaseCampaign(name.Value, tags.Value, features.Value, limits.Value, description, startTime, endTime, attributes, state.Value.Value, activeRulesetId, couponSettings, referralSettings, campaignGroups, type, linkedStoreIds);
        }
