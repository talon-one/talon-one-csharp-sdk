...
namespace TalonOne.Model
{
    ...
    /// </summary>
    public partial class NewApplicationAPIKey : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public NewApplicationAPIKey(string title, DateTime expires, long id, long createdBy, long accountID, long applicationID, DateTime created, string key, Option<PlatformEnum?> platform = default, Option<TypeEnum?> type = default, Option<long?> timeOffset = default)
        {
            Title = title;
            Expires = expires;
            Id = id;
    ...
    public class NewApplicationAPIKeyJsonConverter : JsonConverter<NewApplicationAPIKey>
    {
        ...
        public override NewApplicationAPIKey Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<NewApplicationAPIKey.PlatformEnum?> platform = default;
            Option<NewApplicationAPIKey.TypeEnum?> type = default;
            ...
            if (!title.IsSet)
                throw new ArgumentException("Property is required for class NewApplicationAPIKey.", nameof(title));

            if (!expires.IsSet)
                throw new ArgumentException("Property is required for class NewApplicationAPIKey.", nameof(expires));

            if (!id.IsSet)
                throw new ArgumentException("Property is required for class NewApplicationAPIKey.", nameof(id));

            if (!createdBy.IsSet)
                throw new ArgumentException("Property is required for class NewApplicationAPIKey.", nameof(createdBy));

            if (!accountID.IsSet)
                throw new ArgumentException("Property is required for class NewApplicationAPIKey.", nameof(accountID));

            if (!applicationID.IsSet)
                throw new ArgumentException("Property is required for class NewApplicationAPIKey.", nameof(applicationID));

            if (!created.IsSet)
                throw new ArgumentException("Property is required for class NewApplicationAPIKey.", nameof(created));
        ...
        /// <summary>
        /// Serializes a <see cref="NewApplicationAPIKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="newApplicationAPIKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, NewApplicationAPIKey newApplicationAPIKey, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, newApplicationAPIKey, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="NewApplicationAPIKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="newApplicationAPIKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, NewApplicationAPIKey newApplicationAPIKey, JsonSerializerOptions jsonSerializerOptions)
        {
            if (newApplicationAPIKey.Title == null)
                throw new ArgumentNullException(nameof(newApplicationAPIKey.Title), "Property is required for class NewApplicationAPIKey.");

            if (newApplicationAPIKey.Key == null)
                throw new ArgumentNullException(nameof(newApplicationAPIKey.Key), "Property is required for class NewApplicationAPIKey.");

            writer.WriteString("title", newApplicationAPIKey.Title);

            writer.WriteString("expires", newApplicationAPIKey.Expires.ToString(ExpiresFormat));

            writer.WriteNumber("id", newApplicationAPIKey.Id);

            writer.WriteNumber("createdBy", newApplicationAPIKey.CreatedBy);

            writer.WriteNumber("accountID", newApplicationAPIKey.AccountID);

            writer.WriteNumber("applicationID", newApplicationAPIKey.ApplicationID);

            writer.WriteString("created", newApplicationAPIKey.Created.ToString(CreatedFormat));
