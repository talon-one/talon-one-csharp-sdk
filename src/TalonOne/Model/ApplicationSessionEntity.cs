...
namespace TalonOne.Model
{
    ...
    /// </summary>
    public partial class ApplicationSessionEntity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationSessionEntity" /> class.
        /// </summary>
        /// <param name="sessionId">The globally unique Talon.One ID of the session where this entity was created.</param>
        [JsonConstructor]
        public ApplicationSessionEntity(long sessionId)
        {
            SessionId = sessionId;
            OnCreated();
        }
    ...
    public class ApplicationSessionEntityJsonConverter : JsonConverter<ApplicationSessionEntity>
    {
        ...
        public override ApplicationSessionEntity Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="ApplicationSessionEntity" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="applicationSessionEntity"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ApplicationSessionEntity applicationSessionEntity, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, applicationSessionEntity, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ApplicationSessionEntity" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="applicationSessionEntity"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ApplicationSessionEntity applicationSessionEntity, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteNumber("sessionId", applicationSessionEntity.SessionId);
        }
    }
}
