...
namespace TalonOne.Model
{
    ...
    /// </summary>
    public partial class CardExpiringPointsNotificationTrigger : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public CardExpiringPointsNotificationTrigger(long amount, PeriodEnum period)
        {
            Amount = amount;
            Period = period;
            OnCreated();
    ...
    public class CardExpiringPointsNotificationTriggerJsonConverter : JsonConverter<CardExpiringPointsNotificationTrigger>
    {
        ...
        public override CardExpiringPointsNotificationTrigger Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<CardExpiringPointsNotificationTrigger.PeriodEnum?> period = default;
            ...
            if (!amount.IsSet)
                throw new ArgumentException("Property is required for class CardExpiringPointsNotificationTrigger.", nameof(amount));
        ...
        /// <summary>
        /// Serializes a <see cref="CardExpiringPointsNotificationTrigger" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="cardExpiringPointsNotificationTrigger"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CardExpiringPointsNotificationTrigger cardExpiringPointsNotificationTrigger, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, cardExpiringPointsNotificationTrigger, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CardExpiringPointsNotificationTrigger" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="cardExpiringPointsNotificationTrigger"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CardExpiringPointsNotificationTrigger cardExpiringPointsNotificationTrigger, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteNumber("amount", cardExpiringPointsNotificationTrigger.Amount);

            var periodRawValue = CardExpiringPointsNotificationTrigger.PeriodEnumToJsonValue(cardExpiringPointsNotificationTrigger.Period);
