...
namespace TalonOne.Model
{
    ...
    /// NewCampaignGroup
    /// </summary>
    public partial class NewCampaignGroup : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public NewCampaignGroup(string name, Option<string> description = default, Option<List<long>> subscribedApplicationsIds = default, Option<List<long>> campaignIds = default)
        {
            Name = name;
    ...
    public class NewCampaignGroupJsonConverter : JsonConverter<NewCampaignGroup>
    {
        ...
        public override NewCampaignGroup Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class NewCampaignGroup.");

            if (subscribedApplicationsIds.IsSet && subscribedApplicationsIds.Value == null)
                throw new ArgumentNullException(nameof(subscribedApplicationsIds), "Property is not nullable for class NewCampaignGroup.");

            if (campaignIds.IsSet && campaignIds.Value == null)
                throw new ArgumentNullException(nameof(campaignIds), "Property is not nullable for class NewCampaignGroup.");

            return new NewCampaignGroup(name.Value, description, subscribedApplicationsIds, campaignIds);
        }

        /// <summary>
        /// Serializes a <see cref="NewCampaignGroup" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="newCampaignGroup"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, NewCampaignGroup newCampaignGroup, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, newCampaignGroup, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="NewCampaignGroup" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="newCampaignGroup"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, NewCampaignGroup newCampaignGroup, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (newCampaignGroup.DescriptionOption.IsSet)
                writer.WriteString("description", newCampaignGroup.Description);

            if (newCampaignGroup.SubscribedApplicationsIdsOption.IsSet)
            {
                writer.WritePropertyName("subscribedApplicationsIds");
                JsonSerializer.Serialize(writer, newCampaignGroup.SubscribedApplicationsIds, jsonSerializerOptions);
            }
            if (newCampaignGroup.CampaignIdsOption.IsSet)
            {
                writer.WritePropertyName("campaignIds");
                JsonSerializer.Serialize(writer, newCampaignGroup.CampaignIds, jsonSerializerOptions);
            }
        }
    }
}
