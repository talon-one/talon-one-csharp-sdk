...
namespace TalonOne.Model
{
    ...
    public partial class Audience : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Audience(long accountId, long id, DateTime created, string name, Option<bool?> sandbox = default, Option<string> description = default, Option<string> integration = default, Option<string> integrationId = default, Option<bool?> createdIn3rdParty = default, Option<DateTime?> lastUpdate = default)
        {
            AccountId = accountId;
            Id = id;
            Created = created;
    ...
    public class AudienceJsonConverter : JsonConverter<Audience>
    {
        ...
        public override Audience Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (integration.IsSet && integration.Value == null)
                throw new ArgumentNullException(nameof(integration), "Property is not nullable for class Audience.");

            if (integrationId.IsSet && integrationId.Value == null)
                throw new ArgumentNullException(nameof(integrationId), "Property is not nullable for class Audience.");
