...
namespace TalonOne.Model
{
    ...
    /// ManagerConfig
    /// </summary>
    public partial class ManagerConfig : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public ManagerConfig(long schemaVersion)
        {
    ...
    public class ManagerConfigJsonConverter : JsonConverter<ManagerConfig>
    {
        ...
        public override ManagerConfig Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="ManagerConfig" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="managerConfig"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ManagerConfig managerConfig, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, managerConfig, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ManagerConfig" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="managerConfig"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ManagerConfig managerConfig, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteNumber("schemaVersion", managerConfig.SchemaVersion);
        }
    }
}
