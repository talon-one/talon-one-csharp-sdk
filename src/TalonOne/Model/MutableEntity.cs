...
namespace TalonOne.Model
{
    ...
    /// MutableEntity
    /// </summary>
    public partial class MutableEntity : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public MutableEntity(DateTime modified)
        {
            Modified = modified;
            OnCreated();
        }
    ...
    public class MutableEntityJsonConverter : JsonConverter<MutableEntity>
    {
        ...
        public override MutableEntity Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="MutableEntity" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="mutableEntity"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MutableEntity mutableEntity, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, mutableEntity, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MutableEntity" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="mutableEntity"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MutableEntity mutableEntity, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteString("modified", mutableEntity.Modified.ToString(ModifiedFormat));
        }
    }
}
