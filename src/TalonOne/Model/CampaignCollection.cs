...
namespace TalonOne.Model
{
    ...
    /// CampaignCollection
    /// </summary>
    public partial class CampaignCollection : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public CampaignCollection(long id, DateTime created, long accountId, DateTime modified, string name, long createdBy, Option<string> description = default, Option<long?> modifiedBy = default, Option<long?> applicationId = default, Option<long?> campaignId = default, Option<List<string>> payload = default)
        {
            Id = id;
            Created = created;
            AccountId = accountId;
    ...
    /// <summary>
    /// A Json converter for type <see cref="CampaignCollection" />
    /// </summary>
    public class CampaignCollectionJsonConverter : JsonConverter<CampaignCollection>
    {
        /// <summary>
        ...
        public override CampaignCollection Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!id.IsSet)
                throw new ArgumentException("Property is required for class CampaignCollection.", nameof(id));

            if (!created.IsSet)
                throw new ArgumentException("Property is required for class CampaignCollection.", nameof(created));

            if (!accountId.IsSet)
                throw new ArgumentException("Property is required for class CampaignCollection.", nameof(accountId));

            if (!modified.IsSet)
                throw new ArgumentException("Property is required for class CampaignCollection.", nameof(modified));

            if (!name.IsSet)
                throw new ArgumentException("Property is required for class CampaignCollection.", nameof(name));
            ...
            if (applicationId.IsSet && applicationId.Value == null)
                throw new ArgumentNullException(nameof(applicationId), "Property is not nullable for class CampaignCollection.");
        ...
        /// <summary>
        /// Serializes a <see cref="CampaignCollection" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="campaignCollection"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CampaignCollection campaignCollection, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, campaignCollection, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CampaignCollection" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="campaignCollection"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CampaignCollection campaignCollection, JsonSerializerOptions jsonSerializerOptions)
        {
            if (campaignCollection.Name == null)
                throw new ArgumentNullException(nameof(campaignCollection.Name), "Property is required for class CampaignCollection.");

            if (campaignCollection.DescriptionOption.IsSet && campaignCollection.Description == null)
                throw new ArgumentNullException(nameof(campaignCollection.Description), "Property is required for class CampaignCollection.");

            if (campaignCollection.PayloadOption.IsSet && campaignCollection.Payload == null)
                throw new ArgumentNullException(nameof(campaignCollection.Payload), "Property is required for class CampaignCollection.");

            writer.WriteNumber("id", campaignCollection.Id);

            writer.WriteString("created", campaignCollection.Created.ToString(CreatedFormat));

            writer.WriteNumber("accountId", campaignCollection.AccountId);

            writer.WriteString("modified", campaignCollection.Modified.ToString(ModifiedFormat));

            writer.WriteString("name", campaignCollection.Name);

            writer.WriteNumber("createdBy", campaignCollection.CreatedBy);

            if (campaignCollection.DescriptionOption.IsSet)
                writer.WriteString("description", campaignCollection.Description);

            if (campaignCollection.ModifiedByOption.IsSet)
                writer.WriteNumber("modifiedBy", campaignCollection.ModifiedByOption.Value.Value);

            if (campaignCollection.ApplicationIdOption.IsSet)
                writer.WriteNumber("applicationId", campaignCollection.ApplicationIdOption.Value.Value);

            if (campaignCollection.CampaignIdOption.IsSet)
                writer.WriteNumber("campaignId", campaignCollection.CampaignIdOption.Value.Value);

            if (campaignCollection.PayloadOption.IsSet)
            {
                writer.WritePropertyName("payload");
                JsonSerializer.Serialize(writer, campaignCollection.Payload, jsonSerializerOptions);
            }
        }
    }
}
