...
namespace TalonOne.Model
{
    ...
    /// NewCampaign
    /// </summary>
    public partial class NewCampaign : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public NewCampaign(string name, List<string> tags, List<NewCampaign.FeaturesEnum> features, List<LimitConfig> limits, Option<string> description = default, Option<DateTime?> startTime = default, Option<DateTime?> endTime = default, Option<Object> attributes = default, StateEnum state = StateEnum.Enabled, Option<long?> activeRulesetId = default, Option<CodeGeneratorSettings> couponSettings = default, Option<CodeGeneratorSettings> referralSettings = default, Option<List<long>> campaignGroups = default, Option<TypeEnum?> type = default, Option<List<long>> linkedStoreIds = default, Option<long?> evaluationGroupId = default)
        {
            Name = name;
            Tags = tags;
            Features = features;
        ...
        public List<NewCampaign.FeaturesEnum> Features { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="NewCampaign" />
    /// </summary>
    public class NewCampaignJsonConverter : JsonConverter<NewCampaign>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="NewCampaign" />
        /// </summary>
        ...
        public override NewCampaign Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<NewCampaign.FeaturesEnum>> features = default;
            ...
            Option<NewCampaign.StateEnum?> state = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "features":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                features = new Option<List<NewCampaign.FeaturesEnum>>(JsonSerializer.Deserialize<List<NewCampaign.FeaturesEnum>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "limits":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "state":
                            ...
                            if (stateRawValue != null)
                                state = new Option<NewCampaign.StateEnum?>(NewCampaign.StateEnumFromStringOrDefault(stateRawValue));
                            break;
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<NewCampaign.TypeEnum?>(NewCampaign.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        case "linkedStoreIds":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class NewCampaign.", nameof(name));

            if (!tags.IsSet)
                throw new ArgumentException("Property is required for class NewCampaign.", nameof(tags));

            if (!features.IsSet)
                throw new ArgumentException("Property is required for class NewCampaign.", nameof(features));

            if (!limits.IsSet)
                throw new ArgumentException("Property is required for class NewCampaign.", nameof(limits));
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class NewCampaign.");
            ...
            if (attributes.IsSet && attributes.Value == null)
                throw new ArgumentNullException(nameof(attributes), "Property is not nullable for class NewCampaign.");
            ...
            if (couponSettings.IsSet && couponSettings.Value == null)
                throw new ArgumentNullException(nameof(couponSettings), "Property is not nullable for class NewCampaign.");

            if (referralSettings.IsSet && referralSettings.Value == null)
                throw new ArgumentNullException(nameof(referralSettings), "Property is not nullable for class NewCampaign.");

            if (campaignGroups.IsSet && campaignGroups.Value == null)
                throw new ArgumentNullException(nameof(campaignGroups), "Property is not nullable for class NewCampaign.");
            ...
            if (linkedStoreIds.IsSet && linkedStoreIds.Value == null)
                throw new ArgumentNullException(nameof(linkedStoreIds), "Property is not nullable for class NewCampaign.");
            ...
            return new NewCampaign(name.Value, tags.Value, features.Value, limits.Value, description, startTime, endTime, attributes, state.Value.Value, activeRulesetId, couponSettings, referralSettings, campaignGroups, type, linkedStoreIds, evaluationGroupId);
        }

        /// <summary>
        /// Serializes a <see cref="NewCampaign" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="newCampaign"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, NewCampaign newCampaign, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, newCampaign, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="NewCampaign" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="newCampaign"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, NewCampaign newCampaign, JsonSerializerOptions jsonSerializerOptions)
        {
            if (newCampaign.Name == null)
                throw new ArgumentNullException(nameof(newCampaign.Name), "Property is required for class NewCampaign.");

            if (newCampaign.Tags == null)
                throw new ArgumentNullException(nameof(newCampaign.Tags), "Property is required for class NewCampaign.");

            if (newCampaign.Features == null)
                throw new ArgumentNullException(nameof(newCampaign.Features), "Property is required for class NewCampaign.");
            ...
            JsonSerializer.Serialize(writer, newCampaign.Tags, jsonSerializerOptions);
            writer.WritePropertyName("features");
            JsonSerializer.Serialize(writer, newCampaign.Features, jsonSerializerOptions);
            writer.WritePropertyName("limits");
            JsonSerializer.Serialize(writer, newCampaign.Limits, jsonSerializerOptions);
            if (newCampaign.DescriptionOption.IsSet)
                writer.WriteString("description", newCampaign.Description);

            if (newCampaign.StartTimeOption.IsSet)
                writer.WriteString("startTime", newCampaign.StartTimeOption.Value.Value.ToString(StartTimeFormat));

            if (newCampaign.EndTimeOption.IsSet)
                writer.WriteString("endTime", newCampaign.EndTimeOption.Value.Value.ToString(EndTimeFormat));

            if (newCampaign.AttributesOption.IsSet)
            {
                writer.WritePropertyName("attributes");
                JsonSerializer.Serialize(writer, newCampaign.Attributes, jsonSerializerOptions);
            }
            var stateRawValue = NewCampaign.StateEnumToJsonValue(newCampaign.State);
            writer.WriteString("state", stateRawValue);
            if (newCampaign.ActiveRulesetIdOption.IsSet)
                writer.WriteNumber("activeRulesetId", newCampaign.ActiveRulesetIdOption.Value.Value);

            if (newCampaign.CouponSettingsOption.IsSet)
            {
                writer.WritePropertyName("couponSettings");
                JsonSerializer.Serialize(writer, newCampaign.CouponSettings, jsonSerializerOptions);
            }
            if (newCampaign.ReferralSettingsOption.IsSet)
            {
                writer.WritePropertyName("referralSettings");
                JsonSerializer.Serialize(writer, newCampaign.ReferralSettings, jsonSerializerOptions);
            }
            if (newCampaign.CampaignGroupsOption.IsSet)
            {
                writer.WritePropertyName("campaignGroups");
                JsonSerializer.Serialize(writer, newCampaign.CampaignGroups, jsonSerializerOptions);
            }
            var typeRawValue = NewCampaign.TypeEnumToJsonValue(newCampaign.TypeOption.Value.Value);
            writer.WriteString("type", typeRawValue);
            if (newCampaign.LinkedStoreIdsOption.IsSet)
            {
