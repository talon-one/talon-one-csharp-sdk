...
namespace TalonOne.Model
{
    ...
    /// </summary>
    public partial class UpdateApplicationAPIKey : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public UpdateApplicationAPIKey(long timeOffset)
        {
    ...
    public class UpdateApplicationAPIKeyJsonConverter : JsonConverter<UpdateApplicationAPIKey>
    {
        ...
        public override UpdateApplicationAPIKey Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="UpdateApplicationAPIKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateApplicationAPIKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateApplicationAPIKey updateApplicationAPIKey, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, updateApplicationAPIKey, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateApplicationAPIKey" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateApplicationAPIKey"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UpdateApplicationAPIKey updateApplicationAPIKey, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteNumber("timeOffset", updateApplicationAPIKey.TimeOffset);
        }
    }
}
