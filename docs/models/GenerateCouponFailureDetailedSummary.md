# TalonOneSdk.Model.GenerateCouponFailureDetailedSummary

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**ApplicationID** | **decimal** | The ID of the Application. It is displayed in your Talon.One deployment URL. | 
